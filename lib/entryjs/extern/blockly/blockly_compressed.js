...
goog.string.compareVersions = function (a, b) {
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        var h = d[g] || "", k = e[g] || "", n = RegExp("(\\d*)(\\D*)", "g"), p = RegExp("(\\d*)(\\D*)", "g");
        do {
            var m = n.exec(h) || ["", "", ""], l = p.exec(k) || ["", "", ""];
            if (0 == m[0].length && 0 == l[0].length)break;
            var c = 0 == m[1].length ? 0 : parseInt(m[1], 10), q = 0 == l[1].length ? 0 : parseInt(l[1], 10), c = goog.string.compareElements_(c, q) || goog.string.compareElements_(0 ==
                    m[2].length, 0 == l[2].length) || goog.string.compareElements_(m[2], l[2])
        } while (0 == c)
    }
    return c
};
...
goog.math.longestCommonSubsequence = function (a, b, c, d) {
    ...
    for (var n = [], h = e, k = f; 0 < h && 0 < k;)c(a[h - 1], b[k - 1]) ? (n.unshift(d(h - 1, k - 1)), h--, k--) : g[h - 1][k] > g[h][k - 1] ? h-- : k--;
    return n
};
...
goog.a11y.aria.TAGS_WITH_ASSUMED_ROLES_ = "A AREA BUTTON HEAD INPUT LINK MENU META OPTGROUP OPTION PROGRESS STYLE SELECT SOURCE TEXTAREA TITLE TRACK".split(" ");
...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
    ...
    if (goog.userAgent.IE && !goog.userAgent.isVersionOrHigher("7")) {
        var m = this.getAppliedCombinedClassNames_(n);
        0 < m.length && (n.push.apply(n, m), k = !0)
    }
...
goog.cssom.getAllCssStyleSheets = function (a, b) {
    ...
    if (d.imports && d.imports.length)for (var f = 0, g = d.imports.length; f < g; f++)goog.array.extend(c, goog.cssom.getAllCssStyleSheets(d.imports[f])); else if (d.length)for (f = 0, g = d.length; f < g; f++)goog.array.extend(c, goog.cssom.getAllCssStyleSheets(d[f])); else {
        var h = goog.cssom.getCssRulesFromStyleSheet(d);
        if (h && h.length)for (var f = 0, g = h.length, k; f < g; f++)k = h[f], k.styleSheet && goog.array.extend(c, goog.cssom.getAllCssStyleSheets(k.styleSheet))
    }
    !(d.type ||
...
goog.cssom.getCssRuleIndexInParentStyleSheet = function (a, b) {
    ...
    if ((c = goog.cssom.getCssRulesFromStyleSheet(c)) && c.length)for (var d = 0, e = c.length, f; d < e; d++)if (f = c[d], f == a)return d;
    return -1
};
...
goog.cssom.replaceCssRule = function (a, b, c, d) {
    if (c = c || goog.cssom.getParentStyleSheet(a))if (a = 0 <= Number(d) ? Number(d) : goog.cssom.getCssRuleIndexInParentStyleSheet(a, c), 0 <= a)goog.cssom.removeCssRule(c, a), goog.cssom.addCssRule(c, b, a); else throw Error("Cannot proceed without the index of the cssRule."); else throw Error("Cannot proceed without the parentStyleSheet.");
};
goog.cssom.addCssRule = function (a, b, c) {
    if (void 0 == c || 0 > c)c = goog.cssom.getCssRulesFromStyleSheet(a).length;
    if (a.insertRule)a.insertRule(b, c); else if (b = /^([^\{]+)\{([^\{]+)\}/.exec(b), 3 == b.length)a.addRule(b[1], b[2], c); else throw Error("Your CSSRule appears to be ill-formatted.");
};
...
goog.cssom.getAllCss_ = function (a, b) {
    for (var c = [], d = goog.cssom.getAllCssStyleSheets(a), e = 0; a = d[e]; e++) {
        ...
        if (f && f.length)for (var g = 0, h = 0, k = f.length, n; h < k; h++)n = f[h], b && !n.href ? (n = goog.cssom.getCssTextFromCssRule(n), c.push(n)) : n.href || (n.style && (n.parentStyleSheet || (n.style["-closure-parent-stylesheet"] = a), n.style["-closure-rule-index"] = b ? void 0 : g), c.push(n)), b || g++
    }
    return b ? c.join(" ") : c
};
...
var Blockly = {
    BlockSvg: function (a) {
        ...
        Blockly.enableBlockAnimation && (this.svgPathPatternA_ = Blockly.createSvgElement("path", {
            ...
            Blockly.createSvgElement("path", {
                ...
                "class": "blocklyPathPattern"
            }, this.svgGroup_), this.svgPathPatternC_ = Blockly.createSvgElement("path", {
            id: "blocklyPathPattern3",
            "class": "blocklyPathPattern"
        }, this.svgGroup_), this.svgPathPatternD_ = Blockly.createSvgElement("path", {
            id: "blocklyPathPattern4",
            "class": "blocklyPathPattern"
        }, this.svgGroup_));
        this.block_.outputConnection && (this.svgPathLight_ = Blockly.createSvgElement("path", {"class": "blocklyPathLight"}, this.svgGroup_));
        this.svgPath_.tooltip =
            this.block_;
...
Blockly.BlockSvg.prototype.toggleOnPattern = function (a) {
    Blockly.addClass_(this.svgGroup_.parentNode, "disablePattern");
    Blockly.addClass_(this.svgGroup_, "togglePattern")
};
Blockly.BlockSvg.prototype.toggleOffPattern = function (a) {
    Blockly.removeClass_(this.svgGroup_.parentNode, "disablePattern");
    Blockly.removeClass_(this.svgGroup_, "togglePattern")
};
...
Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL = "v 6.5 m -" + .98 * Blockly.BlockSvg.TAB_WIDTH + ",2.5 q -" + .05 * Blockly.BlockSvg.TAB_WIDTH + ",10 " + .27 * Blockly.BlockSvg.TAB_WIDTH + ",10 m " + .71 * Blockly.BlockSvg.TAB_WIDTH + ",-2.5 v 1.5";
...
Blockly.BlockSvg.INNER_TOP_LEFT_CORNER = Blockly.BlockSvg.NOTCH_PATH_RIGHT + " h -0.6 h" + Blockly.BlockSvg.CORNER_RADIUS + " a " + Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,0 -" + Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS;
...
Blockly.BlockSvg.prototype.dispose = function () {
    ...
    Blockly.enableBlockAnimation && (this.svgPathPatternD_ = this.svgPathPatternC_ = this.svgPathPatternB_ = this.svgPathPatternA_ = null);
    this.block_ = this.svgPathDark_ = this.svgPathLight_ = null
};
...
Blockly.BlockSvg.disposeUiStep_ = function (a) {
    var b = a.getElementsByTagName("text");
    if (b)for (var c = 0; c < b.length; c++)b[c].parentNode.removeChild(b[c]);
    b = (new Date - a.startDate_) / 100;
...
Blockly.BlockSvg.prototype.updateColour = function () {
    if (!this.block_.disabled) {
        var a = Blockly.makeColour(this.block_.getColour()), b = goog.color.hexToRgb(a), c = goog.color.darken(b, .1), b = goog.color.darken(b, .3);
        this.block_.outputConnection && this.svgPathLight_.setAttribute("stroke", goog.color.rgbArrayToHex(c));
        this.block_.outputConnection && (this.block_.parentBlock_ ? this.svgPathDark_.setAttribute("opacity", 0) : this.svgPathDark_.removeAttribute("opacity"));
        this.svgPathDark_.setAttribute("fill", goog.color.rgbArrayToHex(b));
        this.svgPath_.setAttribute("fill", a);
        Blockly.enableBlockAnimation && (this.svgPathPatternA_.setAttribute("fill", "url(#blockPattern1)"), Blockly.createSvgElement("animate", {
            attributeName: "opacity",
            values: "0;0.2;0;0",
            repeatCount: "indefinite",
            begin: "0",
            dur: "1.4s"
        }, this.svgPathPatternA_), this.svgPathPatternB_.setAttribute("fill", "url(#blockPattern2)"), Blockly.createSvgElement("animate", {
            attributeName: "opacity",
            values: "0;0.2;0;0",
            repeatCount: "indefinite",
            begin: "0.33",
            dur: "1.4s"
        }, this.svgPathPatternB_), this.svgPathPatternC_.setAttribute("fill",
            "url(#blockPattern3)"), Blockly.createSvgElement("animate", {
            attributeName: "opacity",
            values: "0;0.2;0;0",
            repeatCount: "indefinite",
            begin: "0.67",
            dur: "1.4s"
        }, this.svgPathPatternC_), this.svgPathPatternD_.setAttribute("fill", "url(#blockPattern4)"));
...
Blockly.BlockSvg.prototype.updateDisabled = function () {
    this.block_.disabled || this.block_.getInheritedDisabled() ? (Blockly.addClass_(this.svgGroup_, "blocklyDisabled"), this.svgPath_.setAttribute("fill", "gray")) : (Blockly.removeClass_(this.svgGroup_, "blocklyDisabled"), this.updateColour());
...
Blockly.BlockSvg.prototype.addSelect = function () {
    ...
    this.block_.isInBlockMenu || this.svgGroup_.parentNode.appendChild(this.svgGroup_)
};
...
Blockly.BlockSvg.prototype.addActive = function () {
    Blockly.addClass_(this.svgGroup_, "blocklyActivated");
...
Blockly.BlockSvg.prototype.render = function () {
    ...
    for (var a = Blockly.BlockSvg.SEP_SPACE_X, b = this.block_.getIcons(), c = 0; c < b.length; c++)a = b[c].renderIcon(a);
    a += Blockly.RTL ? Blockly.BlockSvg.SEP_SPACE_X : -Blockly.BlockSvg.SEP_SPACE_X;
    b = this.renderCompute_(a);
    this.renderDraw_(a, b);
    (a = this.block_.getParent()) && a.render()
};
Blockly.BlockSvg.prototype.renderFields_ = function (a, b, c, d) {
    for (var e = 0, f; f = a[e]; e++) {
        f.isTextInput && 1 == a.length && (b -= 4);
        var g = f.getSize(), h = g.width, g = c + (d - g.height) / 2;
        f.getRootElement().setAttribute("transform", "translate(" + b + ", " + g + ")");
        h && (b += h + Blockly.BlockSvg.SEP_SPACE_X);
        f.isTextInput && 1 == a.length && (b += 4)
    }
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.block_.inputsInline && !this.block_.isCollapsed(), p = 0, m; m = b[p]; p++)if (m.isVisible()) {
        var l;
        n && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT ? l = c[c.length - 1] :
            (k = m.type, l = [], l.type = n && m.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : m.type, l.height = 0, c.push(l));
        l.push(m);
        m.renderHeight = m.sourceBlock_.outputConnection ? Blockly.BlockSvg.MIN_INLINE_BLOCK_Y : Blockly.BlockSvg.MIN_BLOCK_Y;
        m.renderWidth = n && m.type == Blockly.INPUT_VALUE ? Blockly.BlockSvg.TAB_WIDTH + Blockly.BlockSvg.SEP_SPACE_X : 0;
        if (m.connection && m.connection.targetConnection) {
            var q = m.connection.targetBlock().getHeightWidth();
            m.renderHeight = Blockly.BlockSvg.MIN_INLINE_BLOCK_Y;
        ...
        for (var q = 0, r; r = m.fieldRow[q]; q++)0 == q && r instanceof Blockly.FieldIcon || (0 != q && (m.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X), r = r.getSize(), m.fieldWidth += r.width, l.height = Math.max(l.height, r.height));
        l.type != Blockly.BlockSvg.INLINE && (l.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, m.fieldWidth)) : (l.type == Blockly.INPUT_VALUE ? f = !0 : l.type == Blockly.DUMMY_INPUT &&
        (h = !0), d = Math.max(d, m.fieldWidth)))
    }
    for (a = 0; l = c[a]; a++) {
        l.thicker = !1;
        if (l.type == Blockly.BlockSvg.INLINE)for (b = 0; m = l[b]; b++)if (m.type == Blockly.INPUT_VALUE) {
            this.block_.outputConnection && (l.height += 2 * Blockly.BlockSvg.INLINE_PADDING_Y, "PARAM" == this.block_.outputConnection.check_[0].toUpperCase() && (l.height = Blockly.BlockSvg.MIN_BLOCK_Y - 6));
            l.thicker = !0;
            break
        }
        this.height = l.height + 10
    }
...
Blockly.BlockSvg.prototype.renderDraw_ = function (a, b) {
    if (this.block_.outputConnection) {
        ...
        this.block_.nextConnection && (c = this.block_.nextConnection.targetBlock()) && c.previousConnection && c.previousConnection.targetConnection == this.block_.nextConnection &&
        (this.squareBottomLeftCorner_ = !0)
    }
    var c = this.block_.getRelativeToSurfaceXY(), d = [], e = [];
    this.renderDrawTop_(d, c, b);
    var f = this.renderDrawRight_(d, e, c, b, a);
    this.renderDrawBottom_(d, c, f);
    this.renderDrawLeft_(d, c, f, b);
    c = d.join(" ") + "\n" + e.join(" ");
    this.svgPath_.setAttribute("d", c);
    Blockly.enableBlockAnimation && (this.svgPathPatternA_.setAttribute("d", c), this.svgPathPatternB_.setAttribute("d", c), this.svgPathPatternC_.setAttribute("d", c), this.svgPathPatternD_.setAttribute("d", c));
    this.svgPathDark_.setAttribute("d",
        c);
    this.block_.outputConnection && this.svgPathLight_.setAttribute("d", c);
    c = this.block_;
    !c.previousConnection || c.nextConnection || c.outputConnection || c.dummySpace || (c.dummySpace = !0, Blockly.createSvgElement("rect", {
        "class": "BlockSpaceDummy",
        height: "9",
        width: "10",
        y: this.height - 10,
        opacity: "0"
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function (a, b, c) {
    a.push("m 0,0");
    Blockly.BROKEN_CONTROL_POINTS && a.push("c 0,4 0,-4 0,0");
    c = c[0][0].fieldRow;
    this.block_.previousConnection ? (a.push("H", 0), a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), this.block_.previousConnection.moveTo(b.x + Blockly.BlockSvg.NOTCH_WIDTH, b.y)) : c[0] instanceof Blockly.FieldIcon && (a.push("m", "0,-5"), a.push("a", "19.5,19.5 0, 0,1 16,0"), a.push("c", "10,5 15,5 20,5"))
};
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e) {
    for (var f, g = 0, h, k, n, p = 0, m; m = d[p]; p++) {
        f = Blockly.BlockSvg.SEP_SPACE_X;
        0 == p && (f += Blockly.RTL ? -e : e);
        0 == p && this.block_.outputConnection ? f = m[0].type == Blockly.INPUT_VALUE ? f - (m.height / 2 + 2) : "PARAM" == this.block_.outputConnection.check_[0].toUpperCase() ? f - 8 : f - (m.height / 2 - 5) : 0 != p ? (f += 33, g -= 2) : f = d[0][0].fieldRow[0] instanceof Blockly.FieldIcon ? f - 13 : this.block_.previousConnection || this.block_.nextConnection ? f + 14 : f - 0;
        if (this.block_.isCollapsed()) {
            var l =
                m[0];
            h = g + Blockly.BlockSvg.FIELD_HEIGHT;
            this.renderFields_(l.fieldRow, f, h, m.height);
            a.push(Blockly.BlockSvg.JAGGED_TEETH);
            a.push("v", m.height - Blockly.BlockSvg.JAGGED_TEETH_HEIGHT)
        } else if (m.type == Blockly.BlockSvg.INLINE) {
            for (n = 0; l = m[n]; n++)if (h = g + Blockly.BlockSvg.FIELD_HEIGHT, f = this.renderFields_(l.fieldRow, f, h, m.height), l.type != Blockly.DUMMY_INPUT && (f += l.renderWidth + Blockly.BlockSvg.SEP_SPACE_X), l.type == Blockly.INPUT_VALUE) {
                h = l.renderHeight / 2;
                var q = l.renderWidth, r = 0, q = q + 1, t = l.connection.check_ ? l.connection.check_[0] :
                    "null";
                k = g + (m.height - 2 * h) / 2;
                "BOOLEAN" == t.toUpperCase() ? (b.push("M", f - Blockly.BlockSvg.SEP_SPACE_X - h + "," + (k + .5)), b.push("h", -q + 2 * h), b.push("l", "-" + h + "," + h + " " + h + "," + h), b.push("h", q - 2 * h), b.push("l", h + ",-" + h + " -" + h + ",-" + h), b.push("z")) : "PARAM" == t.toUpperCase() ? (k += 1, this.block_.outputConnection ? (f -= l.renderWidth + Blockly.BlockSvg.SEP_SPACE_X, r = l.renderWidth + Blockly.BlockSvg.SEP_SPACE_X + 9) : (r = 8, b.push("M", f - Blockly.BlockSvg.SEP_SPACE_X - 6 + ",3"), b.push("h", -q + 9), b.push("l", "-2,2 0,3 3,0 1,1 0,11 -1,1 -3,0 0,4 2,2"),
                    b.push("h", q - 9), b.push("l", "2,-2 0,-3 3,0 1,-1 0,-13 -1,-1 -3,0 0,-2 -2,-2"), b.push("z"))) : (b.push("M", f - Blockly.BlockSvg.SEP_SPACE_X - h + "," + (k + .5)), b.push("h", -q + 2 * h), b.push("a", h + "," + h + " 0 1,0 0," + 2 * h), b.push("h", q - 2 * h), b.push("a", h + "," + h + " 0 1,0 0,-" + 2 * h), b.push("z"));
                h = c.x + f - Blockly.BlockSvg.SEP_SPACE_X - Blockly.BlockSvg.TAB_WIDTH - l.renderWidth + 7.5 + h + r;
                k = c.y + k;
                l.connection.moveTo(h, k);
                l.connection.targetConnection && l.connection.tighten_()
            }
            n = f = Math.max(f, d.rightEdge);
            this.block_.outputConnection ?
                ...
                this.blockInlineWidth_), l = m[m.length - 1].fieldRow, l[l.length - 1] instanceof Blockly.FieldIcon || (f += 8), h = m.height / 2, a.push("H", f - h - 1), a.push("a", h + "," + h + " 0 0,1 0," + 2 * h))
        } else m.type == Blockly.INPUT_VALUE ? (l = m[0], h = g + Blockly.BlockSvg.FIELD_HEIGHT, l.align != Blockly.ALIGN_LEFT && (k = d.rightEdge - l.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, l.align == Blockly.ALIGN_RIGHT ? f += k : l.align == Blockly.ALIGN_CENTRE && (f += (k + f) / 2)), this.renderFields_(l.fieldRow, f, h, m.height), a.push(Blockly.BlockSvg.TAB_PATH_DOWN),
            ...
            a.push("v", m.height - 4.5), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), a.push("H", 14), a.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), this.blockInlineWidth_ ? a.push("H", this.blockInlineWidth_ - 12) : a.push("H", n), h = c.x + (Blockly.RTL ? -f : f) + 6, k = c.y + g + 3, 0 != p && (k -= 0), g -= 0, l.connection.moveTo(h, k), l.connection.targetConnection && l.connection.tighten_(), p == d.length - 1 || d[p + 1].type == Blockly.NEXT_STATEMENT) && (a.push("a", "8,8 0 0,1 0,16"), g += Blockly.BlockSvg.SEP_SPACE_Y + 3);
        g += m.height
    }
    d.length || (g = Blockly.BlockSvg.MIN_BLOCK_Y,
        a.push("V", g));
    return g
};
Blockly.BlockSvg.prototype.renderDrawBottom_ = function (a, b, c) {
    this.block_.nextConnection && (a.push("l", "0,-0.5"), a.push("H", Blockly.BlockSvg.NOTCH_WIDTH + " " + Blockly.BlockSvg.NOTCH_PATH_RIGHT), a.push("l", "0,0.5"), this.block_.nextConnection.moveTo(b.x + Blockly.BlockSvg.NOTCH_WIDTH, b.y + c + 1), this.block_.nextConnection.targetConnection && this.block_.nextConnection.tighten_());
    Blockly.BROKEN_CONTROL_POINTS && a.push("c 0,4 0,-4 0,0");
    a.push("H 0")
};
Blockly.BlockSvg.prototype.renderDrawLeft_ = function (a, b, c, d) {
    this.block_.outputConnection && (this.block_.outputConnection.moveTo(b.x, b.y), b = this.r_, "PARAM" == this.block_.outputConnection.check_[0].toUpperCase() ? a.push("l", "-18,0 -2,-2 0,-3 3,0 1,-1 0,-12 -1,-1 -3,0 0,-3 2,-2 18,0") : b && "BOOLEAN" == this.block_.outputConnection.check_[0].toUpperCase() ? a.push("l", "-" + b + ",-" + b + " " + b + ",-" + b) : b && a.push("a", b + "," + b + " 0 1,1 0,-" + 2 * b));
    d[0][0].fieldRow[0] instanceof Blockly.FieldIcon && a.push("a", "19.5,19.5 0, 0,1 0,-35");
    a.push("z")
};
...
Blockly.ScrollbarPair.prototype.dispose = function () {
    ...
    this.oldHostMetrics_ = this.workspace_ = this.onResizeWrapper_ = null;
...
Blockly.ScrollbarPair.prototype.resize = function () {
    if (!Blockly.scrollBarOff) {
        ...
        if (a) {
            ...
            (b = !0), this.oldHostMetrics_ && this.oldHostMetrics_.contentHeight == a.contentHeight && this.oldHostMetrics_.viewTop == a.viewTop && this.oldHostMetrics_.contentTop == a.contentTop || (c = !0)) : c = b = !0;
...
Blockly.ScrollbarNative = function (a, b, c) {
    ...
    if (null !== b) {
        ...
        b ? (this.foreignObject_.setAttribute("height", Blockly.Scrollbar.scrollbarThickness), this.outerDiv_.style.height = Blockly.Scrollbar.scrollbarThickness + "px", this.outerDiv_.style.overflowX = "scroll", this.outerDiv_.style.overflowY = "hidden", this.innerImg_.style.height = "1px") : (this.foreignObject_.setAttribute("width",
            Blockly.Scrollbar.scrollbarThickness), this.outerDiv_.style.width = Blockly.Scrollbar.scrollbarThickness + "px", this.outerDiv_.style.overflowX = "hidden", this.outerDiv_.style.overflowY = "scroll", this.innerImg_.style.width = "1px");
        var d = this;
...
Blockly.ScrollbarNative.prototype.resize = function (a) {
    ...
    } else b = a.viewHeight, this.pair_ ? b -= Blockly.Scrollbar.scrollbarThickness : this.setVisible(b < a.contentHeight), this.ratio_ = b / a.viewHeight, c = this.ratio_ * a.contentHeight, d = (a.viewTop - a.contentTop) * this.ratio_, this.outerDiv_.style.height =
...
Blockly.ScrollbarNative.prototype.setVisible = function (a) {
    if (a != this.isVisible()) {
        ...
        a ? (this.foreignObject_.style.display = "block", this.workspace_.getMetrics()) : (this.workspace_.setMetrics({
            x: 0,
            y: 0
...
Blockly.ScrollbarSvg.prototype.uiEffectInc_ = function (a) {
    this.svgGroup_.setAttribute("opacity", "1")
};
Blockly.ScrollbarSvg.prototype.uiEffectDec_ = function (a) {
};
...
Blockly.ScrollbarSvg.prototype.onMouseDownBar_ = function (a) {
    ...
    if (!Blockly.isRightButton(a)) {
        var b = Blockly.mouseToSvg(a), b = this.horizontal_ ? b.x : b.y, c = Blockly.getSvgXY_(this.svgKnob_), c = this.horizontal_ ? c.x : c.y, d = parseFloat(this.svgKnob_.getAttribute(this.horizontal_ ? "width" : "height")), e = parseFloat(this.svgKnob_.getAttribute(this.horizontal_ ? "x" : "y")), f = .95 * d;
        b <= c ? e -= f : b >= c + d && (e += f);
...
Blockly.Trashcan.prototype.createDom = function () {
    ...
    Blockly.bindEvent_(this.svgGroup_, "mousedown", this, function (a) {
        Blockly.isRightButton(a) && (console.log("hi"), document.getElementById("entryBlockly").style.background = "white")
    });
    this.svgBody_ = Blockly.createSvgElement("image", {width: this.WIDTH_, height: this.BODY_HEIGHT_}, this.svgGroup_);
    this.svgBody_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", Blockly.mediaFilePath +
        this.BODY_URL_);
    ...
    this.svgLid_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", Blockly.mediaFilePath + this.LID_URL_);
    return this.svgGroup_
};
...
Blockly.Trashcan.prototype.onMouseMove = function (a) {
    if (this.svgGroup_) {
        ...
        a = a.x + 25 > b.x && a.x < b.x + this.WIDTH_ + 25 && a.y + 25 > b.y && a.y < b.y + this.BODY_HEIGHT_ + this.LID_HEIGHT_ + 25;
...
Blockly.Xml.blockToDom_ = function (a) {
    ...
    a.outputConnection ? b.setAttribute("class", "output " + a.type) : b.setAttribute("class", "inline " + a.type);
    b.setAttribute("id", a.id);
    if (a.mutationToDom) {
        var c = a.mutationToDom();
        c && b.appendChild(c)
    }
    for (var d = 0; c = a.inputList[d]; d++)for (var e = 0, f; f = c.fieldRow[e]; e++)if (f.name && f.EDITABLE) {
        var g = goog.dom.createDom("field", null, f.getValue());
        g.setAttribute("name", f.name);
        b.appendChild(g)
    }
    a.comment && (c = goog.dom.createDom("comment",
        null, a.comment.getText()), c.setAttribute("pinned", a.comment.isVisible()), d = a.comment.getBubbleSize(), c.setAttribute("h", d.height), c.setAttribute("w", d.width), b.appendChild(c));
    d = !1;
    ...
    a.isAddable() || b.setAttribute("addable", !1);
...
Blockly.Xml.domToWorkspace = function (a, b) {
    for (var c = Blockly.svgSize().width, d = 0, e; e = b.childNodes[d]; d++)if ("block" == e.nodeName.toLowerCase()) {
        var f = Blockly.Xml.domToBlock(a, e), g = parseInt(e.getAttribute("x"), 10);
...
Blockly.Xml.domToBlock = function (a, b, c) {
    ...
    d.previousId = b.getAttribute("id");
    d.svg_ || d.initSvg();
    (f = b.getAttribute("inline")) && d.setInputsInline("true" == f);
    (f = b.getAttribute("disabled")) && d.setDisabled("true" ==
        f);
    (f = b.getAttribute("deletable")) && d.setDeletable("true" == f);
    (f = b.getAttribute("movable")) && d.setMovable("true" == f);
    (f = b.getAttribute("addable")) && d.setAddable("true" == f);
    (f = b.getAttribute("editable")) && d.setEditable("true" == f);
    for (var g, f = 0, h; h = b.childNodes[f]; f++)if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
        g = null;
        for (var k = 0, n; n = h.childNodes[k]; k++)3 == n.nodeType && n.data.match(/^\s*$/) || (g = n);
        ...
        switch (h.nodeName.toLowerCase()) {
            ...
            case "comment":
                ...
                (g = h.getAttribute("pinned")) && d.comment.setVisible("true" == g);
            ...
            case "statement":
                ...
                if (g && "block" == g.nodeName.toLowerCase())if (g = Blockly.Xml.domToBlock(a, g, c), g.outputConnection)h.connection.connect(g.outputConnection);
                else if (g.previousConnection)h.connection.connect(g.previousConnection); else throw"Child block does not have output or previous statement.";
                break;
            case "next":
    ...
    (a = d.nextConnection &&
        d.nextConnection.targetBlock()) ? a.render() : d.render();
...
Blockly.Workspace = function (a, b) {
    a ? (this.getMetrics = a, this.setMetrics = b) : (this.getMetrics = Blockly.getGenralWorkspaceMetricsFunc_(this), this.setMetrics = Blockly.setGeneralWorkspaceMetricsFunc_(this));
    this.isFlyout = !1;
    this.topBlocks_ = [];
...
Blockly.Workspace.prototype.addConnectionAnimation = function () {
    ...
    var a = this.connectionAnimation.createDom();
    this.svgGroup_.insertBefore(a, this.svgBlockCanvas_);
...
Blockly.Workspace.prototype.removeTopBlock = function (a) {
    for (var b = !1, c, d = 0; c = this.topBlocks_[d]; d++)if (c == a) {
...
Blockly.Workspace.prototype.getBlockByPreviousId = function (a) {
    for (var b = this.getAllBlocks(), c = 0, d; d = b[c]; c++)if (d.previousId == a)return d;
    return null
};
Blockly.Workspace.prototype.getBlockByIdWithDeactivate = function (a) {
    for (var b = this.getAllBlocks(), c = 0, d; d = b[c]; c++)if (d.svg_.removeActive(), d.id == a)return d;
    return null
};
Blockly.Workspace.prototype.setAllBlockDisable = function () {
    for (var a = this.getAllBlocks(), b = 0, c; c = a[b]; b++)c.setDisabled(!0);
    return null
};
Blockly.Workspace.prototype.setAllBlockAble = function () {
    for (var a = this.getAllBlocks(), b = 0, c; c = a[b]; b++)c.setDisabled(!1);
    return null
};
...
Blockly.Workspace.prototype.activateBlock = function (a) {
    this.traceOn(!0);
    var b = null;
    if (a && (b = this.getBlockById(a), !b))return;
    this.traceOn(!1);
    b ? b.activate() : Blockly.selected && Blockly.selected.unselect();
    this.traceOn(!0)
};
Blockly.Workspace.prototype.activatePreviousBlock = function (a) {
    this.traceOn(!0);
    var b = null;
    if (a && (b = this.getBlockByPreviousId(a), !b))return;
    this.traceOn(!1);
    b ? b.activate() : Blockly.selected && Blockly.selected.unselect();
    this.traceOn(!0)
};
...
Blockly.Workspace.prototype.paste = function (a) {
    if (!(a.getElementsByTagName("block").length >= this.remainingCapacity())) {
        "object" === typeof Entry ? a = Entry.changeXmlHashId(a) : "object" === typeof Ntry && (a = Ntry.changeXmlHashId(a));
        var b = Blockly.Xml.domToBlock(this, a), c = parseInt(a.getAttribute("x"), 10), d = parseInt(a.getAttribute("y"), 10);
        if (!isNaN(c) && !isNaN(d)) {
            Blockly.RTL && (c = -c);
            do for (var e = !1, f = this.getAllBlocks(), g = 0, h; h = f[g]; g++)h = h.getRelativeToSurfaceXY(), 1 >= Math.abs(c - h.x) && 1 >= Math.abs(d - h.y) && (c = Blockly.RTL ?
            c - Blockly.SNAP_RADIUS : c + Blockly.SNAP_RADIUS, d += 2 * Blockly.SNAP_RADIUS, e = !0); while (e);
            b.moveBy(c, d)
        }
        b.select();
        a.getAttribute("isForFunc") && (Entry.Func.positionBlock_(b), a.removeAttribute("isForFunc"))
    }
};
...
Blockly.Workspace.prototype.organizeBlocks = function () {
    ...
    if (a) {
        var b;
        Blockly.hasBlockMenu ? b = Math.round(a.viewLeft + 35) : (b = Blockly.mainWorkspace.flyout_.svgGroup_.getBBox().width, b = Math.round(a.viewLeft + 30 + b));
        var c = 0, d = 0, e = a.viewTop + a.viewHeight - 30, f = this.getTopBlocks(), g;
        for (g in f) {
            var h = f[g].getHeightWidth(), k = c + a.viewTop + 20;
            k > e && (b = b + d + 10, c = d = 0);
            d = Math.max(d, h.width);
            k = c + a.viewTop + 20;
            f[g].svg_.getRootElement().setAttribute("transform", "translate(" + b + "," + k + ")");
            c = c + h.height +
                20
        }
        a = Blockly.Xml.workspaceToDom(this);
        this.clear();
        Blockly.Xml.domToWorkspace(this, a)
    }
};
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
    ...
    b ? (this.resizeGroup_ = Blockly.createSvgElement("g", {"class": Blockly.RTL ? "blocklyResizeSW" : "blocklyResizeSE"},
        this.bubbleGroup_), c = 2 * Blockly.Bubble.BORDER_WIDTH, Blockly.createSvgElement("polygon", {points: "0,x x,x x,0".replace(/x/g, c.toString())}, this.resizeGroup_), Blockly.createSvgElement("line", {
...
Blockly.Bubble.prototype.renderArrow_ = function () {
    ...
    if (b == d && c == e)a.push("M " + b + "," + c); else {
        ...
        var k = Math.sin(h), n = Math.cos(h), p = this.getBubbleSize(), h = (p.width + p.height) / Blockly.Bubble.ARROW_THICKNESS, h = Math.min(h, p.width, p.height) / 2, p = 1 - Blockly.Bubble.ANCHOR_RADIUS / f, d = b + p * d, e = c +
            p * e, p = b + h * n, m = c + h * k, b = b - h * n, c = c - h * k, k = g + this.arrow_radians_;
...
Blockly.Comment.prototype.updateEditable = function () {
    this.textarea_ && (this.block_.isEditable() ? (this.textarea_.removeAttribute("disabled"), this.textarea_.removeAttribute("readonly")) : (this.textarea_.setAttribute("disabled", "disabled"), this.textarea_.setAttribute("readonly", "readonly")));
...
Blockly.Connection.prototype.connect = function (a) {
    ...
    if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
        ...
        if (a.targetConnection) {
            ...
            for (var c = this.sourceBlock_, d; d = Blockly.Connection.singleConnection_(c, b);)if (d.targetBlock())c = d.targetBlock(); else {
                d.connect(b.outputConnection);
                b = null;
                break
            }
            b && (d = b.type.toUpperCase(), -1 < Blockly.primitiveTypes.indexOf(d) ? b.dispose(!0, !1) : window.setTimeout(function () {
                b.outputConnection.bumpAwayFrom_(a)
            }, Blockly.BUMP_DELAY), c.previousConnection || c.nextConnection || window.setTimeout(function () {
        ...
        if (a.targetConnection) {
            ...
            for (c = this.sourceBlock_; c.nextConnection;)if (c.nextConnection.targetConnection)c = c.nextConnection.targetBlock(); else {
...
Blockly.Connection.prototype.disconnect = function () {
    ...
    if (!b.isInFlyout && b.isEditing && b.outputConnection instanceof Blockly.Connection) {
        if (a.sourceBlock_.outputConnection && "PARAM" == a.sourceBlock_.outputConnection.check_[0].toUpperCase() && "PARAM" != a.check_[0].toUpperCase()) {
            var c =
                Blockly.Xml.blockToDom_(b), c = Blockly.Xml.domToBlock(b.workspace, c);
            a.connect(c.outputConnection)
        } else a.check_ && -1 < a.check_.indexOf("Number") ? (c = Blockly.Xml.textToDom('<xml><block type="number"><field name="NUM">10</field></block></xml>'), c = Blockly.Xml.domToBlock(b.workspace, c.childNodes[0]), a.connect(c.outputConnection)) : a.check_ && -1 < a.check_.indexOf("String") ? (c = Blockly.Xml.textToDom('<xml><block type="text"><field name="NAME">\ubb38\uc790</field></block></xml>'), c = Blockly.Xml.domToBlock(b.workspace,
            c.childNodes[0]), a.connect(c.outputConnection)) : a.check_ && -1 < a.check_.indexOf("Boolean") && (c = Blockly.Xml.textToDom('<xml><block type="True"></block></xml>'), c = Blockly.Xml.domToBlock(b.workspace, c.childNodes[0]), a.connect(c.outputConnection));
        b.isDrag = !1;
        a.sourceBlock_.isDrag = !1
    }
...
Blockly.Connection.prototype.bumpAwayFrom_ = function (a) {
    if (0 == Blockly.Block.dragMode_) {
        ...
        if (!b.isInFlyout) {
            ...
            d = a.x_ + Blockly.SNAP_RADIUS - this.x_;
...
Blockly.Connection.prototype.highlight = function () {
    var a, b = this.sourceBlock_.getRelativeToSurfaceXY(), c = this.x_ - b.x, b = this.y_ - b.y;
    this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ? (a = this.check_ ? this.check_[0] : "null", "PARAM" == a.toUpperCase() ? a = (a = this.sourceBlock_.outputConnection) ? "M -20,-2 l 2,2 0,3 4,0 0,12 -4,0 0,3 -2,2" : "M -20,3 l -2,2 0,3 4,0 0,12 -4,0 0,3 2,2" : "BOOLEAN" == a.toUpperCase() ? (a = this.targetConnection && this.targetConnection.sourceBlock_) ? (a = this.targetConnection.sourceBlock_.svg_.svgPathLight_.getAttribute("d").split("z")[0],
        a += "z") : a = "M 16,0 h -20 l -11,11 11,11.5 h 20l 11,-11 -11,-11 z" : (a = this.targetConnection && this.targetConnection.sourceBlock_) ? (a = this.targetConnection.sourceBlock_.svg_.svgPathLight_.getAttribute("d").split("z")[0], a += "z") : a = "M 10,0 h -10 a 12,9.9 0 0,0 0,19.5 h 10a 11,9.9 0 0,0 0,-19.5 z", Blockly.Connection.highlightedPath_ = Blockly.createSvgElement("path", {
        "class": "blocklyHighlightedConnectionPathInline",
        d: a,
        transform: "translate(" + c + ", " + b + ")"
    }, this.sourceBlock_.getSvgRoot())) : (a = Blockly.RTL ? "m 20,0 h -5 l -6,4 -3,0 -6,-4 h -5" :
        "m -15,0 l 7,8 7,-8", Blockly.Connection.highlightedPath_ = Blockly.createSvgElement("path", {
...
Blockly.Connection.prototype.closest = function (a, b, c) {
    function d(b) {
        var c = e[b];
        if ((c.type == Blockly.OUTPUT_VALUE || c.type == Blockly.PREVIOUS_STATEMENT) && c.targetConnection || !p.checkType_(c))return !0;
        c = c.sourceBlock_;
        do {
            if (n == c)return !0;
            c = c.getParent()
    ...
    c = b = h;
    var k = null, n = this.sourceBlock_, p = this;
    if (e.length) {
        for (; 0 <= b && d(b);)b--;
...
Blockly.Connection.prototype.checkType_ = function (a) {
    if (this.sourceBlock_.isInFlyout || a.sourceBlock_.isInFlyout)return !1;
...
Blockly.ContextMenu.show = function (a, b) {
    if (b.length) {
        ...
        for (var c = 0, d = [Blockly.ContextMenu.svgBackground, Blockly.ContextMenu.svgShadow], e = 0, f; f = b[e]; e++) {
            ...
            d.push(h);
            Blockly.bindEvent_(g, "mousedown", null,
                Blockly.noEvent);
        ...
        for (e = 0; e < d.length; e++)d[e].setAttribute("width", c);
        if (Blockly.RTL)for (e = 0; g = Blockly.ContextMenu.svgOptions.childNodes[e]; e++)k = g.lastChild, k.setAttribute("text-anchor", "end"), k.setAttribute("x", c - Blockly.ContextMenu.X_PADDING);
        Blockly.ContextMenu.svgBackground.setAttribute("height",
            b.length * Blockly.ContextMenu.Y_HEIGHT + 8);
...
Blockly.ContextMenu.callbackFactory = function (a, b) {
    return function () {
        var c = Blockly.Xml.domToBlock(a.workspace, b), d = a.getRelativeToSurfaceXY();
...
Blockly.Field = function (a) {
    ...
    this instanceof Blockly.FieldTextInput && (this.borderRect_.setAttribute("x", -Blockly.BlockSvg.SEP_SPACE_X / 2), this.borderRect_.setAttribute("y", "-2"));
    this.textElement_ = Blockly.createSvgElement("text", {"class": "blocklyText", y: 11}, this.fieldGroup_);
...
Blockly.Field.prototype.setText = function (a, b) {
    if (null !== a && a !== this.text_) {
        this.text_ = a;
        goog.dom.removeChildren(this.textElement_);
        a = a.replace(/\s/g, Blockly.Field.NBSP);
        a || (a = Blockly.Field.NBSP);
        b && a.length > Blockly.TEXT_INPUT_MAX_LENGTH && (a = a.substr(0, Blockly.TEXT_INPUT_MAX_LENGTH - 1) + "...");
        var c = document.createTextNode(a);
        this.textElement_.appendChild(c);
        this.size_.width = 0;
        this.sourceBlock_ && this.sourceBlock_.rendered && (this.sourceBlock_.render(), this.sourceBlock_.bumpNeighbours_(), this.sourceBlock_.workspace.fireChangeEvent())
    }
};
...
Blockly.Field.prototype.onMouseUp_ = function (a) {
    !Blockly.isRightButton(a) && 2 != Blockly.Block.dragMode_ && this.sourceBlock_.isEditable() && (this.sourceBlock_.isDrag = !0, this.showEditor_())
};
...
Blockly.Tooltip.show_ = function () {
    ...
    if (Blockly.Tooltip.svgGroup_) {
        ...
        for (var a = a.split("\n"), b = 0; b < a.length; b++) {
            ...
            }, Blockly.Tooltip.svgText_), d = document.createTextNode(a[b]);
            c.appendChild(d)
        }
        ...
        if (Blockly.RTL)for (var c = a.width, d = 0, e; e = Blockly.Tooltip.svgText_.childNodes[d]; d++)e.setAttribute("text-anchor", "end"), e.setAttribute("x", c + Blockly.Tooltip.MARGINS);
...
Blockly.FieldLabel = function (a, b) {
    this.sourceBlock_ = null;
    goog.isString(b) ? this.textElement_ = Blockly.createSvgElement("text", {
        "class": "blocklyText",
        style: "fill:" + b,
        y: 12
    }, null) : this.textElement_ = Blockly.createSvgElement("text", {"class": "blocklyText", y: 12}, null);
    this.size_ = {height: 14, width: 0};
    this.setText(a)
};
...
Blockly.Input.prototype.appendField = function (a, b) {
    if (!a && !b)return this;
    goog.isString(a) && (a = new Blockly.FieldLabel(a, b));
...
Blockly.Input.prototype.setVisible = function (a) {
    ...
    this.connection && (b = a ? this.connection.unhideAll() : this.connection.hideAll(), d = this.connection.targetBlock()) && (d.svg_.getRootElement().style.display = c, a || (d.rendered = !1));
    return b
};
...
Blockly.Mutator.prototype.setVisible = function (a) {
    if (a != this.isVisible())if (a) {
        ...
        this.updateColour()
    } else this.svgBackground_ = this.svgDialog_ =
...
Blockly.Mutator.prototype.workspaceChanged_ = function () {
    if (0 == Blockly.Block.dragMode_)for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++) {
...
Blockly.Warning.prototype.setVisible = function (a) {
    if (a != this.isVisible())if (a) {
        ...
        if (Blockly.RTL)for (var b = a.getBBox().width, c = 0, d; d = a.childNodes[c]; c++)d.setAttribute("text-anchor", "end"), d.setAttribute("x", b + Blockly.Bubble.BORDER_WIDTH);
        this.updateColour();
...
Blockly.Block.prototype.fill = function (a, b) {
    ...
    this.childBlocks_ = [];
    this.editable_ = this.addable_ = this.movable_ = this.deletable_ = !0;
    this.collapsed_ = !1;
    this.workspace = a;
    ...
    goog.isFunction(this.whenAdd) && this.workspace == Blockly.mainWorkspace && this.whenAdd()
};
...
Blockly.Block.prototype.initSvg = function () {
    ...
    this.svg_.init();
    Blockly.readOnly || (this.mouseDownWrapper_ && Blockly.unbindEvent_(this.mouseDownWrapper_), this.mouseDownWrapper_ = Blockly.bindEvent_(this.svg_.getRootElement(), "mousedown", this, this.onMouseDown_), "function_general" === this.type && (this.dblClickWrapper_ && Blockly.unbindEvent_(this.dblClickWrapper_), this.dblClickWrapper_ = Blockly.bindEvent_(this.svg_.getRootElement(), "dblclick", this, this.onDblClick_)));
    Blockly.enableBlockAnimation &&
    (Blockly.bindEvent_(this.svg_.svgGroup_, "mouseover", this.svg_, this.svg_.toggleOnPattern), Blockly.bindEvent_(this.svg_.svgGroup_, "mouseout", this.svg_, this.svg_.toggleOffPattern));
...
Blockly.Block.prototype.dispose = function (a, b, c) {
    goog.isFunction(this.whenRemove) && this.workspace == Blockly.mainWorkspace && this.isDrag && this.whenRemove(Blockly.Xml.blockToDom_(this));
    this.rendered = !1;
    this.unplug(a);
...
Blockly.Block.prototype.unplug = function (a, b) {
    b = b && !!this.getParent();
    if (this.outputConnection)this.outputConnection.targetConnection && this.setParent(null); else {
        var c = null;
    ...
    b && this.moveBy(Blockly.SNAP_RADIUS *
        (Blockly.RTL ? -1 : 1), 2 * Blockly.SNAP_RADIUS)
};
...
Blockly.Block.prototype.moveBy = function (a, b) {
    ...
    Blockly.Realtime.isEnabled() && !Blockly.Realtime.withinSync && Blockly.Realtime.blockChanged(this)
};
Blockly.Block.prototype.getHeightWidth = function () {
    try {
        var a = this.getSvgRoot().getBBox(), b = a.height
    } catch (c) {
        return {height: 0, width: 0}
    }
    Blockly.BROKEN_CONTROL_POINTS && (b -= 10, this.nextConnection && (b += 4), this.nextConnection || this.outputConnection || !this.previousConnection || (b += 4));
    return {height: b - 1, width: a.width}
};
Blockly.Block.prototype.onDblClick_ = function (a) {
    Entry.Func.isEdit || (a = Entry.variableContainer.functions_) && 0 !== a.length && Entry.Func.edit(a[this.hashId])
};
Blockly.Block.prototype.onMouseDown_ = function (a) {
    Entry.documentMousedown && Entry.documentMousedown.notify(a);
    if (this.isInFlyout)this.select(); else {
        Blockly.svgResize();
        Blockly.terminateDrag_();
        this.select();
        Blockly.hideChaff();
        if (Blockly.isRightButton(a)) {
            if (this.isInBlockMenu && 0 == Blockly.Block.dragMode_) {
                this.stalkerBlock && this.stalkerBlock.dispose();
                this.dispose();
                return
            }
            this.isDrag = !0;
            Blockly.ContextMenu && this.showContextMenu_(Blockly.mouseToSvg(a))
        } else if (Blockly.isMiddleButton(a)) {
            if (this.isInBlockMenu &&
                0 == Blockly.Block.dragMode_) {
                this.stalkerBlock && this.stalkerBlock.dispose();
                this.dispose();
                return
            }
        } else if (this.isMovable()) {
            "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged");
            this.isDrag = !1;
...
Blockly.Block.prototype.onMouseUp_ = function (a) {
    if (this.isInBlockMenu) {
        this.isInBlockMenu = !1;
        if ((a = Blockly.selected) && a.willBeDeleted) {
            this.stalkerBlock.dispose(!1, !1);
            a.dispose(!1, !0);
            Blockly.terminateDrag_();
            return
        }
        this.stalkerBlock.dispose(!1, !1);
        delete a.willBeDeleted;
        this.stalkerBlock = null
    }
    Blockly.terminateDrag_();
    Blockly.selected && Blockly.highlightedConnection_ ? (Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.svg_ && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ :
    ...
    "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyMouseUp");
...
Blockly.Block.prototype.duplicate_ = function () {
    ...
    "object" === typeof Entry ? a = Entry.changeXmlHashId(a) : "object" === typeof Ntry && (a = Ntry.changeXmlHashId(a));
    var a = Blockly.Xml.domToBlock(this.workspace, a), b = this.getRelativeToSurfaceXY();
...
Blockly.Block.prototype.showContextMenu_ = function (a) {
    if (!Blockly.readOnly && this.contextMenu) {
        ...
        if (this.isDeletable() && !b.isInFlyout) {
            var d = {
                text: Lang.Blocks.Duplication_option, enabled: !0, callback: function () {
                    b.duplicate_();
                    "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged")
                }
            };
            ...
            c.push(d);
            d = {
                text: Lang.Blocks.CONTEXT_COPY_option, enabled: !0, callback: function () {
                    Blockly.copy_(Blockly.selected)
                }
            };
            this.getDescendants().length >
            this.workspace.remainingCapacity() && (d.enabled = !1);
            c.push(d);
            ...
            d = {
                text: 1 == d ? Lang.Blocks.Delete_Blocks : Lang.Blocks.Delete_Blocks.replace("%1", d),
                enabled: !0,
                callback: function () {
                    b.dispose(!0, !0);
                    "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged")
        ...
        Blockly.ContextMenu.show(a,
            c)
    }
};
Blockly.Block.prototype.getConnections_ = function (a) {
    var b = [];
    if (a || this.rendered)if (this.outputConnection && b.push(this.outputConnection), this.nextConnection && b.push(this.nextConnection), this.previousConnection && b.push(this.previousConnection), a || !this.collapsed_) {
        a = 0;
...
Blockly.Block.prototype.onMouseMove_ = function (a) {
    Blockly.scrollBarOff = !1;
    this.isDrag = !0;
    this.stalkerBlock && (this.stalkerBlock.isDrag = !0, this.stalkerBlock.g = !0);
    this.isEditing = !0;
    if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
        ...
        1 == Blockly.Block.dragMode_ && Math.sqrt(Math.pow(b, 2) + Math.pow(c, 2)) > Blockly.DRAG_RADIUS && (Blockly.Block.dragMode_ = 2, this.isDisconnected = this.getParent(), this.setParent(null),
            this.setDragging_(!0));
        if (2 == Blockly.Block.dragMode_) {
            ...
            this.stalkerBlock && (this.willBeDeleted = !0, d = this.stalkerBlock.startDragX + b, e = this.stalkerBlock.startDragY + c, 200 - d < this.svg_.blockInlineWidth_ / 2 && (this.willBeDeleted = !1), this.stalkerBlock.svg_.getRootElement().setAttribute("transform", "translate(" + d + ", " + e + ")"));
            for (d = 0; d < this.draggedBubbles_.length; d++)e = this.draggedBubbles_[d],
                e.bubble.setIconLocation(e.x + b, e.y + c);
            for (var e = this.getConnections_(!1), f = null, g = null, h = Blockly.SNAP_RADIUS_ENTRY, d = 0; d < e.length; d++) {
                var k = e[d], n = k.closest(h, b, c);
                n.connection && (f = n.connection, g = k, h = n.radius)
            }
            ...
            f && f != Blockly.highlightedConnection_ && (f.highlight(), Blockly.highlightedConnection_ = f, Blockly.localConnection_ =
                g);
            if (this.workspace.trashcan && this.isDeletable())this.workspace.trashcan.onMouseMove(a)
        }
...
Blockly.Block.prototype.bumpNeighbours_ = function () {
    if (0 == Blockly.Block.dragMode_) {
        ...
        if (!a.isInFlyout)for (var b = this.getConnections_(!1), c = 0; c < b.length; c++) {
            var d = b[c];
...
Blockly.Block.prototype.setParent = function (a) {
    if (this.parentBlock_) {
        for (var b = this.parentBlock_.childBlocks_, c, d = 0; c = b[d]; d++)if (c == this) {
            b.splice(d, 1);
            break
        }
    ...
    (this.parentBlock_ = a) ? (a.childBlocks_.push(this), b = this.getRelativeToSurfaceXY(), a.svg_ && this.svg_ && a.svg_.getRootElement().insertBefore(this.svg_.getRootElement(), a.svg_.svgPath_), a = this.getRelativeToSurfaceXY(), this.moveConnections_(a.x - b.x, a.y - b.y)) : this.workspace.addTopBlock(this)
};
...
Blockly.Block.prototype.setAddable = function (a) {
    this.addable_ = a
};
...
Blockly.Block.prototype.setColour = function (a) {
    ...
    if (this.rendered) {
        for (a = 0; b = this.inputList[a]; a++)for (var c = 0, d; d = b.fieldRow[c]; c++)d.setText(null);
        this.render()
    }
};
...
Blockly.Block.prototype.setCollapsed = function (a) {
    if (this.collapsed_ != a) {
        this.collapsed_ = a;
        for (var b = [], c = 0, d; d = this.inputList[c]; c++)b = b.concat(d.setVisible(!a));
        if (a) {
            a = this.getIcons();
...
Blockly.Block.prototype.interpolateMsg = function (a, b) {
    function c(a) {
        a instanceof Blockly.Field ? this.appendField(a) : (goog.asserts.assert(a instanceof Array), this.appendField(a[1], a[0]))
    }
    ...
    for (var e = a.split(this.interpolateMsg.SPLIT_REGEX_), f = [], g = 0; g < e.length; g += 2) {
        ...
        if ((h = e[g + 1]) && "%" == h.charAt(0)) {
            var n = parseInt(h.substring(1), 10), p = arguments[n];
...
Blockly.Block.prototype.setStalkerBlock = function (a) {
    this.isInBlockMenu && (this.stalkerBlock = a)
};
Blockly.BlockMenu = function (a) {
    this.buttons_ = [];
    this.splitters_ = [];
    this.buttons_ = [];
    this.listeners_ = [];
    this.isCenterAlign = this.isViewOnly = !1;
    ...
    this.onResizeWrapper_ = Blockly.bindEvent_(window, goog.events.EventType.RESIZE, this, this.syncViewSize_);
    Blockly.bindEvent_(window, "resize", this, this.updateSplitters);
    a = Blockly.BlockMenu.BTN_WIDTH;
    var c = Blockly.BlockMenu.BTN_HEIGHT, d = Blockly.BlockMenu.BTN_ROUND, e = [];
    e.push("m " + d + ",0");
    e.push("h", a - 2 * d);
    e.push("a", d + "," + d + " 0, 0,1 " + d + "," + d);
    e.push("v",
        c - 2 * d);
    e.push("a", d + "," + d + " 0, 0,1 -" + d + "," + d);
    e.push("h", -a + 2 * d);
...
Blockly.BlockMenu.prototype.show = function (a) {
    this.hide();
    this.menuView_.style.display = "block";
    var b = [], c = [];
    if (a == Blockly.Variables.NAME_TYPE)Blockly.Variables.blockMenuCategory(b, c, 0, this.workspace_); else if (a == Blockly.Procedures.NAME_TYPE)Blockly.Procedures.blockMenuCategory(b, c, 0, this.workspace_); else for (var d = 0, e; e = a[d]; d++)e.tagName && "BLOCK" == e.tagName.toUpperCase() ? (e = Blockly.Xml.domToBlock(this.workspace_, e), e.isInFlyout = !0, b.push(e), c.push(0)) : e.tagName && "SPLITTER" == e.tagName.toUpperCase() ?
        (b.push("splitter"), c.push(0)) : e.tagName && "BTN" == e.tagName.toUpperCase() && (b.push(e), c.push(0));
    a = 10;
    for (d = 0; e = b[d]; d++)if ("splitter" == e)e = this.createSplitter(64, b[d - 1].outputConnection ? a : a + 5, this.view_.style.width.substr(0, 3)), this.workspace_.svgBlockCanvas_.appendChild(e), this.splitters_.push(e), a += 10; else if (e.tagName && "BTN" == e.tagName.toUpperCase()) {
        var f = Number(e.getAttribute("height")), g = Blockly.createSvgElement("g", {
            transform: "translate(10, " + a + ")",
            "class": "blocklyBlockMenuBtn"
        }, null);
        if (f)Blockly.createSvgElement("image",
            {
                x: 0,
                y: 0,
                width: e.getAttribute("width") + "px",
                height: f + "px"
            }, g).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", e.getAttribute("src")), Blockly.createSvgElement("image", {
            x: 0,
            y: 0,
            width: e.getAttribute("width") + "px",
            height: f + "px",
            "class": "blocklyBlockMenuBtnHighlight"
        }, g).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", e.getAttribute("highlightSrc")), a += f + 15; else {
            var h = e.getAttribute("text"), k = Blockly.BlockMenu.BTN_WIDTH, f = Blockly.BlockMenu.BTN_HEIGHT;
            Blockly.createSvgElement("path",
                {transform: "translate(1,1)", d: this.btnPath, fill: "#aaa"}, g);
            Blockly.createSvgElement("path", {d: this.btnPath, fill: "#eee", "class": "blocklyBlockMenuBtnPath"}, g);
            k = Blockly.createSvgElement("text", {
                x: k / 2 + "px",
                y: f / 2 + 4 + "px",
                "font-family": "ng",
            ...
            h = document.createTextNode(eval(h));
            k.appendChild(h);
            a += f + 13
        }
        (e = e.getAttribute("onclick")) && !this.isViewOnly && (g.onclick = function (a) {
            return function () {
                eval(a)
            }
        }(e));
        this.workspace_.svgBlockCanvas_.appendChild(g);
        this.buttons_.push(g)
    } else {
        g = e.getDescendants();
        for (f = 0; h = g[f]; f++)h.isInFlyout = !0, Blockly.Comment && h.setCommentText(null);
        e.render();
        g = e.getSvgRoot();
        f = e.getHeightWidth();
        h = 10;
        if (this.isCenterAlign)h = 200 - f.width / 2; else if (e.outputConnection) {
            h += f.height / 2;
            k = e.type;
            if ("get_variable" == k || "get_canvas_input_value" == k || "value_of_index_from_list" == k || "length_of_list" == k)a += 12;
            "PARAM" == e.outputConnection.check_[0].toUpperCase() && (h += 9, a += 4)
        } else!e.previousConnection && e.nextConnection ? (h += 10, a += 10) : a += 7;
        e.moveBy(h, a);
        e.previousConnection || e.nextConnection || (a += 10);
        a += f.height + c[d];
        e.isAddable() && !this.isViewOnly && this.listeners_.push(Blockly.bindEvent_(g, "mousedown", null, this.blockMouseDown_(e)))
    }
    this.width_ = 0;
    this.reflow();
    Blockly.fireUiEvent(window, "resize");
...
Blockly.BlockMenu.prototype.banClass = function (a) {
    0 > this.bannedClass.indexOf(a) && this.bannedClass.push(a)
};
Blockly.BlockMenu.prototype.unbanClass = function (a) {
    a = this.bannedClass.indexOf(a);
    -1 < a && this.bannedClass.splice(a, 1)
};
Blockly.BlockMenu.prototype.checkBanClass = function (a) {
    a = a.isNotFor;
    for (var b in this.bannedClass)if (a && -1 < a.indexOf(this.bannedClass[b]))return !0;
    return !1
};
Blockly.BlockMenu.prototype.showCategory = function (a) {
    this.hide();
    this.menuView_.style.display = "block";
    var b = [], c = a.blocks;
    a = [];
    var d = "", e;
    for (e in c) {
        var f = EntryStatic.blockInfo[c[e]];
        if (!this.checkBanClass(f)) {
            d && d != f["class"] && (b.push("splitter"), a.push(0));
            var d = f.xml, g = f.xmls ? f.xmls : [f.xml], h;
            for (h in g)d = g[h], d = jQuery.parseXML(d).childNodes[0], d.tagName && "BTN" == d.tagName.toUpperCase() || (d = Blockly.Xml.domToBlock(this.workspace_, d), d.isInFlyout = !0), b.push(d), a.push(0);
            d = f["class"]
        }
    }
    c = 10;
    for (e =
             0; d = b[e]; e++)if ("splitter" == d)d = this.createSplitter(64, b[e - 1].outputConnection ? c : c + 5, this.view_.style.width.substr(0, 3)), this.workspace_.svgBlockCanvas_.appendChild(d), this.splitters_.push(d), c += 10; else if (d.tagName && "BTN" == d.tagName.toUpperCase()) {
        f = Number(d.getAttribute("height"));
        h = Blockly.createSvgElement("g", {
            transform: "translate(10, " + c + ")",
            "class": "blocklyBlockMenuBtn"
        }, null);
        if (f)Blockly.createSvgElement("image", {
            x: 0,
            ...
            height: f + "px"
        }, h).setAttributeNS("http://www.w3.org/1999/xlink",
            "xlink:href", d.getAttribute("src")), Blockly.createSvgElement("image", {
            x: 0,
            y: 0,
            width: d.getAttribute("width") + "px",
            height: f + "px",
            "class": "blocklyBlockMenuBtnHighlight"
        }, h).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", d.getAttribute("highlightSrc")), c += f + 10; else {
            var g = d.getAttribute("text"), k = Blockly.BlockMenu.BTN_WIDTH, f = Blockly.BlockMenu.BTN_HEIGHT;
            Blockly.createSvgElement("path", {transform: "translate(1,1)", d: this.btnPath, fill: "#aaa"}, h);
            Blockly.createSvgElement("path", {
                d: this.btnPath,
                fill: "#eee", "class": "blocklyBlockMenuBtnPath"
            }, h);
            k = Blockly.createSvgElement("text", {
                x: k / 2 + "px",
                y: f / 2 + 4 + "px",
            ...
            g = document.createTextNode(eval(g));
            k.appendChild(g);
            c += f + 13
        }
        if (d = d.getAttribute("onclick"))h.onclick = function (a) {
            return function () {
                eval(a)
            }
        }(d);
        this.workspace_.svgBlockCanvas_.appendChild(h);
        this.buttons_.push(h)
    } else {
        f = d.getDescendants();
        for (h = 0; g = f[h]; h++)g.isInFlyout = !0, Blockly.Comment && g.setCommentText(null);
        d.render();
        h = d.getSvgRoot();
        f = d.getHeightWidth();
        g = 10;
        if (this.isCenterAlign)g = 200 - f.width / 2; else if (d.outputConnection) {
            g += f.height / 2;
            k = d.type;
            if ("get_variable" == k || "get_canvas_input_value" == k || "value_of_index_from_list" == k || "length_of_list" == k)c += 12;
            "PARAM" == d.outputConnection.check_[0].toUpperCase() && (g += 9, c += 4)
        } else!d.previousConnection && d.nextConnection ? (g += 10, c += 10) : c += 7;
        d.moveBy(g, c);
        d.previousConnection || d.nextConnection || (c += 10);
        c += f.height + a[e];
        d.isAddable() && !this.isViewOnly && this.listeners_.push(Blockly.bindEvent_(h,
            "mousedown", null, this.blockMouseDown_(d)))
    }
    this.width_ = 0;
    this.reflow();
    Blockly.fireUiEvent(window, "resize");
...
Blockly.BlockMenu.prototype.hide = function () {
    ...
    for (var a = 0, c; c = b[a]; a++)c.workspace == this.workspace_ && c.dispose(!1, !1);
    for (var d in this.splitters_)goog.dom.removeNode(this.splitters_[d]);
    this.splitters_ = [];
    for (d in this.buttons_)goog.dom.removeNode(this.buttons_[d]);
    this.buttons_ = []
};
Blockly.BlockMenu.prototype.hide = function () {
    for (var a = 0, b; b = this.listeners_[a]; a++)Blockly.unbindEvent_(b);
...
Blockly.BlockMenu.prototype.createSplitter = function (a, b, c) {
    c = Number(c) - 119;
    a = Blockly.createSvgElement("g", {transform: "translate(" + (a - 34) + ", " + b + ")"}, null);
    Blockly.createSvgElement("path", {stroke: "#b5b5b5", transform: "translate(0, 1)", d: "M0 0 l" + c + " 0"}, a);
    return a
};
Blockly.BlockMenu.prototype.updateSplitters = function () {
    var a = Number(this.view_.style.width.substr(0, 3)) - 119 + 64, b;
    for (b in this.splitters_)this.splitters_[b].childNodes[0].setAttribute("d", "M0 0 l" + a + " 0")
};
Blockly.BlockMenu.prototype.blockMouseDown_ = function (a) {
    var b = this;
    return function (c) {
        Blockly.terminateDrag_();
        Blockly.hideChaff();
        Blockly.isRightButton(c) ? Blockly.ContextMenu && a.showContextMenu_(Blockly.mouseToSvg(c)) : (Blockly.removeAllRanges(), Blockly.setCursorHand_(!0), Blockly.BlockMenu.startDownEvent_ = c, Blockly.BlockMenu.startBlock_ = a, Blockly.BlockMenu.startblockMenu_ = b, Blockly.BlockMenu.onMouseUpWrapper_ = Blockly.bindEvent_(document, "mouseup", this, Blockly.terminateDrag_), Blockly.BlockMenu.onMouseMoveWrapper_ =
            Blockly.bindEvent_(document, "mousemove", this, b.onMouseMove_));
        c.stopPropagation()
    }
};
Blockly.BlockMenu.prototype.onMouseMove_ = function (a) {
...
Blockly.BlockMenu.prototype.createBlockFunc_ = function (a) {
    var b = this;
    return function (c) {
        Blockly.scrollBarOff = !0;
        if (!Blockly.isRightButton(c) && !a.disabled) {
            "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged");
            var d = Blockly.Xml.blockToDom_(a), e = Blockly.Xml.domToBlock(b.workspace_, d);
            e.isInBlockMenu = !0;
            var f = a.getSvgRoot();
            if (!f)throw"originBlock is not rendered.";
            var f = Blockly.getSvgXY_(f), g = e.getSvgRoot();
            if (!g)throw"block is not rendered.";
            g = Blockly.getSvgXY_(g);
            e.setDragging_(!0);
            e.svg_.addSelect();
            e.moveBy(f.x - g.x, f.y - g.y);
            e.startDragX = f.x - g.x;
            e.startDragY = f.y - g.y;
            d = Blockly.Xml.domToBlock(b.targetWorkspace, d);
            g = d.getSvgRoot();
            if (!g)throw"block is not rendered.";
            var g = Blockly.getSvgXY_(g), h = Blockly.mainWorkspace, k = $(h.svgGroup_.parentNode.parentNode).css("border-width"), k = k.substring(0, k.length - 2), n = $(h.blockMenu.view_).position(), h = $(h.svgGroup_.parentNode.parentNode).eq(0).position();
            d.moveBy(f.x - g.x - h.left + n.left, f.y - g.y + n.top - h.top - k);
            d.isInBlockMenu = !0;
            d.setStalkerBlock(e);
            e.setStalkerBlock(d);
            d.onMouseDown_(c)
...
Blockly.BlockMenu.prototype.reflow = function () {
    for (var a = 0, b = this.CORNER_RADIUS, c = this.workspace_.getTopBlocks(!1), d = 0, e; e = c[d]; d++)e.getSvgRoot(), e = e.getHeightWidth(), a = Math.max(a, e.width);
    this.blockMenuWidth = a;
    a += b + Blockly.BlockSvg.TAB_WIDTH + b / 2 + Blockly.Scrollbar.scrollbarThickness;
    if (this.width_ != a) {
        for (d = 0; e = c[d]; d++) {
            e.getHeightWidth();
            var f = e.getRelativeToSurfaceXY();
            if (Blockly.RTL) {
                var g = a - b - Blockly.BlockSvg.TAB_WIDTH - f.x;
                e.moveBy(g, 0);
                f.x += g
            }
        }
...
Blockly.BlockMenu.prototype.getMetrics_ = function () {
    var a = this.view_.getBoundingClientRect();
    try {
...
Blockly.BlockMenu.prototype.setMetrics_ = function (a) {
...
Blockly.BlockMenu.terminateDrag_ = function () {
    Blockly.BlockMenu.onMouseUpWrapper_ && (Blockly.unbindEvent_(Blockly.BlockMenu.onMouseUpWrapper_), Blockly.BlockMenu.onMouseUpWrapper_ = null);
    Blockly.BlockMenu.onMouseMoveWrapper_ && (Blockly.unbindEvent_(Blockly.BlockMenu.onMouseMoveWrapper_), Blockly.BlockMenu.onMouseMoveWrapper_ = null);
...
Blockly.BlockMenu.prototype.syncViewSize_ = function () {
    var a = this.view_.getBoundingClientRect();
    this.menuView_.style.width = a.width + "px";
    this.menuView_.style.height = a.height + "px";
    this.scrollbar_.resize()
};
Blockly.FieldIcon = function (a, b, c) {
    this.sourceBlock_ = null;
    this.type = c ? c : "endOrigin";
    "end" == this.type ? (this.height_ = Number(24), this.width_ = Number(24), this.iconSize = .7) : "endOrigin" == this.type ? (this.height_ = Number(24), this.width_ = Number(24)) : "start" == this.type && (this.height_ = Number(34), this.width_ = Number(34));
    this.size_ = {height: this.height_, width: this.width_};
    this.text_ = b || "";
    "end" == this.type ? (this.fieldGroup_ = Blockly.createSvgElement("g", {}, null), this.circleElement_ = Blockly.createSvgElement("circle",
        {
            cx: this.width_ / 2,
            cy: this.height_ / 2,
            r: this.width_ / 2,
            y: 0
        }, this.fieldGroup_), this.imageElement_ = Blockly.createSvgElement("image", {
        height: this.height_ * this.iconSize + "px",
        width: this.width_ * this.iconSize + "px",
        x: this.width_ * (1 - this.iconSize) / 2,
        y: this.height_ * (1 - this.iconSize) / 2
    }, this.fieldGroup_), this.setValue(a)) : "endOrigin" == this.type ? (this.fieldGroup_ = Blockly.createSvgElement("g", {}, null), this.imageElement_ = Blockly.createSvgElement("image", {
        height: this.height_ + "px",
        width: this.width_ + "px",
        x: 0,
        y: 0
    }, this.fieldGroup_),
        this.setValue(a)) : "start" == this.type && (this.fieldGroup_ = Blockly.createSvgElement("g", {}, null), this.imageElement_ = Blockly.createSvgElement("image", {
        height: this.height_ + "px",
        width: this.width_ + "px",
        x: 0,
        y: -2
    }, this.fieldGroup_), this.setValue(a));
...
Blockly.FieldIcon.prototype.clone = function () {
    return new Blockly.FieldIcon(this.getSrc(), this.width_, this.height_, this.getText())
};
Blockly.FieldIcon.prototype.rectElement_ = null;
Blockly.FieldIcon.prototype.EDITABLE = !1;
Blockly.FieldIcon.prototype.init = function (a) {
    if (this.sourceBlock_)throw"Image has already been initialized once.";
    this.sourceBlock_ = a;
    a.getSvgRoot().appendChild(this.fieldGroup_);
    if (this.type && "end" != this.type)"endOrigin" == this.type ? (b = this.imageElement_, b.tooltip = this.sourceBlock_) : "start" == this.type && (b = this.imageElement_, b.tooltip = this.sourceBlock_); else {
        var b = this.rectElement_ || this.imageElement_;
        b.tooltip = this.sourceBlock_;
        a = goog.color.hexToRgb(a.getColour());
        a = goog.color.darken(a, .2);
        a = goog.color.rgbToHex(a[0],
            a[1], a[2]);
        this.circleElement_.style.fill = a
    }
    Blockly.Tooltip && Blockly.Tooltip.bindMouseEvents(b)
};
Blockly.FieldIcon.prototype.dispose = function () {
    goog.dom.removeNode(this.fieldGroup_);
    this.rectElement_ = this.imageElement_ = this.fieldGroup_ = null
};
Blockly.FieldIcon.prototype.setTooltip = function (a) {
    (this.rectElement_ || this.imageElement_).tooltip = a
};
Blockly.FieldIcon.prototype.getValue = function () {
    return this.src_
};
Blockly.FieldIcon.prototype.setValue = function (a) {
    null !== a && (this.src_ = a, this.imageElement_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", goog.isString(a) ? a : ""))
};
Blockly.FieldIcon.prototype.setText = function (a) {
    null !== a && (this.text_ = a)
};
...
Blockly.FieldTextInput.prototype.setText = function (a) {
    if (null !== a) {
        ...
        Blockly.Field.prototype.setText.call(this, a, !0)
    }
};
Blockly.FieldTextInput.prototype.showEditor_ = function () {
    if (goog.userAgent.MOBILE) {
        var a = window.prompt(Blockly.Msg.CHANGE_VALUE_TITLE, this.text_);
        if (this.changeHandler_) {
            var b = this.changeHandler_(a);
            void 0 !== b && (a = b)
        }
        null !== a && this.setText(a)
    } else Blockly.WidgetDiv.show(this, this.dispose_()), b = Blockly.WidgetDiv.DIV, a = goog.dom.createDom("input", "blocklyHtmlInput"), Blockly.FieldTextInput.htmlInput_ = a, b.appendChild(a), a.value = a.defaultValue = this.text_, a.oldValue_ = null, this.validate_(), this.resizeEditor_(),
...
Blockly.FieldTextInput.prototype.resizeEditor_ = function () {
    ...
    b = Blockly.getAbsoluteXY_(this.borderRect_, this.sourceBlock_.workspace.svgGroup_.parentNode);
    if (Blockly.RTL) {
...
Blockly.FieldAngle.prototype.showEditor_ = function () {
    ...
    if (a.firstChild) {
        var a = Blockly.createSvgElement("svg", {
            ...
            cx: Blockly.FieldAngle.HALF, cy: Blockly.FieldAngle.HALF, r: Blockly.FieldAngle.RADIUS,
...
Blockly.FieldAngle.prototype.onMouseMove = function (a) {
    ...
    b = Math.atan(-a / c);
    isNaN(b) || (b = b / Math.PI * 180, b = 90 - b, 0 > c ? b += 180 : 0 < a && (b += 360), Blockly.FieldAngle.ROUND && (b = Math.round(b / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND), 360 <= b && (b -= 360), b = String(b), Blockly.FieldTextInput.htmlInput_.value = b, this.setText(b))
};
...
Blockly.FieldAngle.prototype.updateGraph = function () {
    if (this.gauge_) {
        ...
        if (isNaN(a))this.gauge_.setAttribute("d", "M " + Blockly.FieldAngle.HALF + ", " + Blockly.FieldAngle.HALF), this.line_.setAttribute("x2", Blockly.FieldAngle.HALF), this.line_.setAttribute("y2", Blockly.FieldAngle.HALF); else {
            var b = Blockly.FieldAngle.HALF + Math.sin(a) * Blockly.FieldAngle.RADIUS, c = Blockly.FieldAngle.HALF + Math.cos(a) * -Blockly.FieldAngle.RADIUS;
            this.gauge_.setAttribute("d", "M " + Blockly.FieldAngle.HALF +
                ", " + Blockly.FieldAngle.HALF + " v -" + Blockly.FieldAngle.RADIUS + " A " + Blockly.FieldAngle.RADIUS + "," + Blockly.FieldAngle.RADIUS + " 0 " + (a > Math.PI ? 1 : 0) + " 1 " + b + "," + c + " z");
...
Blockly.FieldColour.prototype.showEditor_ = function () {
    ...
    Blockly.FieldColour.changeEventKey_ = goog.events.listen(b, goog.ui.ColorPicker.EventType.CHANGE, function (a) {
        ...
        null !== a && ("object" == typeof Entry && e.getValue() != a && Entry.dispatchEvent("entryBlocklyChanged"), e.setValue(a))
    })
};
...
Blockly.FieldDropdown = function (a, b, c, d) {
    this.menuGenerator_ = a;
    this.changeHandler_ = b;
    this.trimOptions_();
    a = this.getOptions_()[0];
    this.value_ = a[1];
    this.arrow_ = Blockly.createSvgElement("tspan", {}, null);
    d && (this.arrowColor_ = d);
    0 != c && this.arrow_.appendChild(document.createTextNode(Blockly.RTL ? "\u25be " : " \u25be"));
    Blockly.FieldDropdown.superClass_.constructor.call(this, a[0])
};
...
Blockly.FieldDropdown.createDom = function () {
    var a = Blockly.mediaFilePath + "media/scroll_up.png", b = Blockly.mediaFilePath + "media/scroll_down.png";
    Blockly.FieldDropdown.currentPosition = 0;
    var c = Blockly.createSvgElement("svg", {xmlns: "http://www.w3.org/2000/svg", version: "1.1", height: "200"}, null);
    Blockly.FieldDropdown.svgWrapper_ = c;
    var d = Blockly.createSvgElement("g", {"class": "blocklyHidden blocklyFieldDropdown"}, c);
    Blockly.FieldDropdown.svgGroup_ = d;
    Blockly.FieldDropdown.svgShadow_ = Blockly.createSvgElement("rect",
        {"class": "blocklyDropdownMenuShadow", x: 0, y: 1}, d);
    Blockly.FieldDropdown.svgBackground_ = Blockly.createSvgElement("rect", {
        x: -2,
        y: -1,
        filter: "url(#blocklyEmboss)"
    }, d);
    Blockly.FieldDropdown.svgOptions_ = Blockly.createSvgElement("g", {"class": "blocklyDropdownMenuOptions"}, d);
    Blockly.FieldDropdown.scrollbarWrapper_ = Blockly.createSvgElement("g", {"class": "blocklyDropdownScollWrapper blocklyHidden"}, c);
    Blockly.FieldDropdown.scrollbarUpWrapper_ = Blockly.createSvgElement("g", {
            transform: "translate(0 0)",
            cursor: "pointer"
        },
        Blockly.FieldDropdown.scrollbarWrapper_);
    Blockly.createSvgElement("rect", {
        width: "15",
        height: "40",
        fill: "none",
    ...
    d = Blockly.createSvgElement("image", {
        width: "10",
        height: "40",
        x: "5",
        opacity: "0.5"
    }, Blockly.FieldDropdown.scrollbarUpWrapper_);
    d.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a);
...
Blockly.FieldDropdown.moveUp = function (a) {
    0 != Blockly.FieldDropdown.currentPosition && (Blockly.FieldDropdown.currentPosition--, Blockly.FieldDropdown.moveScroll(Blockly.FieldDropdown.currentPosition), Blockly.FieldDropdown.timer = window.setTimeout(function () {
        Blockly.FieldDropdown.moveUp()
    }, 100))
};
Blockly.FieldDropdown.mouseLeave = function (a) {
    Blockly.FieldDropdown.timer && (window.clearInterval(Blockly.FieldDropdown.timer), Blockly.FieldDropdown.timer = null)
};
Blockly.FieldDropdown.moveDown = function (a) {
    this.getOptions_ && (Blockly.FieldDropdown.optionLength = this.getOptions_().length);
    Blockly.FieldDropdown.currentPosition + 10 != Blockly.FieldDropdown.optionLength && (Blockly.FieldDropdown.currentPosition++, Blockly.FieldDropdown.moveScroll(Blockly.FieldDropdown.currentPosition), Blockly.FieldDropdown.timer = window.setTimeout(function () {
        Blockly.FieldDropdown.moveDown()
    }, 100))
};
Blockly.FieldDropdown.onMouseWheel = function (a) {
    a.stopPropagation();
    a.preventDefault();
    Blockly.removeAllRanges();
...
Blockly.FieldDropdown.moveScroll = function (a) {
    Blockly.FieldDropdown.svgGroup_.setAttribute("transform", "translate(0 " + -20 * a + ")")
};
...
Blockly.FieldDropdown.prototype.showEditor_ = function () {
    function a(a) {
        return function (b) {
            ...
            null !== a && ("object" == typeof Entry && this.getValue() != a && Entry.dispatchEvent("entryBlocklyChanged"), this.setValue(a));
            b.stopPropagation()
        }
    }

    if (Blockly.FieldDropdown.workspace !== this.sourceBlock_.workspace) {
        goog.dom.removeChildren(Blockly.FieldDropdown.svgWrapper_);
        var b = Blockly.FieldDropdown.createDom();
        this.sourceBlock_.workspace.svgGroup_.appendChild(b);
        Blockly.FieldDropdown.workspace = this.sourceBlock_.workspace
    }
    var b = Blockly.FieldDropdown.svgWrapper_, c = Blockly.FieldDropdown.svgGroup_, d = Blockly.FieldDropdown.svgOptions_, e = Blockly.FieldDropdown.svgBackground_, f = Blockly.FieldDropdown.svgShadow_;
    goog.dom.removeChildren(d);
    Blockly.removeClass_(c, "blocklyHidden");
    Blockly.FieldDropdown.openDropdown_ = this;
    for (var g = 0, h = [], k = null, n = this.getOptions_(), p = 0; p < n.length; p++) {
        var m = n[p][1], l = Blockly.ContextMenu.optionToDom(n[p][0]), q = l.firstChild, r = l.lastChild;
        d.appendChild(l);
        k || m != this.value_ || (k = Blockly.createSvgElement("text", {
            "class": "blocklyMenuText",
            y: 15
        }, null), l.insertBefore(k, r), k.appendChild(document.createTextNode("\u2713")));
        l.setAttribute("transform", "translate(0, " + p * Blockly.ContextMenu.Y_HEIGHT + ")");
        h.push(q);
        Blockly.bindEvent_(l, "mousedown", null, Blockly.noEvent);
        Blockly.bindEvent_(l, "mouseup", this, a(m));
        Blockly.bindEvent_(l, "mouseup", null, Blockly.FieldDropdown.hide);
        g = Math.max(g, r.getComputedTextLength())
    }
    g += 2 * Blockly.ContextMenu.X_PADDING;
    for (p = 0; p < h.length; p++)h[p].setAttribute("width", g);
    if (Blockly.RTL)for (p = 0; l = d.childNodes[p]; p++)r = l.lastChild, r.setAttribute("text-anchor", "end"), r.setAttribute("x", g - Blockly.ContextMenu.X_PADDING);
    k && (Blockly.RTL ? (k.setAttribute("text-anchor", "end"), k.setAttribute("x", g - 5)) : k.setAttribute("x", 5));
    p = g + 2 * Blockly.FieldDropdown.CORNER_RADIUS;
    h = n.length * Blockly.ContextMenu.Y_HEIGHT + Blockly.FieldDropdown.CORNER_RADIUS + 1;
    f.setAttribute("width", p);
    f.setAttribute("height", h);
    e.setAttribute("width", p);
    e.setAttribute("height",
        h);
    p = Blockly.makeColour(this.sourceBlock_.getColour());
    e.setAttribute("fill", p);
    e = Blockly.getSvgXY_(this.borderRect_);
    f = this.borderRect_.getBBox();
    p = Blockly.RTL ? e.x - g + Blockly.ContextMenu.X_PADDING + f.width - Blockly.BlockSvg.SEP_SPACE_X / 2 : e.x - Blockly.ContextMenu.X_PADDING + Blockly.BlockSvg.SEP_SPACE_X / 2;
    g = Blockly.FieldDropdown.scrollbarWrapper_;
    10 >= n.length ? Blockly.addClass_(g, "blocklyHidden") : (d = d.getBBox(), Blockly.removeClass_(g, "blocklyHidden"), g.setAttribute("transform", "translate(" + (Number(d.width) -
        15) + " 0)"));
    Blockly.FieldDropdown.wheelEvent_ = Blockly.bindEvent_(c, "wheel", this, Blockly.FieldDropdown.onMouseWheel);
    Blockly.FieldDropdown.moveUpEvent_ = Blockly.bindEvent_(Blockly.FieldDropdown.scrollbarUpWrapper_, "mouseover", this, Blockly.FieldDropdown.moveUp);
    Blockly.FieldDropdown.moveUpLeaveEvent_ = Blockly.bindEvent_(Blockly.FieldDropdown.scrollbarUpWrapper_, "mouseleave", this, Blockly.FieldDropdown.mouseLeave);
    Blockly.FieldDropdown.moveDownEvent_ = Blockly.bindEvent_(Blockly.FieldDropdown.scrollbarDownWrapper_,
        "mouseover", this, Blockly.FieldDropdown.moveDown);
    Blockly.FieldDropdown.moveDownLeaveEvent_ = Blockly.bindEvent_(Blockly.FieldDropdown.scrollbarDownWrapper_, "mouseleave", this, Blockly.FieldDropdown.mouseLeave);
    b.setAttribute("x", p);
    b.setAttribute("y", e.y + f.height)
};
...
Blockly.FieldDropdown.prototype.setText = function (a) {
    this.sourceBlock_ && (this.arrow_.style.fill = this.arrowColor_ ? this.arrowColor_ : Blockly.makeColour(this.sourceBlock_.getColour()));
...
Blockly.FieldDropdown.hide = function () {
    var a = Blockly.FieldDropdown.svgGroup_, b = Blockly.FieldDropdown.scrollbarWrapper_;
    a && (Blockly.addClass_(a, "blocklyHidden"), a.removeAttribute("transform"));
    b && (Blockly.addClass_(b, "blocklyHidden"), b.removeAttribute("transform"));
    Blockly.FieldDropdown.wheelEvent_ && Blockly.unbindEvent_(Blockly.FieldDropdown.wheelEvent_);
    Blockly.FieldDropdown.moveUpEvent_ && Blockly.unbindEvent_(Blockly.FieldDropdown.moveUpEvent_);
    Blockly.FieldDropdown.moveDownEvent_ && Blockly.unbindEvent_(Blockly.FieldDropdown.moveDownEvent_);
    Blockly.FieldDropdown.moveUpLeaveEvent_ && Blockly.unbindEvent_(Blockly.FieldDropdown.moveUpLeaveEvent_);
    Blockly.FieldDropdown.moveDownLaeveEvent_ && Blockly.unbindEvent_(Blockly.FieldDropdown.moveDownLeaveEvent_);
    Blockly.FieldDropdown.currentPosition = 0;
    Blockly.FieldDropdown.openDropdown_ = null
};
Blockly.FieldDropdownDynamic = function (a, b, c, d) {
    "function" == typeof a ? this.menuFunc_ = a : this.menuName_ = a;
    ...
    d && (this.arrowColor_ = d);
    0 != c && this.arrow_.appendChild(document.createTextNode(Blockly.RTL ? "\u25be " : " \u25be"));
    Blockly.FieldDropdownDynamic.superClass_.constructor.call(this, a[0])
};
...
Blockly.FieldDropdownDynamic.createDom = function () {
    ...
    Blockly.FieldDropdownDynamic.svgGroup_ = a;
    ...
    Blockly.FieldDropdownDynamic.svgOptions_ = Blockly.createSvgElement("g", {"class": "blocklyDropdownMenuOptions"},
        a);
    return a
};
Blockly.FieldDropdownDynamic.prototype.dispose = function () {
    Blockly.FieldDropdownDynamic.openDropdown_ == this && Blockly.FieldDropdown.hide();
    Blockly.Field.prototype.dispose.call(this)
};
...
Blockly.FieldDropdownDynamic.prototype.showEditor_ = function () {
    ...
    if (Blockly.RTL)for (p = 0; l = d.childNodes[p]; p++)r = l.lastChild, r.setAttribute("text-anchor", "end"), r.setAttribute("x", g - Blockly.ContextMenu.X_PADDING);
    k && (Blockly.RTL ? (k.setAttribute("text-anchor", "end"), k.setAttribute("x", g - 5)) : k.setAttribute("x", 5));
    p = g + 2 * Blockly.FieldDropdownDynamic.CORNER_RADIUS;
    h = n.length * Blockly.ContextMenu.Y_HEIGHT + Blockly.FieldDropdownDynamic.CORNER_RADIUS + 1;
    f.setAttribute("width", p);
    f.setAttribute("height", h);
    ...
    p = Blockly.RTL ? e.x - g + Blockly.ContextMenu.X_PADDING + f.width - Blockly.BlockSvg.SEP_SPACE_X / 2 : e.x - Blockly.ContextMenu.X_PADDING + Blockly.BlockSvg.SEP_SPACE_X / 2;
    g = Blockly.FieldDropdown.scrollbarWrapper_;
    10 >= n.length ? Blockly.addClass_(g, "blocklyHidden") : (d = d.getBBox(), Blockly.removeClass_(g, "blocklyHidden"), g.setAttribute("transform",
        "translate(" + (Number(d.width) - 15) + " 0)"));
    Blockly.FieldDropdown.wheelEvent_ = Blockly.bindEvent_(c, "wheel", this, Blockly.FieldDropdown.onMouseWheel);
    Blockly.FieldDropdown.moveUpEvent_ = Blockly.bindEvent_(Blockly.FieldDropdown.scrollbarUpWrapper_, "mouseover", this, Blockly.FieldDropdown.moveUp);
    Blockly.FieldDropdown.moveUpLeaveEvent_ = Blockly.bindEvent_(Blockly.FieldDropdown.scrollbarUpWrapper_, "mouseleave", this, Blockly.FieldDropdown.mouseLeave);
    Blockly.FieldDropdown.moveDownEvent_ = Blockly.bindEvent_(Blockly.FieldDropdown.scrollbarDownWrapper_,
...
Blockly.FieldDropdownDynamic.prototype.getOptions_ = function () {
    return "object" == typeof Entry.container ? this.menuName_ ? Entry.container.getDropdownList(this.menuName_) : this.menuFunc_.call(this) : [[Lang.Blocks.no_target, "null"]]
};
Blockly.FieldDropdownDynamic.prototype.getValue = function () {
    return this.value_
};
Blockly.FieldDropdownDynamic.prototype.setValue = function (a) {
    this.value_ = a;
    for (var b = this.getOptions_(), c = 0; c < b.length; c++)if (b[c][1] == a) {
        this.setText(b[c][0]);
        return
...
Blockly.FieldDropdownDynamic.prototype.setText = function (a) {
    this.sourceBlock_ && (this.arrow_.style.fill = this.arrowColor_ ? this.arrowColor_ : Blockly.makeColour(this.sourceBlock_.getColour()));
    a && null !== a && (this.text_ = a, goog.dom.removeChildren(this.textElement_), a = a.replace(/\s/g, Blockly.Field.NBSP), a || (a = Blockly.Field.NBSP), a = document.createTextNode(a), this.textElement_.appendChild(a), Blockly.RTL ? this.textElement_.insertBefore(this.arrow_, this.textElement_.firstChild) : this.textElement_.appendChild(this.arrow_),
        this.size_.width = 0, this.sourceBlock_ && this.sourceBlock_.rendered && (this.sourceBlock_.render(), this.sourceBlock_.bumpNeighbours_(), this.sourceBlock_.workspace.fireChangeEvent()))
};
...
Blockly.FieldImage = function (a, b, c, d) {
    ...
    goog.userAgent.GECKO && (this.rectElement_ = Blockly.createSvgElement("rect", {
        height: this.height_ + "px",
        width: this.width_ + "px", y: b, "fill-opacity": 0
    }, this.fieldGroup_))
};
...
Blockly.FieldKeydownInput = function (a) {
    this.arrow_ = Blockly.createSvgElement("tspan", {}, null);
    var b = Entry.getKeyCodeMap();
    this.value_ = a;
    Blockly.FieldKeydownInput.superClass_.constructor.call(this, b[a])
};
...
Blockly.FieldKeydownInput.createDom = function () {
    var a = Blockly.mediaFilePath + "media/keyboard_workspace.png", b = Blockly.createSvgElement("g", {"class": "blocklyHelperDiv blocklyHidden"}, null);
    Blockly.createSvgElement("image", {
        "class": "blocklyHelperImg",
        width: "249",
        height: "106"
    }, b).setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", a);
    return Blockly.FieldKeydownInput.helperSvgGroup_ = b
};
fkip.CURSOR = "pointer";
...
fkip.setText = function (a) {
    null !== a && (a ? Blockly.Field.prototype.setText.call(this, a) : Blockly.Field.prototype.setText.call(this, "   "))
};
fkip.showEditor_ = function () {
    Blockly.WidgetDiv.show(this, this.dispose_());
    var a = Blockly.WidgetDiv.DIV, b = goog.dom.createDom("input", "blocklyHtmlInput");
    Blockly.FieldTextInput.htmlInput_ = b;
    a.appendChild(b);
    ...
    b.onBlurWrapper_ = Blockly.bindEvent_(b, "blur", this, Blockly.WidgetDiv.hide);
    b.onBlurWrapper_ = Blockly.bindEvent_(b, "blur", this, Blockly.FieldKeydownInput.hide);
    this.sourceBlock_.workspace.getCanvas();
    a = Blockly.FieldKeydownInput.helperSvgGroup_;
    Blockly.removeClass_(a, "blocklyHidden");
    var b = Blockly.getSvgXY_(this.borderRect_), c = this.borderRect_.getBBox();
    a.setAttribute("transform", "translate(" + (b.x - 15 + c.width / 2) + ", " + (b.y + 19) + ")")
};
fkip.onHtmlInputChange_ = function (a) {
    Blockly.FieldTextInput.htmlInput_.value = "";
    a = a.keyCode;
    if (65 <= a && 90 >= a || 37 <= a && 40 >= a || 48 <= a && 57 >= a || 32 == a || 13 == a)Blockly.WidgetDiv.hide(), Blockly.FieldKeydownInput.hide(), this.setValue(a)
};
...
Blockly.FieldKeydownInput.hide = function () {
    var a = Blockly.FieldKeydownInput.helperSvgGroup_;
    a && Blockly.addClass_(a, "blocklyHidden")
};
fkip.setValue = function (a) {
    this.value_ = a;
    (a = Entry.getKeyCodeMap()[a]) ? this.setText(String(a)) : this.setText(Lang.Blocks.no_target)
};
...
Blockly.Flyout.prototype.position_ = function () {
    if (this.isVisible()) {
        ...
        if (a) {
            ...
            c.push("h", b);
            c.push("v", Math.max(0, a.viewHeight));
            c.push("h", -b);
            c.push("z");
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    var b = [], g = [];
    if (a == Blockly.Variables.NAME_TYPE)Blockly.Variables.flyoutCategory(b, g, f, this.workspace_); else if (a == Blockly.Procedures.NAME_TYPE)Blockly.Procedures.flyoutCategory(b, g, f, this.workspace_);
    else for (var h = 0; d = a[h]; h++)d.tagName && "BLOCK" == d.tagName.toUpperCase() && (d = Blockly.Xml.domToBlock(this.workspace_, d), b.push(d), g.push(f));
    a = f;
    for (h = 0; d = b[h]; h++) {
        c = d.getDescendants();
        e = 0;
        for (var k; k = c[e]; e++)k.isInFlyout = !0, Blockly.Comment && k.setCommentText(null);
        d.render();
        k = d.getSvgRoot();
        e = d.getHeightWidth();
        c = Blockly.RTL ? 0 : f + .5 * Blockly.BlockSvg.TAB_WIDTH;
        d.outputConnection ? c += e.height / 2 : !d.previousConnection && d.nextConnection && (c += 10);
        d.moveBy(c, a);
        a += e.height + g[h];
        ...
        d.flyoutRect_ = e;
        this.buttons_[h] = e;
        this.autoClose && d.isAddable() ? this.listeners_.push(Blockly.bindEvent_(k, "mousedown", null, this.createBlockFunc_(d))) : d.isAddable() && this.listeners_.push(Blockly.bindEvent_(k, "mousedown", null, this.blockMouseDown_(d)));
        ...
        this.listeners_.push(Blockly.bindEvent_(e, "mouseover", d.svg_, d.svg_.addSelect));
...
Blockly.Flyout.prototype.createBlockFunc_ = function (a) {
    ...
    return function (c) {
        if (!Blockly.isRightButton(c) && !a.disabled) {
            "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged");
            var d = Blockly.Xml.blockToDom_(a), d = Blockly.Xml.domToBlock(b.targetWorkspace_, d), e = a.getSvgRoot();
...
Blockly.Toolbox.populate_ = function () {
    function a(c, d) {
        for (var e = 0, f; f = c.childNodes[e]; e++)if (f.tagName) {
...
Blockly.Variables.allVariables = function (a) {
    ...
    for (var c = 0; c < b.length; c++) {
        var d = b[c].getVars;
        if (d)for (var d = d.call(b[c]), e = 0; e < d.length; e++) {
            var f = d[e];
            f && (a[f.toLowerCase()] = f)
        }
    }
...
Blockly.Variables.flyoutCategory = function (a, b, c, d) {
    ...
    e.unshift(null);
    for (var f = void 0, g = 0; g < e.length; g++)if (e[g] !== f) {
...
Blockly.Generator.prototype.tutorialWorkspaceToCode = function () {
    var a = [];
    this.init();
    for (var b = Blockly.mainWorkspace.getTopBlocks(!0), c = [], d = 0; d < b.length; d++)"when_start" != b[d].type && "declare_function" != b[d].type || c.push(b[d]);
    for (b = 0; d = c[b]; b++) {
        var e = this.blockToCode(d);
        e instanceof Array && (e = e[0]);
        e && (d.outputConnection && this.scrubNakedValue && (e = this.scrubNakedValue(e)), a.push(e))
...
Blockly.Generator.prototype.FUNCTION_NAME_PLACEHOLDER_REGEXP_ = new RegExp(Blockly.Generator.prototype.FUNCTION_NAME_PLACEHOLDER_, "g");
...
Blockly.Procedures.isLegalName = function (a, b, c) {
    b = b.getAllBlocks();
    for (var d = 0; d < b.length; d++)if (b[d] != c) {
...
Blockly.Procedures.flyoutCategory = function (a, b, c, d) {
    function e(e, f) {
        for (var k = 0; k < e.length; k++) {
            var n = Blockly.Block.obtain(d, f);
            n.setFieldValue(e[k][0], "NAME");
            for (var p = [], m = 0; m < e[k][1].length; m++)p[m] = "ARG" + m;
            n.setProcedureParameters(e[k][1], p);
            n.initSvg();
            a.push(n);
            b.push(2 * c)
        }
...
Blockly.Realtime.initializeModel_ = function (a) {
    ...
    b = a.createString(Blockly.Msg.CHAT);
    a.getRoot().set("text", b)
};
...
Blockly.Realtime.onObjectChange_ = function (a) {
    ...
    for (var c = 0; c < a; c++) {
        var d = b[c];
        if (!d.isLocal && "value_changed" == d.type)if ("xmlDom" == d.property) {
            var e = d.target;
            Blockly.Realtime.doWithinSync_(function () {
                Blockly.Realtime.placeBlockOnWorkspace_(e, !1);
                Blockly.Realtime.moveBlock_(e)
            })
        } else if ("relativeX" == d.property || "relativeY" == d.property) {
            var f = d.target;
            Blockly.Realtime.doWithinSync_(function () {
                f.svg_ || Blockly.Realtime.placeBlockOnWorkspace_(f, !1);
                Blockly.Realtime.moveBlock_(f)
            })
        }
    }
};
...
Blockly.Realtime.doWithinSync_ = function (a) {
    if (Blockly.Realtime.withinSync)a(); else try {
...
Blockly.Realtime.moveBlock_ = function (a) {
    if (!isNaN(a.relativeX) && !isNaN(a.relativeY)) {
        var b = Blockly.svgSize().width, c = a.getRelativeToSurfaceXY(), d = a.relativeX - c.x;
...
Blockly.Realtime.loadBlocks_ = function () {
    for (var a = Blockly.Realtime.blocksMap_.values(), b = 0; b < a.length; b++) {
        var c = parseInt(a[b].id, 10);
        c > Blockly.getUidCounter() && Blockly.setUidCounter(c + 1)
    }
    a = Blockly.Realtime.topBlocks_;
    for (b = 0; b < a.length; b++)c = a.get(b), Blockly.Realtime.placeBlockOnWorkspace_(c, !0)
};
Blockly.Realtime.blockChanged = function (a) {
    if (a.workspace == Blockly.mainWorkspace) {
        a = a.getRootBlock();
        var b = a.getRelativeToSurfaceXY(), c = !1, d = Blockly.Xml.blockToDom_(a);
...
Blockly.Realtime.onFileLoaded_ = function (a) {
    ...
    Blockly.Realtime.blocksMap_.addEventListener(gapi.drive.realtime.EventType.VALUE_CHANGED, Blockly.Realtime.onBlocksMapChange_);
    a = Blockly.Realtime.model_.getRoot().get("text");
    var b = document.getElementById("chatbox");
    gapi.drive.realtime.databinding.bindString(a, b);
    b.disabled = !1;
...
Blockly.Realtime.registerTypes_ = function () {
    ...
    Blockly.Block.prototype.type = a.collaborativeField("type");
...
Blockly.Realtime.afterCreate_ = function (a) {
    var b = gapi.client.drive.permissions.insert({
        fileId: a,
        resource: {type: "anyone", role: "writer", value: "default", withLink: !0}
    });
...
Blockly.Realtime.startRealtime = function (a) {
    Blockly.Realtime.enabled_ = !0;
    Blockly.Realtime.initUi_ = a;
    Blockly.Realtime.realtimeLoader_ = new rtclient.RealtimeLoader(Blockly.Realtime.realtimeOptions_);
    Blockly.Realtime.realtimeLoader_.start()
};
Blockly.Css = {};
Blockly.Css.inject = function () {
    var a = Blockly.Css.CONTENT.join("\n"), a = a.replace(/<<<PATH>>>/g, Blockly.mediaFilePath);
...
Blockly.parseOptions_ = function (a) {
    var b = !!a.readOnly;
    if (b)var c = !1, d = !1, e = !1, f = null; else {
        if (f = a.toolbox) {
            "string" != typeof f && "undefined" == typeof XSLTProcessor && (f = f.outerHTML);
            "string" == typeof f && (f = Blockly.Xml.textToDom(f));
            c = !1;
            try {
                c = !!f.getElementsByTagName("category").length
            } catch (k) {
                c = !1
            }
        } else f = null, c = !1;
...
Blockly.createDom_ = function (a) {
    ...
    var b = Blockly.createSvgElement("svg", {
        ...
        version: "1.1",
        "class": "blocklySvg"
    }, null), c = Blockly.createSvgElement("defs", {}, b), d, e;
    ...
    d = Blockly.createSvgElement("filter",
        {id: "blocklyTrashcanShadowFilter"}, c);
    ...
    Blockly.createSvgElement("feGaussianBlur", {stdDeviation: 2},
        d);
    ...
    Blockly.createSvgElement("rect", {width: 10, height: 10, fill: "#aaa"}, d);
    Blockly.createSvgElement("path", {d: "M 0 0 L 10 10 M 10 0 L 0 10", stroke: "#cc0"}, d);
    for (d = 1; 5 > d; d++)e = Blockly.createSvgElement("pattern", {
        id: "blockPattern" + d,
        patternUnits: "userSpaceOnUse",
        width: 125,
        height: 33,
        x: 0,
        y: 0
    }, c), e = Blockly.createSvgElement("image", {
        width: 125,
        height: 33,
        x: 0,
        y: 0
    }, e), e.setAttributeNS("http://www.w3.org/1999/xlink",
        "xlink:href", Blockly.mediaFilePath + "block_pattern_" + d + ".png");
    ...
    Blockly.readOnly || (Blockly.hasCategories ? Blockly.Toolbox.createDom(b, a) : (Blockly.hasBlockMenu && (c = new Blockly.BlockMenu(Blockly.hasBlockMenu), Blockly.mainWorkspace.blockMenu = c, Blockly.bindEvent_(c.menuView_, "wheel", c, Blockly.onMouseWheelFlyout_)),
        Blockly.mainWorkspace.flyout_ = new Blockly.Flyout, c = Blockly.mainWorkspace.flyout_, d = c.createDom(), c.init(Blockly.mainWorkspace, !0), Blockly.bindEvent_(d, "wheel", c, Blockly.onMouseWheelFlyout_), c.autoClose = !1, goog.dom.insertSiblingAfter(d, Blockly.mainWorkspace.svgGroup_), Blockly.addChangeListener(function () {
    })));
    Blockly.Tooltip && b.appendChild(Blockly.Tooltip.createDom());
    !Blockly.readOnly && Blockly.FieldDropdown && (Blockly.fieldDropdownDom = Blockly.FieldDropdown.createDom(), b.appendChild(Blockly.fieldDropdownDom));
    !Blockly.readOnly && Blockly.FieldKeydownInput && (Blockly.fieldKeydownDom = Blockly.FieldKeydownInput.createDom(), b.appendChild(Blockly.fieldKeydownDom));
    Blockly.ContextMenu && Blockly.ContextMenu && b.appendChild(Blockly.ContextMenu.createDom());
    a.appendChild(b);
    Blockly.bindEvent_(b, "mousedown", this, Blockly.hideChaff);
    Blockly.bindEvent_(b, "wheel", this, Blockly.onMouseWheel_);
    Blockly.svg = b;
    Blockly.svgResize();
...
Blockly.init_ = function () {
    ...
    Blockly.documentEventsBound_ || (Blockly.bindEvent_(window, "resize",
        document, Blockly.svgResize), Blockly.bindEvent_(document, "mouseup", null, Blockly.onMouseUp_), Blockly.bindEvent_(document, "keydown", null, Blockly.onKeyDown_), goog.userAgent.IPAD && Blockly.bindEvent_(window, "orientationchange", document, function () {
        Blockly.fireUiEvent(window, "resize")
    }, !1), Blockly.documentEventsBound_ = !0);
    Blockly.languageTree && (Blockly.hasCategories ? Blockly.Toolbox.init() : (Blockly.mainWorkspace.flyout_.init(Blockly.mainWorkspace, !0), Blockly.mainWorkspace.flyout_.show(Blockly.languageTree.childNodes),
        Blockly.mainWorkspace.scrollX = Blockly.mainWorkspace.flyout_.width_, a = "translate(" + Blockly.mainWorkspace.scrollX + ", 0)", Blockly.mainWorkspace.getCanvas().setAttribute("transform", a), Blockly.mainWorkspace.getBubbleCanvas().setAttribute("transform", a)));
...
Blockly.bindEvent_ = function (a, b, c, d) {
    var e = [], f;
    if (!a.addEventListener)throw"Element is not a DOM node with addEventListener.";
    f = function (a) {
        d.apply(c, arguments)
    };
    ...
    b in Blockly.bindEvent_.TOUCH_MAP && (f = function (a) {
        ...
        d.apply(c, arguments);
        if (Entry && "phone" == Entry.type) {
            var b = $(window).scrollTop(), e = $(Entry.playground.blocklyView_), f = e.offset();
            a.clientY > f.top - b && a.clientY <
            f.top - b + e.height() && a.clientX > f.left && a.clientX < f.left + e.width() && a.preventDefault()
...
Blockly.fireUiEvent = function (a, b) {
    var c = document;
    if (c.createEvent)c = c.createEvent("UIEvents"), c.initEvent(b, !0, !0), a.dispatchEvent(c); else if (c.createEventObject)c = c.createEventObject(), a.fireEvent("on" + b, c); else throw"FireEvent: No event creation mechanism.";
};
...
Blockly.getSvgXY_ = function (a, b) {
    ...
    if (Blockly.mainWorkspace.blockMenu) {
        do {
            var e = Blockly.getRelativeXY_(a), c = c + e.x, d = d + e.y;
            a = a.parentNode
        } while (a && "SVG" != a.tagName.toUpperCase())
    } else {
        do e = Blockly.getRelativeXY_(a), c += e.x, d += e.y, a = a.parentNode; while (a && a != Blockly.svg)
    }
    return {x: c, y: d}
};
Blockly.getAbsoluteXY_ = function (a, b) {
    var c = Blockly.getSvgXY_(a);
    return Blockly.convertCoordinates(c.x, c.y, !1, b)
};
...
Blockly.isMiddleButton = function (a) {
    return 1 == a.button
};
Blockly.convertCoordinates = function (a, b, c, d) {
    ...
    a = d.getScreenCTM();
    c && (a = a.inverse());
    e = e.matrixTransform(a);
    c || (e.x += window.scrollX || window.pageXOffset, e.y += window.scrollY || window.pageYOffset);
    return e
};
...
Blockly.getComputedTextLength = function (a) {
    var b = a.innerHTML, c = Blockly.textLengthCache[b];
    c || (c = a.getComputedTextLength(), Blockly.textLengthCache[b] = c);
    return c
};
Blockly.isChild = function (a, b) {
    if (null != b)for (; b.parentNode;)if ((b = b.parentNode) == a)return !0;
    return !1
};
...
Blockly.makeColour = function (a) {
    return "number" == typeof a ? goog.color.hsvToHex(a, Blockly.HSV_SATURATION, 256 * Blockly.HSV_VALUE) : a
};
...
Blockly.primitiveTypes = "NUMBER TRUE FALSE TEXT FUNCTION_PARAM_BOOLEAN FUNCTION_PARAM_STRING TRUE_UN".split(" ");
...
Blockly.svgResize = function () {
    var a = Blockly.svg, b = a.parentNode, c = b.offsetWidth - 3, b = b.offsetHeight;
...
Blockly.onMouseDown_ = function (a) {
    ...
    Blockly.isRightButton(a) ? Blockly.ContextMenu && Blockly.showContextMenu_(Blockly.mouseToSvg(a)) : (Blockly.readOnly || b) && Blockly.mainWorkspace.scrollbar && (Blockly.mainWorkspace.dragMode = !0, Blockly.mainWorkspace.startDragMouseX = a.clientX, Blockly.mainWorkspace.startDragMouseY = a.clientY,
        Blockly.mainWorkspace.startDragMetrics = Blockly.mainWorkspace.getMetrics(), Blockly.mainWorkspace.startScrollX = Blockly.mainWorkspace.scrollX, Blockly.mainWorkspace.startScrollY = Blockly.mainWorkspace.scrollY)
};
...
Blockly.onMouseMove_ = function (a) {
    var b = Blockly.mainWorkspace.scrollbar.vScroll;
    Blockly.mainWorkspace.scrollbar.hScroll.svgGroup_.setAttribute("opacity", "1");
    b.svgGroup_.setAttribute("opacity", "1");
...
Blockly.onMouseWheel_ = function (a) {
    a.preventDefault();
    Blockly.removeAllRanges();
    Blockly.hideChaff();
    var b = a.wheelDeltaX || -a.deltaX, c = a.wheelDeltaY || -a.deltaY;
    a = Blockly.mainWorkspace.getMetrics();
    ...
    b = Blockly.mainWorkspace.startScrollX + b;
    c = Blockly.mainWorkspace.startScrollY + c;
    b = Math.min(b, -a.contentLeft);
    c = Math.min(c, -a.contentTop);
...
Blockly.onMouseWheelFlyout_ = function (a) {
    a.stopPropagation();
    a.preventDefault();
    Blockly.removeAllRanges();
    var b = this.scrollbar_, c = a.wheelDeltaY || -a.deltaY;
    a = this.getMetrics_();
    b.startScrollY = parseFloat(this.scrollbar_.svgKnob_.getAttribute("y"));
    c = parseFloat(-b.startScrollY) + c;
    c = Math.min(c, -a.contentTop);
    c = Math.max(c, a.viewHeight - a.contentTop - a.contentHeight);
    b.svgKnob_.setAttribute(this.horizontal_ ? "x" : "y", b.constrainKnob_(-c - a.contentTop));
    b.onScroll_()
};
Blockly.onKeyDown_ = function (a) {
    var b = Blockly.selected;
    if (!Blockly.isTargetInput_(a) && 27 != a.keyCode)if (8 == a.keyCode || 46 == a.keyCode)try {
        if (b && b.isDeletable() && !b.isInFlyout) {
            Blockly.hideChaff();
            var c = b.type.toUpperCase();
            -1 < Blockly.primitiveTypes.indexOf(c) && b.getParent() || b.dispose(!0, !0);
            "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged")
        }
    } finally {
        a.preventDefault()
    } else if (a.altKey || a.ctrlKey || a.metaKey)b && b.isDeletable() && b.workspace == Blockly.mainWorkspace && (Blockly.hideChaff(), 67 ==
...
Blockly.terminateDrag_ = function () {
    ...
    Blockly.mainWorkspace.blockMenu && Blockly.BlockMenu.terminateDrag_()
};
...
Blockly.showContextMenu_ = function (a) {
    if (!Blockly.readOnly) {
        var b = [];
        if (Blockly.collapse) {
            for (var c = !1, d = !1, e = Blockly.mainWorkspace.getTopBlocks(!1), f = 0; f < e.length; f++)e[f].isCollapsed() ? c = !0 : d = !0;
            d = {enabled: d};
            d.text = Blockly.Msg.COLLAPSE_ALL;
            d.callback = function () {
                for (var a = 0; a < e.length; a++)e[a].setCollapsed(!0)
            };
            b.push(d);
            c = {enabled: c};
            c.text = Blockly.Msg.EXPAND_ALL;
            c.callback = function () {
                for (var a = 0; a < e.length; a++)e[a].setCollapsed(!1)
            };
            b.push(c)
        }
        c = {
            text: Lang.Blocks.Paste_blocks, enabled: !0, callback: function () {
                var a =
                    Blockly.clipboard_;
                "object" === typeof Entry && Entry && Entry.Func && Entry.Func.workspace && Entry.Func.workspace.visible ? (a.setAttribute("isForFunc", "true"), Entry.Func.workspace.paste(a)) : "object" === typeof Ntry && Ntry && Ntry.Func && Ntry.Func.workspace && Ntry.Func.workspace.visible ? a.setAttribute("isForFunc", "true") : Blockly.mainWorkspace.paste(Blockly.clipboard_);
                "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged")
            }
        };
        d = {
            text: Lang.Blocks.Clear_all_blocks, enabled: !0, callback: function () {
                var a;
                "object" === typeof Entry && Entry && Entry.Func && Entry.Func.workspace && Entry.Func.workspace.visible ? a = Entry.Func.workspace.getAllBlocks() : "object" === typeof Ntry && Ntry && Ntry.Func && Ntry.Func.workspace && Ntry.Func.workspace.visible || (a = Blockly.mainWorkspace.getAllBlocks());
                for (var b = a.length - 1; 0 <= b; b--)a[b].deletable_ && a[b].dispose();
                "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged")
            }
        };
        Blockly.clipboard_ || (c.enabled = !1);
        b.push(c);
        b.push({
            text: "\ucf54\ub4dc \uc815\ub9ac\ud558\uae30", enabled: !0, callback: function () {
                Blockly.mainWorkspace.organizeBlocks();
                "object" == typeof Entry && Entry.dispatchEvent("entryBlocklyChanged");
                "object" == typeof Ntry && Entry.dispatchEvent("ntryBlocklyChanged")
            }
        });
        b.push(d);
...
Blockly.loadAudio_ = function (a, b) {
    if (window.Audio && a.length)for (; 0 < a.length;) {
        var c = a[0], d = Blockly.pathToBlockly + c, c = c.match(/\/([^.]+)./)[1];
        createjs.Sound.registerSound(d, c, 4);
        break
    }
};
...
Blockly.getMainWorkspaceMetrics_ = function () {
    ...
    if (Blockly.mainWorkspace.scrollbar)var e = Math.min(d.x - b / 2, d.x + d.width - b), b = Math.max(d.x + d.width + b / 2, d.x + b), f = Math.min(d.y - c / 2, d.y + d.height - c), c = Math.max(d.y + d.height + c / 2, d.y + c); else e = d.x, b = e + d.width, f = d.y, c = f + d.height;
    return {
        viewHeight: a.height,
        viewWidth: a.width,
        contentHeight: c - f,
...
Blockly.getGenralWorkspaceMetricsFunc_ = function (a) {
    return function () {
        var b = Blockly.svgSize();
        b.width -= Blockly.Toolbox.width;
        var c = b.width - Blockly.Scrollbar.scrollbarThickness, d = b.height - Blockly.Scrollbar.scrollbarThickness;
        try {
            var e = a.getCanvas().getBBox()
        } catch (h) {
            return null
        }
        if (a.scrollbar)var f = Math.min(e.x - c / 2, e.x + e.width - c), c = Math.max(e.x + e.width + c / 2, e.x + c), g = Math.min(e.y - d / 2, e.y + e.height - d), d = Math.max(e.y + e.height + d / 2, e.y + d); else f = e.x, c = f + e.width, g = e.y, d = g + e.height;
        return {
            viewHeight: b.height,
            viewWidth: b.width,
            contentHeight: d - g,
...
Blockly.setGeneralWorkspaceMetricsFunc_ = function (a) {
    return function (b) {
        if (!a.scrollbar)throw"Attempt to set main workspace scroll without scrollbars.";
        var c = Blockly.getGenralWorkspaceMetricsFunc_(a)();
        goog.isNumber(b.x) && (a.scrollX = -c.contentWidth * b.x - c.contentLeft);
        goog.isNumber(b.y) && (a.scrollY = -c.contentHeight * b.y - c.contentTop);
        b = "translate(" + (a.scrollX + c.absoluteLeft) + "," + (a.scrollY + c.absoluteTop) + ")";
        a.getCanvas().setAttribute("transform", b);
        a.getBubbleCanvas().setAttribute("transform", b)
    }
};
