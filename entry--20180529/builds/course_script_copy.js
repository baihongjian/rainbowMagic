!function(e) {
            ...
            e.global = r,
                ...
                e.findSoundById = function(t, n) {
                    a.get("/api/sound/" + t).then(function(t) {
                        var r = t.data
                            , a = "/uploads/" + r.filename.substring(0, 2) + "/" + r.filename.substring(2, 4) + "/" + r.filename + r.ext;
                        ...
                        a({
                            ...
                            url: o
                                ...
                                for (var r in e.systemSounds = [],
                                    t) {
                                    var a = t[r]
                                        , o = "/uploads/" + a.filename.substring(0, 2) + "/" + a.filename.substring(2, 4) + "/" + a.filename + a.ext;
                        ...
                        e.systemSounds = Entry.Utils.fuzzy.filter(e.searchWord, n, {
                            extract: function(e) {
                                ...
                                var t = e.original
                                    , n = t._id
                                    , a = t.filename
                                    , o = "/uploads/" + a.substring(0, 2) + "/" + a.substring(2, 4) + "/" + a + t.ext;
                                Entry.soundQueue.loadFile({
                                    id: t._id,
                                    src: o,
                                    type: createjs.LoadQueue.SOUND
                    ...
                    $.ajax({
                        ...
                        success: function(t) {
                            e.$apply(function() {
                                e.isUploading = !1,
                                    t.forEach(function(t) {
                                        var n = "/uploads/" + t.filename.substring(0, 2) + "/" + t.filename.substring(2, 4) + "/" + t.filename + t.ext;
                                        Entry.soundQueue.loadFile({
                                            id: t._id,
                                            src: n,
                                            type: createjs.LoadQueue.SOUND
    ...
    961: function(e, t, n) {
        ...
        r.controller("CourseController", ["$scope", "$route", "$routeParams", "$uibModal", "$http", "$location", "$log", "$q", "Global", "Sprites", "myProject", "Projects", "shareSet", function(e, t, n, r, a, o, i, s, c, u, l, d, p) {
                ...
                function g(t, n, r, o) {
                    if (e.lectureId && window.user && !e.teacherMode) {
                        ...
                        e.groupId && (s.groupId = e.groupId),
                            ...
                            a.post("/api/lecture/progress", s).then(function(t) {
                ...
                function f() {
                    if (e.lectureId)
                        a.get("/api/lecture/detail/" + e.lectureId).success(function(t) {
                            if (e.shareSet.lecture = t,
                                ...
                                if (e.shareSet.lecture.curriculum && (n.curriculum = e.shareSet.lecture.curriculum),
                                    ...
                                    n.user = r,
                                        ...
                                        a.post("/api/lecture/progress/" + e.lectureId, n).then(function(e) {
                                            y(e.data)
                                        }, function() {
                                            h(t)
                                        })
                ...
                function S() {
                    ...
                    e.project._id ? e.project.parent = e.project._id : t && t.basicProject && (e.project.parent = t.basicProject._id),
                        ...
                        L(e.project),
                        a.post("/api/project", e.project).success(function(t) {
                ...
                function E(t) {
                    ...
                    Entry.stage.handle.visible = !1,
                        ...
                        e.project._id ? e.project.$update(function(r) {
                            e.project._id = r._id,
                                p.userProject = r._id,
                                a.post("/api/project/thumbnail/" + r._id, {
                                    thumbnail: P()
                                }).then(function() {
                ...
                e.initWorkspace = function() {
                        e.isGroupOwner = c.isGroupOwner(),
                            ...
                            e.groupId && e.studentId ? a.get("/api/group/" + e.groupId).success(function(t) {
                                e.currentGroup = t,
                                    e.isGroupOwner = c.isGroupOwner(t),
                                    e.homeworkId && (e.isHomework = !0),
                                    e.isGroupOwner ? e.studentId && (e.teacherMode = !0,
                                        a.get("/api/student/" + e.studentId).success(function(t) {
                                            e.currentStudent = t,
                                                f()
                                        })) : a.get("/api/student/group/" + e.groupId).success(function(n) {
                 ...
                 e.popupHelper.show("workspaceSpinner");
                        ...
                        i.parentTitle = e.shareSet.lecture.title,
                            v(i).done(function(n) {
                                ...
                                r ? a.get("/api/project/studylectures/" + e.lectureId + "/" + i._id + "/" + r).then(function(r) {
                                    e.isNew = !1;
                                    var a = r.data || {}
                                        , o = a.userProject || {};
                                    ...
                                    p.isLastStudy ? (k(),
                                        function(t, n) {
                                            var r = e.currentStudent
                                                ...
                                                , s = "/api/group/homework/submit/" + e.groupId
                                                , c = {
                                                    id: e.homeworkId,
                                                    lecture: e.lectureId,
                                                    student: o,
                ...
                e.saveHomework = function(t) {
                        var n = s.defer()
                            , r = "/api/group/homework/submit/" + e.groupId
                            , o = {
                                id: e.homeworkId,
                                lecture: t,
                                student: e.studentId,
                        ...
                        t.parentTitle = e.shareSet.lecture.title,
                            ...
                            v(t).done(function(n) {
                                ...
                                n.basicProject && console.log("basic=", n.basicProject._id),
                                    a.get("/api/project/studylecture/" + e.lectureId + "/" + t._id + "/" + r).then(function(t) {
                                        t.data;
                        ...
                        if (entrylms.isInitialize && t !== n && e.shareSet.lecture && Array.isArray(e.shareSet.lecture.studies)) {
                            ...
                            if (entrylms.Modal.hideAllModal(),
                                ...
                                "true" === o.isCodingParty ? "party17f" === o.season ? document.location.href = "http://playsw.or.kr/party17f" : document.location.href = "http://playsw.or.kr/party17s" : function() {
                                    Entry.Utils.blur();
                                    var t = "/tt#!/custom/lecture/view/" + e.shareSet.lecture._id;
                                    if (!e.isHomework && e.shareSet.lecture.curriculum) {
                                        t = "/tt#!/custom/curriculum/list?sort=updated&rows=12&page=1";
                                        ...
                                        a.get(r).success(function(r) {
                                            ...
                                            t = null != o ? e.groupId ? "/tt#!/group/lecture/view/" + o._id + "/" + e.groupId : "/tt#!/custom/lecture/view/" + o._id : e.groupId ? "/tt#!/group/curriculum/view/" + n + "/" + e.groupId : "/tt#!/custom/curriculum/view/" + n,
                                                window.location.href = t
                                        })
                                    } else
                                        e.groupId && (t = e.homeworkId ? "/tt#!/group/homework/list/" + e.groupId : "/tt#!/group/lecture/view/" + e.shareSet.lecture._id + "/" + e.groupId),
                                            window.location.href = t
                                }()
                            }
                        }
                        ...
                        n.append("data", e.image),
                            $.ajax({
                                ...
                                success: function(n, r) {
                                    ...
                                    var a = new Image
                                        , o = n.filename;
                                    a.src = "/uploads/" + o.substring(0, 2) + "/" + o.substring(2, 4) + "/image/" + o + ".png",
                                        a.onload = function(t) {
    ...
    962: function(e, t) {
        angular.module("mean.course").controller("CourseIframeController", ["$scope", "$route", "$routeParams", "$uibModal", "$http", "$location", "$log", "Global", "Sprites", "myProject", "Projects", function(e, t, n, r, a, o, i, s, c, u, l) {
            ...
            e.isChanged = !0,
                ...
                e.hashId = n.hashId,
                e.initWorkspace = function() {
                    a.get("/api/lecture/" + e.lectureId).success(function(t) {
                        e.lecture = t,
                    ...
                    n.append("data", e.image),
                        $.ajax({
                            ...
                            success: function(e, n) {
                                ...
                                var r = new Image
                                    , a = e.filename;
                                r.src = "/uploads/" + a.substring(0, 2) + "/" + a.substring(2, 4) + "/image/" + a + ".png",
                                    r.onload = function(t) {
            ...
            t.getCourseIndicatorBadgeClass = function(e, t) {
                ...
                t.init = function() {
                    $(".dropdown-menu").find("form").click(function(e) {
                        ...
                        a({
                            method: "GET",
                            url: "/api/lecture/curriculum/" + f.lectureId
                        }).success(function(e) {
                                if (e.curriculum) {
                                    ...
                                    a({
                                        method: "GET",
                                        url: "/api/curriculum/" + t.curriculumId + "?like=true&view=true",
                                        params: {
