...
Lang.CommandTooltip = {
    ...
    "103": "블록 삭제하기",
    "104": "블록 복구하기",
    "105": "코드 분리하기$$코드 연결하기@@이 코드의 가장 위에 있는 블록을 잡고 분리하여 끌어옵니다.$$이 곳에 코드를 연결합니다.$$이 곳에 블록의 向左一步 끝을 끼워 넣습니다.",
    "106": "블록 분리하기",
    "107": "블록 이동하기",
    "108": "블록 복제하기",
    "109": "블록 복제 취소하기",
    ...
    "117": "블록 쓰레드 추가하기",
    "118": "블록 연결하기@@이 곳에 블록을 연결합니다.$$이 곳에 블록의 向左一步 끝을 끼워 넣습니다.",
    ...
    "122": "블록 연결하기@@이 곳에 블록을 연결합니다.$$이 곳에 블록의 向左一步 끝을 끼워 넣습니다.",
    "123": "코드 분리하기$$코드 연결하기@@이 코드의 가장 위에 있는 블록을 잡고 분리하여 끌어옵니다.$$이 곳에 코드를 연결합니다.$$이 곳에 블록의 向左一步 끝을 끼워 넣습니다.",
    "201": "오브젝트 선택하기",
    "301": "do",
    "302": "undo",
    "303": "redo",
...
Lang.Blocks = {
    ...
    "byrobot_dronefighter_controller_joystick_left_x": "向左一步 조이스틱 가로축",
    "byrobot_dronefighter_controller_joystick_left_y": "向左一步 조이스틱 세로축",
    "byrobot_dronefighter_controller_joystick_left_direction": "向左一步 조이스틱 방향",
    "byrobot_dronefighter_controller_joystick_left_event": "向左一步 조이스틱 이벤트",
    "byrobot_dronefighter_controller_joystick_left_command": "向左一步 조이스틱 명령",
    "byrobot_dronefighter_controller_joystick_right_x": "向右一步 조이스틱 가로축",
    "byrobot_dronefighter_controller_joystick_right_y": "向右一步 조이스틱 세로축",
    "byrobot_dronefighter_controller_joystick_right_direction": "向右一步 조이스틱 방향",
    "byrobot_dronefighter_controller_joystick_right_event": "向右一步 조이스틱 이벤트",
    "byrobot_dronefighter_controller_joystick_right_command": "向右一步 조이스틱 명령",
    "byrobot_dronefighter_controller_joystick_direction_left_up": "向左一步 위",
    "byrobot_dronefighter_controller_joystick_direction_up": "위",
    "byrobot_dronefighter_controller_joystick_direction_right_up": "向右一步 위",
    "byrobot_dronefighter_controller_joystick_direction_left": "向左一步",
    "byrobot_dronefighter_controller_joystick_direction_center": "중앙",
    "byrobot_dronefighter_controller_joystick_direction_right": "向右一步",
    "byrobot_dronefighter_controller_joystick_direction_left_down": "向左一步 아래",
    "byrobot_dronefighter_controller_joystick_direction_down": "아래",
    "byrobot_dronefighter_controller_joystick_direction_right_down": "向右一步 아래",
    "byrobot_dronefighter_controller_button_button": "버튼",
    "byrobot_dronefighter_controller_button_event": "버튼 이벤트",
    "byrobot_dronefighter_controller_button_front_left": "向左一步 빨간 버튼",
    "byrobot_dronefighter_controller_button_front_right": "向右一步 빨간 버튼",
    ...
    "byrobot_dronefighter_controller_button_center_left": "트림 向左一步 버튼",
    "byrobot_dronefighter_controller_button_center_right": "트림 向右一步 버튼",
    "byrobot_dronefighter_controller_button_center_down": "트림 뒤 버튼",
    "byrobot_dronefighter_controller_button_bottom_left": "向左一步 둥근 버튼",
    "byrobot_dronefighter_controller_button_bottom_right": "向右一步 둥근 버튼",
    ...
    "byrobot_dronefighter_common_left": "向左一步",
    "byrobot_dronefighter_common_right": "向右一步",
    ...
    "byrobot_dronefighter_controller_userinterface_command_setup_button_frontleft_down": "向左一步 빨간 버튼을 눌렀을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_button_frontright_down": "向右一步 빨간 버튼을 눌렀을 때",
    ...
    "byrobot_dronefighter_controller_userinterface_command_setup_button_midleft_down": "트림 向左一步 버튼을 눌렀을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_button_midright_down": "트림 向右一步 버튼을 눌렀을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_button_middown_down": "트림 뒤 버튼을 눌렀을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_left_up_in": "向左一步 조이스틱을 위로 움직였을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_left_left_in": "向左一步 조이스틱을 向左一步으로 움직였을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_left_right_in": "向左一步 조이스틱을 向右一步으로 움직였을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_left_down_in": "向左一步 조이스틱을 아래로 움직였을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_right_up_in": "向右一步 조이스틱을 위로 움직였을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_right_left_in": "向右一步 조이스틱을 向左一步으로 움직였을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_right_right_in": "向右一步 조이스틱을 向右一步으로 움직였을 때",
    "byrobot_dronefighter_controller_userinterface_command_setup_joystick_right_down_in": "向右一步 조이스틱을 아래로 움직였을 때",
    ...
    "byrobot_dronefighter_drone_control_double_wheel_left": "向左一步 회전",
    "byrobot_dronefighter_drone_control_double_wheel_right": "向右一步 회전",
    ...
    "byrobot_dronefighter_drone_control_quad_roll_left": "向左一步",
    "byrobot_dronefighter_drone_control_quad_roll_right": "向右一步",
    "byrobot_dronefighter_drone_control_quad_pitch_forward": "앞으로",
    "byrobot_dronefighter_drone_control_quad_pitch_backward": "뒤로",
    "byrobot_dronefighter_drone_control_quad_yaw_left": "向左一步 회전",
    "byrobot_dronefighter_drone_control_quad_yaw_right": "向右一步 회전",
    "byrobot_dronefighter_drone_control_quad_throttle_up": "위",
    "byrobot_dronefighter_drone_control_quad_throttle_down": "아래",
    "byrobot_petrone_v2_common_left": "向左一步",
    ...
    "byrobot_petrone_v2_controller_button_front_left": "向左一步 빨간 버튼",
    "byrobot_petrone_v2_controller_button_front_left_right": "양쪽 빨간 버튼",
    "byrobot_petrone_v2_controller_button_front_right": "向右一步 빨간 버튼",
    ...
    "byrobot_petrone_v2_controller_display_align_left": "向左一步",
    "byrobot_petrone_v2_controller_display_align_right": "向右一步",
    ...
    "byrobot_petrone_v2_controller_joystick_direction_left": "向左一步",
    "byrobot_petrone_v2_controller_joystick_direction_left_down": "向左一步 아래",
    "byrobot_petrone_v2_controller_joystick_direction_left_up": "向左一步 위",
    "byrobot_petrone_v2_controller_joystick_direction_right": "向右一步",
    "byrobot_petrone_v2_controller_joystick_direction_right_down": "向右一步 아래",
    "byrobot_petrone_v2_controller_joystick_direction_right_up": "向右一步 위",
    "byrobot_petrone_v2_controller_joystick_direction_up": "위",
    "byrobot_petrone_v2_controller_joystick_left_direction": "向左一步 조이스틱 방향",
    "byrobot_petrone_v2_controller_joystick_left_event": "向左一步 조이스틱 이벤트",
    "byrobot_petrone_v2_controller_joystick_left_x": "向左一步 조이스틱 가로축",
    "byrobot_petrone_v2_controller_joystick_left_y": "向左一步 조이스틱 세로축",
    "byrobot_petrone_v2_controller_joystick_right_direction": "向右一步 조이스틱 방향",
    "byrobot_petrone_v2_controller_joystick_right_event": "向右一步 조이스틱 이벤트",
    "byrobot_petrone_v2_controller_joystick_right_x": "向右一步 조이스틱 가로축",
    "byrobot_petrone_v2_controller_joystick_right_y": "向右一步 조이스틱 세로축",
    ...
    "byrobot_petrone_v2_drone_control_double_wheel_left": "向左一步 회전",
    "byrobot_petrone_v2_drone_control_double_wheel_right": "向右一步 회전",
    ...
    "byrobot_petrone_v2_drone_control_quad_roll_left": "向左一步",
    "byrobot_petrone_v2_drone_control_quad_roll_right": "向右一步",
    ...
    "byrobot_petrone_v2_drone_control_quad_yaw_left": "向左一步 회전",
    "byrobot_petrone_v2_drone_control_quad_yaw_right": "向右一步 회전",
    ...
    "CODEino_string_16": "向左一步 기울임",
    "CODEino_string_17": "向右一步 기울임",
    "CODEino_string_18": "向上一步 기울임",
    "CODEino_string_19": "向下一步 기울임",
    ...
    "FLOW_if_else_3": "아니면",
    "FLOW_repeat_basic_1": "",
    "FLOW_repeat_basic_2": "번 循环하기",
    "FLOW_repeat_basic_errorMsg": "循环 횟수는 0보다 같거나 커야 합니다.",
    "FLOW_repeat_inf": "계속 循环하기",
    ...
    "START_press_some_key_down": "向下一步 화살표",
    "START_press_some_key_enter": "엔터",
    "START_press_some_key_left": "向左一步 화살표",
    "START_press_some_key_right": "向右一步 화살표",
    "START_press_some_key_space": "스페이스",
    "START_press_some_key_up": "向上一步 화살표",
    ...
    "START_when_run_button_click": "开始 버튼을 클릭했을 때",
    ...
    "HAMSTER_sensor_left_proximity": "向左一步 근접 센서",
    "HAMSTER_sensor_right_proximity": "向右一步 근접 센서",
    "HAMSTER_sensor_left_floor": "向左一步 바닥 센서",
    "HAMSTER_sensor_right_floor": "向右一步 바닥 센서",
    ...
    "HAMSTER_turn_once_left": "向左一步",
    "HAMSTER_turn_right": "向右一步",
    ...
    "HAMSTER_change_both_wheels_by_1": "向左一步 바퀴",
    "HAMSTER_change_both_wheels_by_2": "向右一步 바퀴",
    "HAMSTER_change_both_wheels_by_3": "만큼 바꾸기",
    "HAMSTER_set_both_wheels_to_1": "向左一步 바퀴",
    "HAMSTER_set_both_wheels_to_2": "向右一步 바퀴",
    ...
    "HAMSTER_left_wheel": "向左一步",
    "HAMSTER_right_wheel": "向右一步",
    ...
    "HAMSTER_left_floor_sensor": "向左一步",
    "HAMSTER_right_floor_sensor": "向右一步",
    ...
    "HAMSTER_left_intersection": "向左一步",
    "HAMSTER_right_intersection": "向右一步",
    ...
    "HAMSTER_left_led": "向左一步",
    "HAMSTER_right_led": "向右一步",
    ...
    "ROBOID_left": "向左一步",
    "ROBOID_left_wheel": "向左一步 바퀴",
    "ROBOID_long_pressed": "길게~눌렀는가",
    "ROBOID_note": "음표",
    "ROBOID_right": "向右一步",
    "ROBOID_right_wheel": "向右一步 바퀴",
    "ROBOID_sound_beep": "삐",
    ...
    "ALBERT_front_oid": "앞쪽",
    "ALBERT_back_oid": "뒤쪽",
    "ALBERT_sensor_left_proximity": "向左一步 근접 센서",
    "ALBERT_sensor_right_proximity": "向右一步 근접 센서",
    ...
    "ALBERT_turn_left": "向左一步",
    "ALBERT_turn_right": "向右一步",
    "ALBERT_change_both_wheels_by_1": "向左一步 바퀴",
    "ALBERT_change_both_wheels_by_2": "向右一步 바퀴",
    "ALBERT_change_both_wheels_by_3": "만큼 바꾸기",
    "ALBERT_left_wheel": "向左一步",
    "ALBERT_right_wheel": "向右一步",
    "ALBERT_both_wheels": "양쪽",
    "ALBERT_set_both_wheels_to_1": "向左一步 바퀴",
    "ALBERT_set_both_wheels_to_2": "向右一步 바퀴",
    ...
    "ALBERT_left_eye": "向左一步",
    "ALBERT_right_eye": "向右一步",
    "ALBERT_both_eyes": "양쪽",
    "ALBERT_clear_eye_1": "",
    ...
    "robotis_cm_spring_left": "向左一步 접촉 센서",
    "robotis_cm_spring_right": "向右一步 접촉 센서",
    "robotis_cm_led_left": "向左一步 LED",
    "robotis_cm_led_right": "向右一步 LED",
    ...
    "robotis_cm_ir_left": "向左一步 적외선 센서",
    "robotis_cm_ir_right": "向右一步 적외선 센서",
    "robotis_cm_calibration_left": "向左一步 적외선 센서 캘리브레이션 값",
    "robotis_cm_calibration_right": "向右一步 적외선 센서 캘리브레이션 값",
    ...
    "XBOT_angle": ", 각도",
    "XBOT_DC": "바퀴(DC) 모터",
    "XBOT_rightWheel": "向右一步",
    "XBOT_leftWheel": "向左一步",
    "XBOT_bothWheel": "양쪽",
    "XBOT_speed": ", 속도",
    "XBOT_rightSpeed": "바퀴(DC) 모터 向右一步(2) 속도:",
    "XBOT_leftSpeed": "向左一步(1) 속도:",
    ...
    "robotori_Servo": "서보모터",
    "robotori_DC": "DC모터",
    "robotori_DC_rightmotor": "向右一步",
    "robotori_DC_leftmotor": "向左一步",
    "robotori_DC_STOP": "정지",
    "robotori_DC_CW": "시계방향",
    ...
    "SCENE_start_scene_1": "",
    "SCENE_start_scene_2": "开始",
    "SCENE_start_neighbor_scene_1": "",
    "SCENE_start_neighbor_scene_2": "장면 开始",
    "SCENE_start_scene_pre": "返回",
    ...
    "CALC_choose_project_timer_action_sub_1": "开始",
    ...
    "coconut_turn_left": "向左一步",
    "coconut_turn_right": "向右一步",
    ...
    "coconut_sensor_left_proximity": "向左一步 전방 센서",
    "coconut_sensor_right_proximity": "向右一步 전방 센서",
    "coconut_sensor_both_proximity": "모든",
    "coconut_sensor_left_floor": "向左一步 바닥센서",
    "coconut_sensor_right_floor": "向右一步 바닥 센서",
    ...
    "coconut_left_led": "向左一步",
    "coconut_right_led": "向右一步",
    ...
    "ALTINO_Led_Turn_Left_Light": "向左一步방향",
    "ALTINO_Led_Turn_Right_Light": "向右一步방향",
    "ALTINO_Line": "번째 줄",
    "ALTINO_MAGX": "나침판 X축",
    "ALTINO_MAGY": "나침판 Y축",
    "ALTINO_MAGZ": "나침판 Z축",
    ...
    "ALTINO_Steering_Angle_Left10": "向左一步10",
    "ALTINO_Steering_Angle_Left15": "向左一步15",
    "ALTINO_Steering_Angle_Left20": "向左一步20",
    "ALTINO_Steering_Angle_Left5": "向左一步5",
    "ALTINO_Steering_Angle_Right10": "向右一步10",
    "ALTINO_Steering_Angle_Right15": "向右一步15",
    "ALTINO_Steering_Angle_Right20": "向右一步20",
    "ALTINO_Steering_Angle_Right5": "向右一步5",
    "ALTINO_TEM": "온도",
    "ALTINO_TOR1": "向右一步 토크",
    "ALTINO_TOR2": "向左一步 토크",
    "ALTINO_Value": "출력 값",
    ...
    "jdkit_joystick_leftleftright": "向左一步 좌우",
    "jdkit_joystick_lefttopbottom": "向左一步 상하",
    "jdkit_joystick_rightleftright": "向右一步 좌우",
    "jdkit_joystick_righttopbottom": "向右一步 상하",
    "jdkit_led": "LED",
    "jdkit_led_color_green": "초록색",
    "jdkit_led_color_orange": "오랜지색",
    "jdkit_led_turnoff": "끄기",
    "jdkit_led_turnon": "켜기",
    "jdkit_motor_leftbottom": "向左一步아래",
    "jdkit_motor_lefttop": "向左一步위",
    "jdkit_motor_rightbottom": "向右一步아래",
    "jdkit_motor_righttop": "向右一步위",
    "jdkit_tune_do": "도",
    "jdkit_tune_fa": "파",
    "jdkit_tune_la": "라",
    "jdkit_tune_mi": "미",
    ...
    "FUNBOARD_row_tag": "줄",
    "FUNBOARD_scroll_down": "向下一步으로",
    "FUNBOARD_scroll_left": "向左一步으로",
    "FUNBOARD_scroll_no": "없음",
    "FUNBOARD_scroll_right": "向右一步으로",
    "FUNBOARD_scroll_up": "向上一步으로",
...
Lang.Menus = {
    ...
    "concept_guide": "개념 톡톡",
    "group_quiz": "우리 반 퀴즈",
    "fail_check_hint": "앗… 失败! 다시 한 번 도전해보세요!<br>어려울 땐 [힌트]를 확인해보세요!",
    "sort_student": "학생별",
    "sort_lesson": "강의별",
    "sort_course": "강의 모음별",
    ...
    "codingparty2016_blockHelper_4_contents": "횟수 循环하기",
    ...
    "codingparty2016_goalHint_5": "앞으로 쭉 가는 길이잖아? 循环 블록을 사용하여 간단하게 해결해 보자!",
    "codingparty2016_goalHint_6": "미네랄을 모두 모아오자. 循环블록을 쓰면 쉽게 다녀올 수 있겠어!",
    ...
    "codingparty2016_guide_2_1_contents": "<向右一步으로 돌기>와 <向左一步으로 돌기>는 \n제자리에서 90도 회전하는 블록이야. 방향만 회전하는 블록이야. \n캐릭터가 바라보고 있는 방향을 기준으로 向右一步인지 向左一步인지 잘 생각해 봐!\n",
    ...
    "codingparty2016_guide_5_1_title": "'~번 循环하기' 블록 사용하기",
    "codingparty2016_guide_5_1_contents": "똑같은 일을 循环해서 명령하는 건 매우 귀찮은 일이야.\n이럴 땐 명령을 사용하면 훨씬 쉽게 명령을 내릴 수 있어.       \n< [ ? ] 번 循环하기> 블록 안에 循环되는 명령 블록을 넣고  \n[ ? ] 부분에 횟수를 입력하면 입력한 횟수만큼 같은 명령을 循环하게 돼.",
    "codingparty2016_guide_5_2_title": "'~번 循环하기' 블록 사용하기",
    "codingparty2016_guide_5_2_contents": "'< [ ? ] 번 循环하기>  블록 안에는 여러 개의 명령어를 넣을 수도 있으니 잘 활용해봐! \n도착지에 도착했더라도 循环하기 블록 안에 있는 블록이 모두 실행돼.\n 즉, 위 상황에서 목적지에 도착한 후에도 向左一步으로 돈 다음에야 끝나는 거야!",
    ...
    "codingparty2016_guide_9_1_title": "조건 循环 블록 사용하기",
    "codingparty2016_guide_9_1_contents": "循环하는 횟수를 세지 않아도, 어떤 조건을 만족할 때까지 행동을 循环할 수 있어.\n< [목적지]에 도착할 때까지 循环하기 > 블록 안에 循环되는 명령 블록을 넣으면 [목적지]에 도착할 때까지 명령을 循环해.",
    "codingparty2016_guide_9_2_title": "조건 循环 블록 사용하기",
    "codingparty2016_guide_9_2_contents": "<[목적지]에 도착할 때까지 循环하기> 블록 안에는 여러 개의 명령어를 넣을 수도 있으니 잘 활용해봐!\n 도착지에 도착했더라도 循环하기 블록 안에 있는 블록이 모두 실행 돼. 즉, 위 상황에서 목적지에 도착한 후에도 向左一步으로 돈 다음에야 끝나는 거야!",
    ...
    "hw_submit_alert2": "과제를 제출하시겠습니까? 제출 시 学习结束한 학습 단계까지만 제출이 됩니다.",
    ...
    "lesson_share_cancel_alert": "작품을 비공개하면 지금까지 받은 관심 개수가 0이 됩니다. 계속 진행하시겠습니까?",
    ...
    "art_description_1": "엔트리로 만든 ",
    "art_description_2": "개 작품의 공유 공간입니다. 작품을 만들고 공유해 보세요.",
    ...
    "solve_mission_desc_2": "미로 속의 엔트리봇을 목적지까지 움직이며 순차, 循环, 선택, 비교연산 등의 개념을 자연스럽게 익힐 수 있어요.",
    ...
    "cparty_jr_success_1": "太棒了，找到书包了!",
    "go_right": "向右一步",
    "go_down": "  向下一步",
    "go_up": "  向上一步",
    "go_left": "  向左一步",
    "go_forward": "앞으로 가기",
    "jr_turn_left": "向左一步으로 돌기",
    "jr_turn_right": "向右一步으로 돌기",
    "go_slow": "천천히 가기",
    "repeat_until_reach_1": "만날 때 까지 循环하기",
    ...
    "unpluggedDesc_2": "소프트웨어의 기본 개념과 원리(순차, 循环, 선택, 함수)를 익힐 수 있습니다.",
    "entryMaze": "엔트리봇 미로탈출",
    "entryAI": "엔트리봇 우주여행",
    ...
    "entrybot_cardgame_contents": "갑자기 엔트리도시에 나타난 12종류의 폭탄들! 과연 폭탄들을 안전하게 해체할 수 있을까요? 폭탄들을 하나씩 해체하며 엔트리 블록과 함께 소프트웨어의 원리를 배워봐요!  순차, 循环, 조건을 통해 폭탄을 하나씩 해체하다 보면 엔트리도시를 구한 영웅이 될 수 있답니다!",
    ...
    "connect_fail": "하드웨어 연결에 失败했습니다. 연결프로그램이 켜져 있는지 확인해 주세요.",
    ...
    "escape_guide_3_2": "학습 목표: 循环문과 조건문",
    ...
    "maze_1_detail": "1. 블록 꾸러미에서 원하는 블록을 꺼내어 “开始를 클릭했을 때” 블록과 연결해봐 <br> 2. 다 조립했으면, 시작을 눌러봐 <br> 3. 나는 네가 조립한 블록대로 위에서부터 순서대로 움직일게",
    ...
    "maze_2_detail_2": "1. 블록 꾸러미에서 원하는 블록을 꺼내어 “开始를 클릭했을 때” 블록과 연결해봐 <br> 2. 다 조립했으면, 시작을 눌러봐 <br> 3. 나는 네가 조립한 블록대로 위에서부터 순서대로 움직일게",
    "maze_3_intro": "멋졌어! 이제 또 다른 친구를 구하러 가자~ 이번에는 아까 구한 친구가 준 循环하기 블록을 이용해볼까? 循环하기를 이용하면 똑같은 동작을 쉽게 여러번 할 수 있어! 한 번 循环할 숫자를 바꿔볼래?",
    "maze_3_title": "循环 블록(1)",
    "maze_3_content": "(3)회 循环하기 블록은 어떻게 사용하나요?",
    "maze_3_detail": "같은 행동을 여러번 循环하려면 ~번 循环하기 블록을 사용해야 해. <br> 循环하고 싶은 블록들을 ~번 循环하기 안에 넣고 循环 횟수를 입력하면 돼",
    "maze_4_intro": "훌륭해! 이제 구해야 할 친구 로봇들도 별로 남지 않았어. 벌집에 닿지 않도록 뛰어넘기를 循环하면서 친구에게 갈 수 있게 해줘!",
    "maze_4_title": "循环 블록(1)",
    "maze_4_content": "(3)회 循环하기 블록은 어떻게 사용하나요?",
    "maze_4_detail": "같은 행동을 여러번 循环하려면 ~번 循环하기 블록을 사용해야 해. <br> 循环하고 싶은 블록들을 ~번 循环하기 안에 넣고 循环 횟수를 입력하면 돼",
    "maze_5_intro": "대단해! 이제 循环하기 블록과 만약 블록을 같이 사용해보자~ 만약 블록을 사용하면 앞에 벽이 있을 때 벽이 없는 쪽으로 회전할 수 있어. 그럼 친구를 구해주러 출발해볼까?",
    ...
    "maze_5_title_2": "循环 블록(2)",
    "maze_5_content_2": "~를 만날 때 까지 循环하기 블록은 어떻게 사용하나요?",
    "maze_5_detail_2": "~까지 循环하기'를 사용하면 같은 행동을 언제까지 循环할지를 정해줄 수 있어. <br> 循环하고 싶은 블록들을 ~까지 循环하기안에 넣으면 돼. <br> 그러면 {이미지}와 같은 타일 위에 있는 경우 循环이 멈추게 될 거야.",
    ...
    "maze_6_title_2": "循环 블록(2)",
    "maze_6_content_2": "~를 만날 때 까지 循环하기 블록은 어떻게 사용하나요?",
    "maze_6_detail_2": "~까지 循环하기'를 사용하면 같은 행동을 언제까지 循环할지를 정해줄 수 있어. <br> 循环하고 싶은 블록들을 ~까지 循环하기안에 넣으면 돼. <br> 그러면 {이미지}와 같은 타일 위에 있는 경우 循环이 멈추게 될 거야.",
    ...
    "maze_operation1_4_desc": "미션을 해결하기 위한 명령어를 다 입력했다면 <span class=\"textShadow\">[开始]</span>를 누르면 돼.</br> [开始]를 누르면 나는 명령을 내린대로 움직일 거야!</br> 각 명령어가 궁금하다면 <span class=\"textShadow\">[명령어 도움말]</span>을 확인해봐!",
    "maze_operation7_title": "7단계 - 循环 명령 알아보기(횟수循环)",
    "maze_operation7_1_desc": "<b>똑같은 일</b>을 循环해서 명령하는건 매우 귀찮은 일이야.</br>이럴땐 <span class=\"textShadow\">循环</span>과 관련된 명령어를 사용하면 훨씬 쉽게 명령을 내릴 수 있어.",
    "maze_operation7_2_desc": "그렇다면 循环되는 명령을 쉽게 내리는 방법을 알아보자.</br>먼저 循环하기 명령어를 클릭한 다음, <span class=\"textShadow\">i<1</span> 의 숫자를 바꿔서 <span class=\"textShadow\">循环횟수</span>를 정하고</br><span class=\"textShadow\">괄호({ })</span> 사이에 循环할 명령어를 넣어주면 돼!",
    "maze_operation7_3_desc": "예를 들어 이 명령어<span class=\"textBadge number1\"></span>은 move(); 를 10번 循环해서 실행해.</br><span class=\"textBadge number2\"></span>명령어와 동일한 명령어지.",
    "maze_operation7_4_desc": "이 명령어를 사용할 때는 <span class=\"textShadow\">{ } 안에 循环할 명령어</span>를 잘 입력했는지,</br><span class=\"textShadow\">`;`</span>는 빠지지 않았는지 잘 살펴봐!</br>이 명령어에 대한 자세한 설명은 [명령어 도움말]에서 볼 수 있어.",
    "maze_operation7_1_textset_1": "똑같은 명령어를 循环해서 사용하는 경우",
    "maze_operation7_1_textset_2": "循环 명령어를 사용하는 경우",
    "maze_operation7_2_textset_1": "循环 횟수",
    "maze_operation7_2_textset_2": "循环할 명령",
    "maze_operation7_4_textset_1": "괄호({})가 빠진 경우",
    "maze_operation7_4_textset_2": "세미콜론(;)이 빠진 경우",
    "study_maze_operation8_title": "8단계 - 循环 명령 알아보기(횟수循环)",
    "study_maze_operation16_title": "4단계 - 循环 명령 알아보기(조건循环)",
    "study_maze_operation1_title": "1단계 - 循环 명령 알아보기(횟수循环)",
    "maze_operation9_title": "9단계 - 循环 명령 알아보기(조건循环)",
    "maze_operation9_1_desc": "앞에서는 몇 번을 循环하는 횟수循环 명령어에 대해 배웠어.</br>이번에는 <span class=\"textShadow\">계속해서 循环하는 명령어</span>를 살펴보자.</br>이 명령어를 사용하면 미션이 끝날 때까지 <b>동일한 행동</b>을 계속 循环하게 돼.</br>이 명령어 역시 괄호({ }) 사이에 循环할 명령어를 넣어 사용할 수 있어!",
    "maze_operation9_2_desc": "예를 들어 이 명령어 <span class=\"textBadge number1\"></span>은 미션을 완료할때까지 循环해서 move(); right()를 실행해.</br><span class=\"textBadge number2\"></span>명령어와 동일한 명령어지.",
    "maze_operation9_3_desc": "이 명령어를 사용할 때도 <span class=\"textShadow\">{ } 안에 循环할 명령어</span>를 잘 입력했는지,</br><span class=\"textShadow\">`true`</span>가 빠지지 않았는지 잘 살펴봐!</br>이 명령어에 대한 자세한 설명은 [명령어 도움말]에서 볼 수 있어.",
    "maze_operation9_1_textset_1": "循环할 명령",
    "maze_operation9_3_textset_1": "괄호({})가 빠진 경우",
    "maze_operation9_3_textset_2": "세미콜론(;)이 빠진 경우",
    "maze_operation9_3_textset_3": "true가 빠진 경우",
    "study_maze_operation3_title": "3단계 - 循环 명령 알아보기(조건循环)",
    ...
    "maze_operation10_1_desc": "앞에서는 미션이 끝날 때까지 계속 循环하는 循环 명령어에 대해 배웠어.</br>이번에는 특정한 조건에서만 행동을 하는 <span class=\"textShadow\">조건 명령어</span>를 살펴보자.</br><span class=\"textBadge number2\"></span>에서 보는것처럼 조건 명령어를 사용하면 <b>명령을 보다 효율적으로 잘 내릴 수 있어.</b>",
    ...
    "maze_operation10_4_textset_3": "<span class=\"textMultiline\">계속 앞으로 가다가,</br>만약에 벽을 만나면</br>向右一步으로 회전한다.</span>",
    ...
    "maze_command_right_desc": "제자리에서 向右一步으로 90도 회전합니다.",
    "maze_command_left_desc": "제자리에서 向左一步으로 90도 회전합니다.",
    "maze_command_for_desc": "괄호<span class=\"textShadow\">{}</span> 안에 있는 명령을 <span class=\"textShadow\">입력한 횟수</span> 만큼 循环해서 실행합니다.",
    "maze_command_while_desc": "미션이 끝날 때가지 괄호<span class=\"textShadow\">{}</span> 안에 있는 명령을 계속 循环해서 실행합니다.",
    ...
    "perfect": "아주 완벽해!  ",
    "succeeded_using_blocks": " 개의 블록을 사용해서 成功했어!",
    "succeeded_using_commands": " 개의 명령어를 사용해서 成功했어!",
    "awesome": "대단한 걸!",
    "succeeded_go_to_next": "개의 블록만으로 成功했어! <br> 다음 단계로 넘어가자.",
    "good": "좋아! ",
    "but": "<br> 하지만, ",
    "try_again": " 개의 블록만으로 成功하는 방법도 있어. <br> 다시 도전해 보는건 어때?",
    "try_again_commands": " 개의 명렁어만으로 成功하는 방법도 있어. <br> 다시 도전해 보는건 어때?",
    "cfest_success": "대단한걸! 덕분에 친구들을 구할 수 있었어! <br> 아마도 너는 타고난 프로그래머 인가봐! <br> 나중에 또 만나자~!",
    "succeeded_and_cert": "개의 블록만으로 成功했어! <br>인증서를 받으러 가자.",
    ...
    "turn_ko": "으로 회전",
    "jump_over": "뛰어넘기",
    "when_start_is_pressed": "开始를 클릭했을 때",
    "repeat_until_ko": "만날 때 까지 循环",
    "repeat_until_en": "",
    "repeat_until": "만날 때 까지 循环",
    "if_there_is_1": "만약 앞에 ",
    "if_there_is_2": "있다면",
    "used_blocks": "사용 블록",
    "maximum": "목표 블록",
    ...
    "jr_intro_1": "안녕! 난 쥬니라고 해! 내 친구 엔트리봇이 向右一步에 있어! 날 친구에게 데려다 줘!",
    "jr_intro_2": "엔트리봇이 내 向左一步에 있어! 向左一步으로 가보자.",
    "jr_intro_3": "엔트리봇이 向上一步에 있어! 친구를 만날 수 있도록 도와줘!",
    "jr_intro_4": "어서 엔트리봇을 만나러 가자! 向下一步으로 가보는거야~ ",
    ...
    "jr_intro_11": "엔트리봇에게 가려면 向右一步으로 다섯번이나 가야 하잖아? 循环하기 블록을 사용해서 좀 더 쉽게 가 보자.",
    "jr_intro_12": "循环하기를 사용해서 엔트리봇을 만나러 가자.",
    "jr_intro_13": "지금 블록으로는 친구에게 갈 수가 없어. 循环 횟수를 바꿔 엔트리봇에게 갈 수 있게 해줘.",
    "jr_intro_14": "循环 블록을 사용하여 엔트리봇에게 데려다 줘.",
    "jr_intro_15": "엔트리봇이 정~말 멀리 있잖아? 그래도 循环 블록을 사용하면 쉽게 엔트리봇에게 갈 수 있을 거야.",
    ...
    "jr_popup_prefix_3": "太棒了，找到书包了！",
    "jr_popup_prefix_4": "哇哈，找到书包了。但能不能用更少的魔块呢？",
    "jr_popup_suffix_1": "谢谢，终于找到书包了！下次上学一起去哦！",
    "jr_popup_suffix": "고마워~ 덕분에 엔트리봇이랑 재밌게 놀 수 있었어~ <br>다음에 또 엔트리봇이랑 놀자~",
    "jr_fail_dont_go": "哎哦！这里好像走不通呀！再试试！",
    "jr_fail_dont_know": "哦？你让我走到哪里了呢？",
    "jr_fail_no_flower": "이런 그곳에는 꽃이 없어. 꽃이 있는 곳에서 사용해보자~",
    "jr_fail_forgot_flower": "앗! 엔트리봇한테 줄 꽃을 깜빡했어. 꽃을 모아서 가자~",
    "jr_fail_need_repeat": "没有使用循环魔块。请再试一次。",
    "jr_hint_1": "안녕! 난 쥬니라고 해! 내 친구 엔트리봇이 向右一步에 있어! 날 친구에게 데려다 줘!",
    "jr_hint_2": "엔트리봇이 내 向左一步에 있어! 向左一步으로 가보자.",
    "jr_hint_3": "엔트리봇이 向上一步에 있어! 친구를 만날 수 있도록 도와줘!",
    "jr_hint_4": "어서 엔트리봇을 만나러 가자! 向下一步으로 가보는거야~",
    ...
    "jr_hint_11": "엔트리봇에게 가려면 向右一步으로 다섯번이나 가야 하잖아? 循环하기 블록을 사용해서 좀 더 쉽게 가 보자.",
    "jr_hint_12": "循环하기를 사용해서 엔트리봇을 만나러 가자.",
    "jr_hint_13": "지금 블록으로는 친구에게 갈 수가 없어. 循环 횟수를 바꿔 엔트리봇에게 갈 수 있게 해줘.",
    "jr_hint_14": "循环 블록을 사용하여 엔트리봇에게 데려다 줘.",
    "jr_hint_15": "엔트리봇이 정~말 멀리 있잖아? 그래도 循环 블록을 사용하면 쉽게 엔트리봇에게 갈 수 있을 거야.",
    "jr_certification": "인증서",
    "jr_congrat": "축하드립니다!",
    "jr_congrat_msg": "문제해결 과정을 成功적으로 마쳤습니다.",
    "jr_share": "공유",
    ...
    "cparty_robot_intro_6": "멋져! 이제 몸이 많이 좋아져서, 똑같은 일은 여러 번 해도 괜찮을 거야! 한 번 循环하기를 사용해서 가보자!",
    "cparty_robot_intro_7": "어? 중간중간에 뛰어넘어야 할 곳이 있어! 그래도 循环하기로 충분히 갈 수 있을 거야!",
    "cparty_robot_intro_8": "이런! 이번에는 부품이 저기 멀리 떨어져 있어. 그래도 循环하기를 사용하면 쉽게 갈수 있지! 얼른 도와줘!",
    "cparty_robot_intro_9": "우와~ 이제 내 몸이 거의 다 고쳐진 것 같아! 이번에도 循环하기를 이용해서 부품을 구하러 가보자!",
    "cparty_robot_intro_10": "대단해! 이제 마지막 부품만 있으면 내 몸을 완벽하게 고칠 수 있을 거야! 빨리 循环하기로 도와줘!",
    "cparty_car_intro_1": "안녕! 나는 엔트리봇이라고 해, 자동차를 타고 계속 이동하려면 연료가 필요해! 앞에 있는 연료를 얻을 수 있게 도와줄래?",
    "cparty_car_intro_2": "좋아! 그런데 이번에는 길이 직선이 아니네! 向左一步/向右一步 돌기 블록으로 잘 운전해서 함께 연료를 얻으러 가볼까?",
    "cparty_car_intro_3": "잘했어! 이번 길 앞에는 과속방지턱이 있어. 빠르게 운전하면 사고가 날 수도 있을 것 같아, 천천히 가기 블록을 써서 연료를 얻으러 가보자!",
    "cparty_car_intro_4": "야호, 이제 운전이 한결 편해졌어! 이 도로에서는 循环하기 블록을 사용해서 연료를 채우러 가볼까?",
    "cparty_car_intro_5": "와 이번 도로는 조금 복잡해 보이지만, 앞으로 가기와 向左一步/向右一步 돌기 블록을 循环하면서 가보면 돼! 차분하게 연료까지 가보자",
    ...
    "cparty_car_intro_9": "복잡해 보이는 길이지만, 앞에서 사용한 循环 블록과 만약에 블록을 잘 이용하면 충분히 운전할 수 있어, 연료를 채울 수 있도록 도와줘!",
    ...
    "cparty_result_fail_4": "哦？你让我走到哪里了呢？",
    ...
    "zoom_in": "확대",
    "zoom_out": "축소",
    "cparty_jr_intro_1": "你好，我是机器人小白。帮我走到书包的位置，好吗？ ",
    "cparty_jr_intro_2": "书包在左边，帮我走一下吧",
    "cparty_jr_intro_3": "책가방이 向上一步에 있어! 책가방을 챙길 수 있도록 도와줘!",
    "cparty_jr_intro_4": "书包就在下面，快帮帮我吧！",
    "cparty_jr_intro_5": "우왓! 내 책가방이 멀리 떨어져 있어. 책가방이 있는 곳까지 안내해줄래?",
    "cparty_jr_intro_6": "我看到书包了，快帮帮我吧！",
    ...
    "cparty_jr_intro_11": "可以循环向右走5次。",
    "cparty_jr_intro_12": "循环하기를 사용해서 책가방을 챙기러 가자.",
    "cparty_jr_intro_13": "请使用循环的方式找到书包。试一试吧！",
    "cparty_jr_intro_14": "循环 블록을 사용하여 책가방을 챙기러 가줘.",
    "cparty_jr_intro_15": "학교가 정~말 멀리 있잖아? 그래도 循环 블록을 사용하면 쉽게 학교에 도착 할수 있을 거야.",
    ...
    "hello_kbs": "ㅋㄷㅋㄷ 코딩TV",
    "hello_kbs_sub_1": "내가 직접 만든 게임으로",
    "hello_kbs_sub_2": "‘코딩 게임왕’에 참여하세요!",
    "kbs_banner_title": "KBS <ㅋㄷㅋㄷ 코딩TV> - 양띵x코딩TV",
    "kbs_banner_subtitle": "‘코딩 게임왕’에 참여하세요!",
    "kbs_banner_desc1": "내가 만든 게임을 유투브 스타 양띵크루가 직접 게임을 해본대요!",
    "kbs_banner_desc2": "나의 게임을 방송에서 볼 수 있는 절호의 찬스,",
    "kbs_banner_desc3": "재미있는 게임을 만들어 ‘코딩 게임왕’에 도전해보세요!",
    "kbs_banner_make": "게임 만들기",
    "kbs_banner_link_txt1": "KBS 코딩TV",
    "kbs_banner_link_txt2": "바로가기",
    ...
    "maze_text_content_3": "멋진걸! 저기에도 부품이 있어! 길이 조금 꼬여있지만 向右一步, 向左一步으로 회전할 수 있는 right(); left(); 명령어를 쓰면 충분히 갈 수 있을것 같아!",
    ...
    "maze_text_content_7": "덕분에 몸이 아주 좋아졌어! 이제 똑같은 일을 여러 번 循环해도 무리는 없을 거야. 어? 그런데 앞에 있는 저 로봇은 뭐지? 뭔가 도움이 필요한 것 같아! 도와주자! for 명령어를 사용해서 저 친구한테 나를 데려다줘!",
    ...
    "maze_text_content_9": "이번에는 for 명령어 대신 미션이 끝날때까지 같은 일을 循环하도록 하는 while 명령어를 사용해봐! 나를 친구에게 데려다주면 미션이 끝나!",
    "maze_text_content_10": "이번에는 if 명령어가 나왔어! if와 while 명령어를 사용해서 내가 언제 어느 쪽으로 회전해야 하는지 알려줘!",
    "maze_text_content_11": "좋아 아까 했던 것처럼 해볼까? 언제 向左一步으로 돌아야 하는지 알려줄 수 있겠어?",
    "maze_text_content_12": "이번에는 중간중간 벌집(bee)이 있네? 언제 뛰어넘어가야 할지 알려줄래?",
    "maze_text_content_13": "여기저기 도움이 필요한 친구들이 많이 있네! 모두 가서 도와주자!",
    "maze_text_content_14": "우와 이번에도 도와줘야 할 친구들이 많네. 먼저 조그마한 사각형을 돌도록 명령어를 만들고 만든 걸 循环해서 모든 친구를 구해보자.",
    ...
    "maze_content_7": "덕분에 몸이 아주 좋아졌어! 이제 똑같은 일을 여러 번 循环해도 무리는 없을 거야. 어? 그런데 앞에 있는 저 로봇은 뭐지? 뭔가 도움이 필요한 것 같아! 도와주자! 얼른 循环하기의 숫자를 바꿔서 저 친구한테 나를 데려다줘!",
    "maze_content_8": "좋아! 덕분에 친구 로봇을 살릴 수 있었어! 하지만 앞에도 도움이 필요한 친구가 있는 것 같아, 하지만 이번에는 벌집이 있으니까 조심해서 벌집에 안 닿게 뛰어넘어가자! 할 수 있겠지? 그럼 아까 했던 것처럼 循环을 써서 친구한테 갈 수 있게 해줄래?",
    "maze_content_9": "이번에는 숫자만큼 循环하는 게 아니라 친구 로봇한테 갈 때까지 똑같은 일을 循环할 수 있어! 이번에도 친구를 구할 수 있도록 도와줘!",
    "maze_content_10": "이번에는 만약 블록이란 게 있어! 만약 블록을 써서 언제 어느 쪽으로 돌아야 하는지 알려줘!",
    "maze_content_11": "좋아 아까 했던 것처럼 해볼까? 언제 向左一步으로 돌아야 하는지 알려줄 수 있겠어?",
    "maze_content_12": "이번에는 중간중간 벌집이 있네? 언제 뛰어넘어가야 할지 알려줄래?",
    "maze_content_13": "여기저기 도움이 필요한 친구들이 많이 있네! 모두 도와주자!",
    "maze_content_14": "우와 이번에도 도와줘야 할 친구들이 많네. 먼저 조그마한 사각형을 돌도록 블록을 만들고 만든 걸 循环해서 모든 친구를 구해보자.",
    "maze_content_15": "循环을 하도 많이 했더니 자주 쓰는 블록은 외울 수 있을 것 같아! 약속 블록은 지금 내가 외운 블록들이야! 일단은 오래 움직여서 지쳤으니까 배터리를 좀 채울 수 있게 약속 호출 블록을 써서 배터리를 채울 수 있게 해줘!",
    ...
    "maze_content_18": "이번에는 길이 좀 복잡한걸? 그래도 언제 向左一步으로 돌고, 언제 向右一步으로 돌면 되는지 알려만 주면 충전할 수 있을 것 같아.",
    ...
    "maze_content_21": "안녕? 나는 엔트리 봇이야. 지금 많은 친구들이 내 도움을 필요로 하고 있어. 循环하기를 이용해서 친구들을 도울수 있게 데려다 줘!",
    "maze_content_22": "고마워! 이번에는 벌집을 뛰어넘어서 친구를 구하러 갈 수 있게 도와줘!",
    "maze_content_23": "좋아! 이번에는 친구 로봇한테 갈 때까지 循环하기를 이용해서 친구를 도울 수 있게 도와줘!",
    ...
    "ai_content_3": "좋았어! 안전하게 돌을 피했어. 그런데 앞을 봐! 아까보다 더 많은 돌이 있어. 하지만 걱정하지 마. 나에게 循环하기 블록이 있거든. 循环하기 블록 안에 움직이는 블록을 넣으면 목적지에 도착할 때까지 계속 움직일게!",
    "ai_content_4": "대단해! 循环하기 블록을 쓰니 많은 돌을 피하기가 훨씬 수월한걸! 하지만 이렇게 일일이 조종하기는 피곤하다. 나에겐 레이더가 있으니 앞으로 무엇이 나올지 알 수 있어. 앞으로 계속 가다가 앞에 돌이 있으면 피할 수 있도록 해줄래?",
    ...
    "ai_content_7": "휴~ 지구에 점점 가까워지고 있어! 돌을 피할 때 기왕이면 더 안전한 길로 가고 싶어! 아마도 돌이 더 멀리 있는 쪽이 더 안전한 길이겠지? 向上一步 레이더와 向下一步 레이더를 비교하여 더 안전한 쪽으로 움직이도록 해줄래?",
    ...
    "maze_hints_detail_1": "1. 블록 꾸러미에서 원하는 블록을 꺼내어 “开始를 클릭했을 때” 블록과 연결해봐<br>2. 다 조립했으면, 시작을 눌러봐<br>3. 나는 네가 조립한 블록대로 위에서부터 순서대로 움직일게",
    ...
    "maze_hints_title_3": "循环 블록(1)",
    "maze_hints_content_3": "(3)회 循环하기 블록은 어떻게 사용하나요?",
    "maze_hints_detail_3": "같은 행동을 여러번 循环하려면 ~번 循环하기 블록을 사용해야 해.<br>循环하고 싶은 블록들을 ~번 循环하기 안에 넣고 循环 횟수를 입력하면 돼.",
    "maze_hints_title_4": "循环 블록(2)",
    "maze_hints_content_4": "~를 만날 때 까지 循环하기 블록은 어떻게 사용하나요?",
    "maze_hints_detail_4": "~까지 循环하기'를 사용하면 같은 행동을 언제까지 循环할지를 정해줄 수 있어.<br>循环하고 싶은 블록들을 ~까지 循环하기안에 넣으면 돼.<br>그러면 {이미지}와 같은 타일 위에 있는 경우 循环이 멈추게 될 거야.",
    ...
    "maze_hints_title_6": "循环 블록(3)",
    "maze_hints_content_6": "모든 ~를 만날 때 까지 블록은 어떻게 동작하나요?",
    "maze_hints_detail_6": "모든 {타일}에 한 번씩 도착할 때까지 그 안에 있는 블록을 循环해서 실행해.<br>모든 {타일}에 한 번씩 도착하면 循环이 멈추게 될 거야.",
    "maze_hints_title_7": "특별 힌트",
    "maze_hints_content_7": "너무 어려워요. 도와주세요.",
    "maze_hints_detail_7": "내가 가야하는 길을 자세히 봐. 작은 사각형 4개가 보여?<br>작은 사각형을 도는 블록을 만들고, 循环하기를 사용해 보는것은 어때?",
    ...
    "ai_hints_content_1_1": "돌을 피해 向右一步 행성까지 안전하게 이동할 수 있도록 도와주세요.",
    "ai_hints_detail_1_1": "돌을 피해 向右一步 행성까지 안전하게 이동할 수 있도록 도와주세요.",
    "ai_hints_title_1_2": "시작 방법",
    "ai_hints_content_1_2": "어떻게 시작할 수 있나요?",
    "ai_hints_detail_1_2": "1. 블록 꾸러미에서 원하는 블록을 꺼내어 “开始를 클릭했을 때” 블록과 연결해봐<br>2. 다 조립했으면, 시작을 눌러봐<br>3. 나는 네가 조립한 블록대로 위에서부터 순서대로 움직일게",
    "ai_hints_title_1_3": "움직이게 하기",
    "ai_hints_content_1_3": "엔트리봇은 어떻게 움직이나요?",
    "ai_hints_detail_1_3": "나는 向上一步으로 가거나 앞으로 가거나 向下一步으로 갈 수 있어.<br>방향을 정할 때에는 돌이 없는 방향으로 안전하게 갈 수 있도록 해줘.<br>나를 화면 밖으로 내보내면 우주미아가 되어버리니 조심해!",
    "ai_hints_title_2_1": "게임의 목표",
    "ai_hints_content_2_1": "循环하기 블록으로 돌들을 피할 수 있도록 도와주세요.",
    "ai_hints_detail_2_1": "循环하기 블록으로 돌들을 피할 수 있도록 도와주세요.",
    "ai_hints_title_2_2": "循环 블록",
    "ai_hints_content_2_2": "循环 블록은 무슨 블록인가요?",
    "ai_hints_detail_2_2": "휴~ 이번에 가야 할 길은 너무 멀어서 하나씩 조립하기는 힘들겠는걸? 循环하기블록을 사용해봐.<br>똑같이 循环되는 블록들을 循环하기 블록으로 묶어주면 아주 긴 블록을 짧게 줄여줄 수 있어!",
    ...
    "ai_hints_detail_4_2": "레이더는 지금 내가 물체와 얼마나 떨어져 있는지 알려주는 기계야.<br>만약 바로 내 앞에 무엇인가 있다면 앞쪽 레이더는 '1'을 보여줘.<br>또, 레이더는 혼자 있을 때 보다 만약 &lt;사실&gt;이라면 / 아니면 블록과<br> 같이 쓰이면 아주 강력하게 쓸 수 있어.<br>예를 들어 내 앞에 물체와의 거리가 1보다 크다면 나는 안전하게 앞으로 갈 수 있겠지만, 아니라면 위나 向下一步으로 피하도록 할 수 있지.",
    ...
    "ai_hints_detail_5_2": "만약 ~ / 아니면 블록안에도 만약 ~ / 아니면 블록을 넣을 수 있어! 이렇게 되면 다양한 상황에서 내가 어떻게 행동해야 할지 정할 수 있어.<br>예를 들어 앞에 돌이 길을 막고 있을때와 없을때의 행동을 정한다음, 돌이 있을때의 상황에서도 상황에 따라 向上一步으로 갈지 向下一步으로 갈지 선택 할 수 있어",
    "ai_hints_title_6_1": "레이더(2)",
    "ai_hints_content_6_1": "向上一步 레이더와 向下一步 레이더의 값을 비교하고 싶을 땐 어떻게 하나요?",
    "ai_hints_detail_6_1": "([向上一步]레이더) 블록은 向上一步 물체까지의 거리를 뜻하는 블록이야.<br>向下一步과 向上一步 중에서 어느 쪽에 돌이 더 멀리 있는지 확인하기 위해서 쓸 수 있는 블록이지.<br>돌을 피해가는 길을 선택할 때에는 돌이 멀리 떨어져 있는 쪽으로 피하는게 앞으로 멀리 가는데 유리할거야~",
    ...
    "ai_hints_detail_7_2": "아이템을 얻기위해서는 아이템이 어디에 있는지 확인할 필요가 있어. <br>그럴 때 사용할 수 있는 블록이 [向上一步] 물체는 [아이템]인가? 블록이야.<br>이 블록을 활용하면 아이템이 어느 위치에 있는지 알 수 있고 아이템이 있는 방향으로 움직이도록 블록을 조립할 수 있어.",
    ...
    "maze_when_run": "开始를 클릭했을때",
    "maze_turn_left": "向左一步으로 회전",
    "maze_turn_right": "向右一步으로 회전",
    "maze_repeat_times_1": "",
    "maze_repeat_times_2": "번 循环하기",
    "maze_repeat_until_1": "",
    "maze_repeat_until_2": "을 만날때까지 循环",
    "maze_call_function": "약속 불러오기",
    "maze_function": "약속하기",
    "maze_repeat_until_all_1": "모든",
    "maze_repeat_until_all_2": "만날 때 까지 循环",
    ...
    "ai_move_above": "向上一步으로 가기",
    "ai_move_under": "向下一步으로 가기",
    "ai_repeat_until_dest": "목적지에 도달 할 때까지 循环하기",
    "ai_if_front_1": "만약 앞에",
    "ai_if_front_2": "가 있다면",
    "ai_else": "아니면",
    "ai_if_1": "만약",
    ...
    "maze_perfect_success": "멋져! 완벽하게 成功했어~",
    ...
    "maze_success_perfect": "멋져! 완벽하게 成功했어~",
    "maze_success_block_excess": "좋아! %1개의 블록을 사용해서 成功했어! <br> 하지만, %2개의 블록만으로 成功하는 방법도 있어. 다시 도전해 보는 건 어때?",
    "maze_success_not_essential": "좋아! %1개의 블록을 사용해서 成功했어! <br>하지만 이 블록을 사용하면 더 쉽게 해결할 수 있어. 다시 도전해 보는 건 어때?",
    "maze_success_final_perfect_basic": "좋아! 샐리 공주가 어디 있는지 찾았어! 이제 샐리 공주를 구할 수 있을 거야!",
    "maze_success_final_block_excess_basic": "좋아! 샐리 공주가 어디 있는지 찾았어! 이제 샐리 공주를 구할 수 있을 거야!%1개의 블록을 사용했는데, %2개의 블록만으로 成功하는 방법도 있어. 다시 해볼래?",
    "maze_success_final_perfect_advanced": "샐리 공주가 있는 곳까지 도착했어! 이제 악당 메피스토를 물리치고 샐리를 구하면 돼!",
    "maze_success_final_block_excess_advanced": "샐리 공주가 있는 곳까지 도착했어! 이제 악당 메피스토를 물리치고 샐리를 구하면 돼!%1개의 블록을 사용했는데, %2개의 블록만으로 成功하는 방법도 있어. 다시 해볼래?",
    ...
    "maple_success_perfect": "좋아! 완벽하게 成功했어!!",
    "maple_success_block_excess": "좋아! %1개의 블록을 사용해서 成功했어! <br> 그런데 %2개의 블록으로도 成功하는 방법이 있어. 다시 도전해 보는건 어때?",
    "maple_success_not_essential": "좋아! %1개의 블록을 사용해서 成功했어! <br>그런데 이 블록을 사용하면 더 쉽게 해결할 수 있어. 다시 도전해 보는 건 어때?",
    "maple_success_final_perfect_henesys": "멋져! 헤네시스 모험을 훌륭하게 해냈어.",
    "maple_success_final_perfect_excess_henesys": "멋져! 헤네시스 모험을 잘 해냈어.<br />그런데 %2개의 블록으로도 成功하는 방법이 있어. 다시 도전해 보는 건 어때?",
    ...
    "maple_success_final_perfect_excess_ellinia": "우와! 이 곳에서 정말 재밌는 모험을 했어!<br />그런데 %2개의 블록으로도 成功하는 방법이 있어. 다시 도전해 보는 건 어때?",
    ...
    "maple_fail_more_move": "成功하려면 목적지까지 조금 더 움직여야 해!",
    ...
    "codingparty_2016_content": "미션에 참여한 사용자들의 블록 조립 순서, 成功/失败 유무가 학년, 성별 정보와 함께 제공됩니다.",
...
Lang.Msgs = {
    ...
    "monthly_description_2": "~인 동안 循环하기를 이용한 퍼즐 게임과 복제본, 무작위 수를 이용한 애니메이션 작품을 만들어 봅시다.",
    "monthly_description_3": "계속 循环하기 블록과 수학 연산 블록을 활용하여 물고기 미디어 아트 작품과 태양계를 만들어 봅시다.",
    ...
    "quiz_correct": "정답이야!",
    "hw_connection_success": "하드웨어 연결 成功",
...
Lang.Users = {
    "auth_failed": "인증에 失败하였습니다",
    "birth_year": "태어난 해",
    "birth_year_before_1990": "1990년 返回",
    "edit_personal": "정보수정",
    "email": "이메일",
...
Lang.Workspace = {
    ...
    "cannot_add_object": "执行中에는 오브젝트를 추가할 수 없습니다.",
    "cannot_add_picture": "执行中에는 모양을 추가할 수 없습니다.",
    "cannot_add_sound": "执行中에는 소리를 추가할 수 없습니다.",
    "cannot_edit_click_to_stop": "执行中에는 수정할 수 없습니다.\n클릭하여 정지하기.",
    ...
    "list_rename_failed": "리스트 이름 변경 失败",
    "list_rename_ok": "리스트의 이름이 成功적으로 변경 되었습니다.",
    "list_too_long": "리스트의 이름이 너무 깁니다.",
    "message": "신호",
    "message_add_cancel": "신호 추가 취소",
    "message_add_cancel_msg": "신호 추가를 취소하였습니다.",
    "message_add_fail": "신호 추가 失败",
    ...
    "message_rename_failed": "신호 이름 변경에 失败하였습니다. ",
    "message_rename_ok": "신호의 이름이 成功적으로 변경 되었습니다.",
    ...
    "object_not_found_for_paste": "粘贴 할 오브젝트가 없습니다.",
    "people": "일반 사람들",
    "picture_add": "모양 추가",
    "plant": "식물",
    "project": "작품",
    ...
    "removed_msg": "(이)가 成功적으로 삭제 되었습니다.",
    "rotate_method": "회전방식",
    "rotation": "방향",
    "run": "开始",
    "saved": "저장완료",
    ...
    "variable_rename_failed": "변수 이름 변경에 失败하였습니다. ",
    "variable_rename_msg": "'변수의 이름이 成功적으로 변경 되었습니다.'",
    "variable_rename_ok": "변수의 이름이 成功적으로 변경 되었습니다.",
...
Lang.Helper = {
    "when_run_button_click": "开始 버튼을 클릭하면 아래에 연결된 블록들을 실행합니다.",
    ...
    "start_neighbor_scene": "返回 장면 또는 다음 장면을 시작합니다.",
    "wait_second": "설정한 시간만큼 기다린 후 다음 블록을 실행 합니다.",
    "repeat_basic": "설정한 횟수만큼 감싸고 있는 블록들을 循环 실행합니다.",
    "repeat_inf": "감싸고 있는 블록들을 계속해서 循环 실행합니다.",
    "repeat_while_true": "판단이 참인 동안 감싸고 있는 블록들을 循环 실행합니다.",
    "stop_repeat": "이 블록을 감싸는 가장 가까운 循环 블록의 循环을 중단 합니다.",
    ...
    "move_to_angle": "설정한 각도 방향으로 입력한 값만큼 움직입니다. (실행화면 向上一步이 0도, 시계방향으로 갈수록 각도 증가)",
    ...
    "set_effect_amount": "색깔 : 오브젝트에 색깔 효과를 입력한 값만큼 줍니다. (0~100을 주기로 循环됨)<br>밝기 : 오브젝트에 밝기 효과를 입력한 값만큼 줍니다. (-100~100 사이의 범위, -100 이하는 -100으로 100 이상은 100으로 처리 됨) <br> 투명도 : 오브젝트에 투명도 효과를 입력한 값만큼 줍니다. (0~100 사이의 범위, 0이하는 0으로, 100 이상은 100으로 처리됨)",
    ...
    "change_effect_amount": "색깔 : 오브젝트의 색깔 효과를 입력한 값으로 정합니다. (0~100을 주기로 循环됨) <br> 밝기 : 오브젝트의 밝기 효과를 입력한 값으로 정합니다. (-100~100 사이의 범위, -100 이하는 -100으로 100 이상은 100으로 처리 됨) <br> 투명도 : 오브젝트의 투명도 효과를 입력한 값으로 정합니다. (0~100 사이의 범위, 0이하는 0으로, 100 이상은 100으로 처리됨)",
    ...
    "boolean_basic_operator": "= : 向左一步에 위치한 값과 向右一步에 위치한 값이  같으면 '참'으로 판단합니다.<br>> : 向左一步에 위치한 값이 向右一步에 위치한 값보다 크면 '참'으로 판단합니다.<br>< : 向左一步에 위치한 값이 向右一步에 위치한 값보다 작으면 '참'으로 판단합니다.<br>≥ : 向左一步에 위치한 값이 向右一步에 위치한 값보다 크거나 같으면 '참'으로 판단합니다.<br>≤ : 向左一步에 위치한 값이 向右一步에 위치한 값보다 작거나 같으면 '참'으로 판단합니다.",
    "function_create": "자주 쓰는 코드를 이 블록 아래에 조립하여 함수로 만듭니다. [함수 정의하기]의 向右一步 빈칸에 [이름]을 조립하여 함수의 이름을 정할 수 있습니다. 함수를 실행하는 데 입력값이 필요한 경우 빈칸에 [문자/숫자값], [판단값]을 조립하여 매개변수로 사용합니다.",
    ...
    "choose_project_timer_action": "开始: 초시계를 시작합니다. <br> 정지하기: 초시계를 정지합니다. <br> 초기화하기: 초시계의 값을 0으로 초기화합니다. <br> (이 블록을 블록조립소로 가져오면 실행화면에 ‘초시계 창’이 생성됩니다.)",
    ...
    "robotis_carCont_sensor_value": "向左一步 접속 센서 : 접촉(1), 비접촉(0) 값 입니다.<br/>向右一步 접촉 센서 : 접촉(1), 비접촉(0) 값 입니다.<br/>선택 버튼 상태 : 접촉(1), 비접촉(0) 값 입니다.<br/>최종 소리 감지 횟수 : 마지막 실시간 소리 감지 횟수 값 입니다.<br/>실시간 소리 감지 횟수 : 약 1초 안에 다음 소리가 감지되면 1씩 증가합니다.<br/>向左一步 적외선 센서 : 물체와 가까울 수록 큰 값 입니다.<br/>向右一步 적외선 센서 : 물체와 가까울 수록 큰 값 값 입니다.<br/>向左一步 적외선 센서 캘리브레이션 값 : 적외선 센서의 캘리브레이션 값 입니다.<br/>向右一步 적외선 센서 캘리브레이션 값 : 적외선 센서의 캘리브레이션 값 입니다.<br/>(*캘리브레이션 값 - 적외선센서 조정 값)",
    ...
    "hamster_change_both_wheels_by": "向左一步과 向右一步 바퀴의 현재 속도 값(%)에 입력한 값을 각각 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    ...
    "hamster_change_wheel_by": "向左一步/向右一步/양쪽 바퀴의 현재 속도 값(%)에 입력한 값을 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    "hamster_clear_buzzer": "버저 소리를 끕니다.",
    "hamster_clear_led": "向左一步/向右一步/양쪽 LED를 끕니다.",
    "hamster_follow_line_until": "向左一步/向右一步/앞쪽/뒤쪽의 검은색/하얀색 선을 따라 이동하다가 교차로를 만나면 정지합니다.",
    "hamster_follow_line_using": "向左一步/向右一步/양쪽 바닥 센서를 사용하여 검은색/하얀색 선을 따라 이동합니다.",
    ...
    "hamster_set_both_wheels_to": "向左一步과 向右一步 바퀴의 속도를 입력한 값(-100 ~ 100%)으로 각각 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    ...
    "hamster_set_led_to": "向左一步/向右一步/양쪽 LED를 선택한 색깔로 켭니다.",
    ...
    "hamster_set_wheel_to": "向左一步/向右一步/양쪽 바퀴의 속도를 입력한 값(-100 ~ 100%)으로 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    "hamster_stop": "양쪽 바퀴를 정지합니다.",
    "hamster_turn_for_secs": "입력한 시간(초) 동안 向左一步/向右一步 방향으로 제자리에서 회전합니다.",
    "hamster_turn_once": "말판 위에서 向左一步/向右一步 방향으로 제자리에서 90도 회전합니다.",
    "hamster_value": "向左一步 근접 센서: 向左一步 근접 센서의 값 (값의 범위: 0 ~ 255, 초기값: 0)<br/>向右一步 근접 센서: 向右一步 근접 센서의 값 (값의 범위: 0 ~ 255, 초기값: 0)<br/>向左一步 바닥 센서: 向左一步 바닥 센서의 값 (값의 범위: 0 ~ 100, 초기값: 0)<br/>向右一步 바닥 센서: 向右一步 바닥 센서의 값 (값의 범위: 0 ~ 100, 초기값: 0)<br/>x축 가속도: 가속도 센서의 X축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇이 전진하는 방향이 X축의 양수 방향입니다.<br/>y축 가속도: 가속도 센서의 Y축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇의 向左一步 방향이 Y축의 양수 방향입니다.<br/>z축 가속도: 가속도 센서의 Z축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇의 向上一步 방향이 Z축의 양수 방향입니다.<br/>밝기: 밝기 센서의 값 (값의 범위: 0 ~ 65535, 초기값: 0) 밝을 수록 값이 커집니다.<br/>온도: 로봇 내부의 온도 값 (값의 범위: 섭씨 -40 ~ 88도, 초기값: 0)<br/>신호 세기: 블루투스 무선 통신의 신호 세기 (값의 범위: -128 ~ 0 dBm, 초기값: 0) 신호의 세기가 셀수록 값이 커집니다.<br/>입력 A: 외부 확장 포트 A로 입력되는 신호의 값 (값의 범위: 아날로그 입력 0 ~ 255, 디지털 입력 0 또는 1, 초기값: 0)<br/>입력 B: 외부 확장 포트 B로 입력되는 신호의 값 (값의 범위: 아날로그 입력 0 ~ 255, 디지털 입력 0 또는 1, 초기값: 0)",
    "roboid_hamster_beep": "버저 소리를 짧게 냅니다.",
    "roboid_hamster_change_both_wheels_by": "向左一步과 向右一步 바퀴의 현재 속도 값(%)에 입력한 값을 각각 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    ...
    "roboid_hamster_change_wheel_by": "向左一步/向右一步/양쪽 바퀴의 현재 속도 값(%)에 입력한 값을 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    "roboid_hamster_clear_buzzer": "버저 소리를 끕니다.",
    "roboid_hamster_clear_led": "向左一步/向右一步/양쪽 LED를 끕니다.",
    "roboid_hamster_follow_line_until": "向左一步/向右一步/앞쪽/뒤쪽의 검은색/하얀색 선을 따라 이동하다가 교차로를 만나면 정지합니다.",
    "roboid_hamster_follow_line_using": "向左一步/向右一步/양쪽 바닥 센서를 사용하여 검은색/하얀색 선을 따라 이동합니다.",
    ...
    "roboid_hamster_set_both_wheels_to": "向左一步과 向右一步 바퀴의 속도를 입력한 값(-100 ~ 100%)으로 각각 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    ...
    "roboid_hamster_set_led_to": "向左一步/向右一步/양쪽 LED를 선택한 색깔로 켭니다.",
    ...
    "roboid_hamster_set_wheel_to": "向左一步/向右一步/양쪽 바퀴의 속도를 입력한 값(-100 ~ 100%)으로 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    "roboid_hamster_stop": "양쪽 바퀴를 정지합니다.",
    "roboid_hamster_turn_for_secs": "입력한 시간(초) 동안 向左一步/向右一步 방향으로 제자리에서 회전합니다.",
    "roboid_hamster_turn_once": "말판 위에서 向左一步/向右一步 방향으로 제자리에서 90도 회전합니다.",
    "roboid_hamster_value": "向左一步 근접 센서: 向左一步 근접 센서의 값 (값의 범위: 0 ~ 255, 초기값: 0)<br/>向右一步 근접 센서: 向右一步 근접 센서의 값 (값의 범위: 0 ~ 255, 초기값: 0)<br/>向左一步 바닥 센서: 向左一步 바닥 센서의 값 (값의 범위: 0 ~ 100, 초기값: 0)<br/>向右一步 바닥 센서: 向右一步 바닥 센서의 값 (값의 범위: 0 ~ 100, 초기값: 0)<br/>x축 가속도: 가속도 센서의 X축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇이 전진하는 방향이 X축의 양수 방향입니다.<br/>y축 가속도: 가속도 센서의 Y축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇의 向左一步 방향이 Y축의 양수 방향입니다.<br/>z축 가속도: 가속도 센서의 Z축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇의 向上一步 방향이 Z축의 양수 방향입니다.<br/>밝기: 밝기 센서의 값 (값의 범위: 0 ~ 65535, 초기값: 0) 밝을 수록 값이 커집니다.<br/>온도: 로봇 내부의 온도 값 (값의 범위: 섭씨 -40 ~ 88도, 초기값: 0)<br/>신호 세기: 블루투스 무선 통신의 신호 세기 (값의 범위: -128 ~ 0 dBm, 초기값: 0) 신호의 세기가 셀수록 값이 커집니다.<br/>입력 A: 외부 확장 포트 A로 입력되는 신호의 값 (값의 범위: 아날로그 입력 0 ~ 255, 디지털 입력 0 또는 1, 초기값: 0)<br/>입력 B: 외부 확장 포트 B로 입력되는 신호의 값 (값의 범위: 아날로그 입력 0 ~ 255, 디지털 입력 0 또는 1, 초기값: 0)",
    ...
    "roboid_turtle_change_wheel_by": "向左一步/向右一步/양쪽 바퀴의 현재 속도 값(%)에 입력한 값을 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    "roboid_turtle_change_wheels_by_left_right": "向左一步과 向右一步 바퀴의 현재 속도 값(%)에 입력한 값을 각각 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    ...
    "roboid_turtle_pivot_around_wheel_unit_in_direction": "向左一步/向右一步 바퀴 중심으로 입력한 각도(도)/시간(초)/펄스만큼 머리/꼬리 방향으로 회전합니다.",
    ...
    "roboid_turtle_set_wheel_to": "向左一步/向右一步/양쪽 바퀴의 속도를 입력한 값(-400 ~ 400%)으로 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    "roboid_turtle_set_wheels_to_left_right": "向左一步과 向右一步 바퀴의 속도를 입력한 값(-400 ~ 400%)으로 각각 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    "roboid_turtle_stop": "양쪽 바퀴를 정지합니다.",
    "roboid_turtle_touching_color": "선택한 색깔을 컬러 센서가 감지하였으면 '참'으로 판단하고, 아니면 '거짓'으로 판단합니다.",
    "roboid_turtle_turn_at_intersection": "검은색 교차로에서 잠시 앞으로 이동한 후 제자리에서 向左一步/向右一步/뒤쪽으로 회전하고 검은색 선을 찾아 다시 이동합니다.",
    "roboid_turtle_turn_unit_in_place": "입력한 각도(도)/시간(초)/펄스만큼 向左一步/向右一步 방향으로 제자리에서 회전합니다.",
    "roboid_turtle_turn_unit_with_radius_in_direction": "입력한 반지름의 원을 그리면서 입력한 각도(도)/시간(초)/펄스만큼 向左一步/向右一步, 머리/꼬리 방향으로 회전합니다.",
    "roboid_turtle_value": "색깔 번호: 컬러 센서가 감지한 색깔의 번호 (값의 범위: -1 ~ 8, 초기값: -1)<br/>색깔 패턴: 컬러 센서가 감지한 색깔 패턴의 값 (값의 범위: -1 ~ 88, 초기값: -1)<br/>바닥 센서: 바닥 센서의 값 (값의 범위: 0 ~ 100, 초기값: 0)<br/>버튼: 거북이 등 버튼의 상태 값 (누르면 1, 아니면 0, 초기값: 0)<br/>x축 가속도: 가속도 센서의 X축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇이 전진하는 방향이 X축의 양수 방향입니다.<br/>y축 가속도: 가속도 센서의 Y축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇의 向左一步 방향이 Y축의 양수 방향입니다.<br/>z축 가속도: 가속도 센서의 Z축 값 (값의 범위: -32768 ~ 32767, 초기값: 0) 로봇의 向上一步 방향이 Z축의 양수 방향입니다.",
    ...
    "turtle_change_wheel_by": "向左一步/向右一步/양쪽 바퀴의 현재 속도 값(%)에 입력한 값을 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    "turtle_change_wheels_by_left_right": "向左一步과 向右一步 바퀴의 현재 속도 값(%)에 입력한 값을 각각 더합니다. 더한 결과가 양수 값이면 바퀴가 앞으로 회전하고, 음수 값이면 뒤로 회전합니다.",
    ...
    "turtle_pivot_around_wheel_unit_in_direction": "向左一步/向右一步 바퀴 중심으로 입력한 각도(도)/시간(초)/펄스만큼 머리/꼬리 방향으로 회전합니다.",
    ...
    "turtle_set_wheel_to": "向左一步/向右一步/양쪽 바퀴의 속도를 입력한 값(-400 ~ 400%)으로 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    "turtle_set_wheels_to_left_right": "向左一步과 向右一步 바퀴의 속도를 입력한 값(-400 ~ 400%)으로 각각 설정합니다. 양수 값을 입력하면 바퀴가 앞으로 회전하고, 음수 값을 입력하면 뒤로 회전합니다. 숫자 0을 입력하면 정지합니다.",
    "turtle_stop": "양쪽 바퀴를 정지합니다.",
    "turtle_touching_color": "선택한 색깔을 컬러 센서가 감지하였으면 '참'으로 판단하고, 아니면 '거짓'으로 판단합니다.",
    "turtle_turn_at_intersection": "검은색 교차로에서 잠시 앞으로 이동한 후 제자리에서 向左一步/向右一步/뒤쪽으로 회전하고 검은색 선을 찾아 다시 이동합니다.",
    "turtle_turn_unit_in_place": "입력한 각도(도)/시간(초)/펄스만큼 向左一步/向右一步 방향으로 제자리에서 회전합니다.",
    "turtle_turn_unit_with_radius_in_direction": "입력한 반지름의 원을 그리면서 입력한 각도(도)/시간(초)/펄스만큼 向左一步/向右一步, 머리/꼬리 방향으로 회전합니다.",
    ...
    "byrobot_dronefighter_controller_controller_vibrator_delay": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
    "byrobot_dronefighter_controller_controller_vibrator_reserve": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    ...
    "byrobot_dronefighter_drive_drone_motorsingle": "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    "byrobot_dronefighter_drive_drone_motorsingle_input": "<br>지정한 모터(1, 2, 3, 4)를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    ...
    "byrobot_dronefighter_drive_controller_vibrator_delay": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
    "byrobot_dronefighter_drive_controller_vibrator_reserve": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    ...
    "byrobot_dronefighter_flight_drone_motorsingle": "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#모터제어</font>",
    "byrobot_dronefighter_flight_drone_motorsingle_input": "<br>지정한 모터(1, 2, 3, 4)를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#모터제어</font>",
    ...
    "byrobot_dronefighter_flight_controller_vibrator_delay": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
    "byrobot_dronefighter_flight_controller_vibrator_reserve": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    ...
    "byrobot_petrone_v2_controller_controller_value_joystick": "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br><br>조이스틱 방향은 가로x세로 = 3x3 = 총9방향입니다.<br>위(向左一步=17, 가운데=18, 向右一步=20)<br>중간(向左一步=33, 센터=34, 向右一步=36)<br>아래(向左一步=65, 가운데=66, 向右一步=68)<br>기본값은 센터=34입니다.<br><br>조이스틱 이벤트는 값이 있을때 2, 없으면 0, 진입 1, 벗어남 3입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
    "byrobot_petrone_v2_controller_controller_vibrator_delay": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
    ...
    "byrobot_petrone_v2_controller_controller_vibrator_reserve": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    ...
    "byrobot_petrone_v2_drive_controller_value_joystick": "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br><br>조이스틱 방향은 가로x세로 = 3x3 = 총9방향입니다.<br>위(向左一步=17, 가운데=18, 向右一步=20)<br>중간(向左一步=33, 센터=34, 向右一步=36)<br>아래(向左一步=65, 가운데=66, 向右一步=68)<br>기본값은 센터=34입니다.<br><br>조이스틱 이벤트는 값이 있을때 2, 없으면 0, 진입 1, 벗어남 3입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
    "byrobot_petrone_v2_drive_controller_vibrator_delay": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
    ...
    "byrobot_petrone_v2_drive_controller_vibrator_reserve": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    ...
    "byrobot_petrone_v2_drive_drone_motorsingle": "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 자동차의 바퀴가 움직이기 위해서는 2700 이상을 입력해야 합니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    "byrobot_petrone_v2_drive_drone_motorsingle_input": "<br>지정한 모터(1, 2, 3, 4)를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 자동차의 바퀴가 움직이기 위해서는 2700 이상을 입력해야 합니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    "byrobot_petrone_v2_drive_drone_motorsingle_rotation": "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 1번 모터와 2번 모터는 역방향도 회전 가능하기 때문에 방향도 선택할 수 있습니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 자동차의 바퀴가 움직이기 위해서는 2700 이상을 입력해야 합니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    ...
    "byrobot_petrone_v2_flight_controller_value_joystick": "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br><br>조이스틱 방향은 가로x세로 = 3x3 = 총9방향입니다.<br>위(向左一步=17, 가운데=18, 向右一步=20)<br>중간(向左一步=33, 센터=34, 向右一步=36)<br>아래(向左一步=65, 가운데=66, 向右一步=68)<br>기본값은 센터=34입니다.<br><br>조이스틱 이벤트는 값이 있을때 2, 없으면 0, 진입 1, 벗어남 3입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
    "byrobot_petrone_v2_flight_controller_vibrator_delay": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环합니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
    ...
    "byrobot_petrone_v2_flight_controller_vibrator_reserve": "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 循环하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    ...
    "byrobot_petrone_v2_flight_drone_motorsingle": "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#모터제어</font>",
    "byrobot_petrone_v2_flight_drone_motorsingle_input": "<br>지정한 모터(1, 2, 3, 4)를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#모터제어</font>",
    "byrobot_petrone_v2_flight_drone_motorsingle_rotation": "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 1번 모터와 2번 모터는 역방향도 회전 가능하기 때문에 방향도 선택할 수 있습니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '向左一步 앞', '向右一步 앞', '向右一步 뒤', '向左一步 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
...
Lang.template = {
    ...
    "albert_change_both_wheels_by": "向左一步 바퀴 %1 向右一步 바퀴 %2 만큼 바꾸기 %3",
    "albert_set_both_wheels_to": "向左一步 바퀴 %1 向右一步 바퀴 %2 (으)로 정하기 %3",
    ...
    "repeat_basic": "%1 번 循环하기 %2",
    "hidden_loop": "%1 번 循环하기 %2",
    "repeat_inf": "계속 循环하기 %1",
    "stop_repeat": "循环 중단하기 %1",
    ...
    "hamster_change_both_wheels_by": "向左一步 바퀴 %1 向右一步 바퀴 %2 만큼 바꾸기 %3",
    "hamster_set_both_wheels_to": "向左一步 바퀴 %1 向右一步 바퀴 %2 (으)로 정하기 %3",
    ...
    "roboid_hamster_change_both_wheels_by": "햄스터 %1: 向左一步 바퀴 %2 向右一步 바퀴 %3 만큼 바꾸기 %4",
    ...
    "roboid_hamster_set_both_wheels_to": "햄스터 %1: 向左一步 바퀴 %2 向右一步 바퀴 %3 (으)로 정하기 %4",
    ...
    "roboid_turtle_change_wheels_by_left_right": "거북이 %1: 向左一步 바퀴 %2 向右一步 바퀴 %3 만큼 바꾸기 %4",
    ...
    "roboid_turtle_set_wheels_to_left_right": "거북이 %1: 向左一步 바퀴 %2 向右一步 바퀴 %3 (으)로 정하기 %4",
    ...
    "turtle_change_wheels_by_left_right": "向左一步 바퀴 %1 向右一步 바퀴 %2 만큼 바꾸기 %3",
    ...
    "turtle_set_wheels_to_left_right": "向左一步 바퀴 %1 向右一步 바퀴 %2 (으)로 정하기 %3",
    "turtle_stop": "정지하기 %1",
    ...
    "neobot_turn_left": "向左一步모터를 %1 %2 회전 %3",
    "neobot_stop_left": "向左一步모터 정지 %1",
    "neobot_turn_right": "向右一步모터를 %1 %2 회전 %3",
    "neobot_stop_right": "向右一步모터 정지 %1",
    ...
    "start_scene": "%1 开始 %2",
    "start_neighbor_scene": "%1 장면 开始 %2",
    ...
    "when_run_button_click": "%1 开始 버튼을 클릭했을 때",
    ...
    "xbot_twoWheel": "바퀴(DC) 모터 向右一步(2) 속도: %1 向左一步(1) 속도: %2 %3",
    ...
    "jr_turn_left": "向左一步으로 돌기%1",
    "jr_turn_right": "向右一步으로 돌기%1",
    "jr_go_slow": "천천히 가기 %1",
    "jr_repeat_until_dest": "%1 만날 때까지 循环하기 %2",
    "jr_if_construction": "만약 %1 앞에 있다면 %2",
    "jr_if_speed": "만약 %1 앞에 있다면 %2",
    "maze_step_start": "%1 开始를 클릭했을 때",
    "maze_step_jump": "뛰어넘기%1",
    "maze_step_jump2": "뛰어넘기%1",
    "maze_step_jump_pinkbean": "뛰어넘기%1",
    "maze_step_for": "%1 번 循环하기%2",
    "test": "%1 this is test block %2",
    "maze_repeat_until_1": "%1 만날 때 까지 循环%2",
    "maze_repeat_until_2": "모든 %1 만날 때 까지 循环%2",
    ...
    "maze_step_rotate_left": "向左一步으로 회전%1",
    "maze_step_rotate_right": "向右一步으로 회전%1",
    "maze_step_forward": "앞으로 가기%1",
    "maze_turn_right": "向右一步 바라보기%1",
    "maze_turn_left": "向左一步 바라보기%1",
    ...
    "maze_step_if_left_monster": "만약 向左一步 공격범위에 몬스터가 있다면 %1 %2 아니면",
    "maze_step_if_right_monster": "만약 向右一步 공격범위에 몬스터가 있다면 %1 %2 아니면",
    ...
    "maze_rotate_left": "向左一步으로 돌기%1",
    "maze_rotate_right": "向右一步으로 돌기%1",
    "maze_moon_kick": "발차기하기%1",
    "maze_repeat_until_3": "%1에 도착할 때까지 循环하기%2",
    "maze_repeat_until_4": "%1에 도착할 때까지 循环하기%2",
    "maze_repeat_until_5": "%1에 도착할 때까지 循环하기%2",
    "maze_repeat_until_6": "%1에 도착할 때까지 循环하기%2",
    "maze_repeat_until_7": "%1에 도착할 때까지 循环하기%2",
    "maze_repeat_until_goal": "목적지에 도착할 때까지 循环하기%1",
    "maze_repeat_until_beat_monster": "모든 몬스터를 혼내줄 때까지 循环하기%1",
    ...
    "ai_move_up": "向上一步으로 가기 %1",
    "ai_move_down": "向下一步으로 가기 %1",
    "ai_repeat_until_reach": "목적지에 도달 할 때까지 循环하기 %1",
    ...
    "ardublock_get_left_cds_analog_value": "向左一步 조도센서 %1 센서값",
    "ardublock_get_right_cds_analog_value": "向右一步 조도센서 %1 센서값",
    "ardublock_get_sound_analog_value": "사운드(소리) 센서 %1 센서값",
    "ardublock_get_ultrasonic_value": "초음파센서 Trig %1 Echo %2 센서값",
    "ardublock_set_left_motor": "向左一步모터를 %1 으로 %2 회전 속도로 정하기 %3",
    "ardublock_set_right_motor": "向右一步모터를 %1 으로 %2 회전 속도로 정하기 %3",
    ...
    "ardublock_toggle_left_led": "向左一步 라이트 %1 번 핀 %2 %3",
    "ardublock_toggle_right_led": "向右一步 라이트 %1 번 핀 %2 %3",
    ...
    "altino_rear_wheel": "뒷바퀴 向右一步 %1 向左一步 %2 로 정하기 %3",
...
Lang.PythonHelper = {
    "when_run_button_click_desc": "[开始]버튼을 클릭하면 아래 명령어들을 실행합니다.<br>아래 명령어는 [Tab]키를 통해 들여쓰기합니다.",
    "when_run_button_click_exampleCode": "def when_start():\n    Entry.print(\"안녕!\")",
    "when_run_button_click_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"안녕!\"이라 말합니다.",
    ...
    "message_cast_exampleDesc": "[开始]버튼을 클릭하면 \"오브젝트1\"이 \"안녕! 넌 몇살이니?\"라고 2초간 말하고 \"신호를 보냅니다., \"오브젝트2\"가 \"신호\"를 받았을때 \"안녕? 난 세 살이야.\"라고 2초간 말합니다.",
    ...
    "message_cast_wait_exampleDesc": "[开始]버튼을 클릭하면 \"오브젝트1\"이 \"숨바꼭질하자!\"라고 2초 동안 말하고 \"신호\"를 보낸 후 기다립니다. \"오브젝트2\"가 \"신호\"를 받으면 \"그래!\"를 2초 동안 말합니다. \"오브젝트1\"이 그 후에 모양을 숨깁니다.",
    ...
    "when_scene_start_exampleDesc": "\"장면 1\"에서 [开始]버튼을 클릭하면 \"다른 곳으로 가볼까?\"라고 2초간 말하고, \"장면 2\"가 시작됩니다. \"장면 2\"가 시작되면 오브젝트가 \"여기가 어디지?\"라고 말합니다.",
    ...
    "start_neighbor_scene_desc": "A에 입력한 다음 또는 返回 장면을 시작합니다.",
    "start_neighbor_scene_elements": "A-- 아래 선택지 중 하나<br>① 다음 장면: \"next\" 또는 \"다음\"<br>② 返回 장면: \"pre\" 또는 \"返回\"",
    ...
    "start_neighbor_scene_exampleDesc": "\"장면 1\"에서 向右一步화살표키를 누르면 다음 장면이, \"장면 2\"에서 向左一步화살표키를 누르면 返回 장면이 시작됩니다.",
    ...
    "wait_second_exampleDesc": "[开始]버튼을 클릭하면 오브젝트에 색깔효과를 10만큼 주고, 2초동안 기다린 다음 크기를 10만큼 커지게 합니다.",
    "repeat_basic_desc": "아래 명령어들을 A번 循环하여 실행합니다.<br>아래 명령어는 [Tab]키를 통해 들여쓰기합니다.",
    "repeat_basic_elements": "A-- 循环할 횟수 입력",
    "repeat_basic_exampleCode": "def when_start():\n    for i in range(10):\n        Entry.move_to_direction(10)\n        Entry.stamp()",
    "repeat_basic_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 이동방향으로 10만큼 이동하고, 도장찍는 행동을 10번 循环합니다.",
    "repeat_inf_desc": "A 판단이 True인 동안 아래 명령어들을 循环 실행합니다. A에 True를 입력하면 계속 循环됩니다. <br>아래 명령어는 [Tab]키를 통해 들여쓰기합니다.",
    ...
    "repeat_inf_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 계속해서 이동방향으로 10만큼 이동하고, 벽에 닿으면 튕깁니다.",
    "repeat_while_true_desc": "A 판단이 True가 될 때까지 아래 명령어들을 循环 실행합니다.<br>아래 명령어는 [Tab]키를 통해 들여쓰기합니다.",
    ...
    "repeat_while_true_exampleDesc": "[开始]버튼을 클릭하면 스페이스키를 누를때까지 오브젝트가 90도 만큼 회전합니다.",
    "stop_repeat_desc": "이 명령어와 가장 가까운 循环 명령어의 循环을 중단합니다.",
    "stop_repeat_exampleCode": "def when_start():\n    while True:\n        Entry.move_to_direction(10)\n        if Entry.is_key_pressed(\"enter\"):\n            break",
    "stop_repeat_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 이동방향으로 10만큼 계속 이동합니다. 엔터키를 누르면 循环이 중단됩니다.",
    ...
    "_if_exampleCode": "def when_click_mouse_on():\n    if (Entry.value_of_mouse_pointer(\"x\") > 0):\n        Entry.print_for_sec(\"向右一步!\", 0.5)",
    "_if_exampleDesc": "마우스를 클릭했을 때 마우스 x좌표가 0보다 크면 오브젝트가 \"向右一步!\"이라고 0.5초 동안 말합니다.",
    ...
    "wait_until_true_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"엔터를 눌러봐!\"라 말하고, 엔터키를 누를 때까지 기다립니다. 엔터키를 누르면 \"잘했어!\"라 말합니다.",
    ...
    "stop_object_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 계속해서 마우스포인터 위치로  이동합니다. 스페이스키를 누르면 모든 코드의 실행이 중지됩니다.",
    "restart_project_desc": "작품을 처음부터 다시 실행합니다.",
    "restart_project_exampleCode": "def when_start():\n    while True:\n        Entry.add_size(10)\n\ndef when_press_key(\"enter\"):\n    Entry.start_again()",
    "restart_project_exampleDesc": "[开始]버튼을 클릭하면 계속해서 오브젝트의 크기가 커집니다. 엔터키를 누르면 작품을 처음부터 다시 실행합니다.",
    ...
    "when_clone_start_exampleDesc": "[开始]버튼을 클릭하면 자신의 복제본 5개를 만듭니다. 복제본이 새로 생성되었을때 복제본의 x좌표를 -200에서 200사이의 무작위수로 정합니다.",
    ...
    "create_clone_exampleDesc": "[开始]버튼을 클릭하면 자신의 복제본 5개를 만듭니다. 복제본이 새로 생성되었을때 복제본의 x좌표를 -200에서 200사이의 무작위수로 정합니다.",
    ...
    "delete_clone_exampleDesc": "[开始]버튼을 클릭하면 자신의 복제본 5개를 만듭니다. 복제본이 새로 생성되었을때 복제본의 x좌표를 -200에서 200사이의 무작위수로 정합니다. 복제본을 클릭하면 클릭된 복제본을 삭제합니다.",
    "remove_all_clones_desc": "해당 오브젝트의 모든 복제본을 삭제합니다.",
    "remove_all_clones_exampleCode": "def when_start():\n    for i in range(5):\n        Entry.make_clone_of(\"자신\")\n\ndef when_make_clone():\n    Entry.set_x(random.randint(-200, 200))\n\ndef when_press_key(\"space\"):\n    Entry.remove_all_clone()",
    "remove_all_clones_exampleDesc": "[开始]버튼을 클릭하면 자신의 복제본 5개를 만듭니다. 복제본이 새로 생성되었을때 복제본의 x좌표를 -200에서 200사이의 무작위수로 정합니다. 스페이스 키를 누르면 모든 복제본을 삭제합니다.",
    ...
    "move_direction_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 이동방향으로 10만큼 이동합니다.",
    "bounce_wall_desc": "오브젝트가 화면 끝에 닿으면 튕겨져 나옵니다.",
    "bounce_wall_exampleCode": "def when_start():\n    while True:\n        Entry.move_to_direction(10)\n        Entry.bounce_on_edge()",
    "bounce_wall_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 계속해서 이동방향으로 10만큼 이동하고, 벽에 닿으면 튕깁니다.",
    "move_x_desc": "오브젝트의 x좌표를 A만큼 바꿉니다.",
    "move_x_elements": "A-- x좌표의 변화 값<br>① 양수: 오브젝트가 向右一步으로 이동합니다.<br>② 음수: 오브젝트가 向左一步으로 이동합니다.",
    "move_x_exampleCode": "def when_start():\n    Entry.add_x(10)\n    Entry.wait_for_sec(2)\n    Entry.add_x(-10)",
    "move_x_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 向右一步으로 10만큼 이동하고 2초 동안 기다린 후 向左一步으로 10만큼 이동합니다.",
    "move_y_desc": "오브젝트의 y좌표를 A만큼 바꿉니다.",
    "move_y_elements": "A-- y좌표의 변화 값<br>① 양수: 오브젝트가 向上一步으로 이동합니다.<br>② 음수: 오브젝트가 向下一步으로 이동합니다.",
    "move_y_exampleCode": "def when_start():\n    Entry.add_y(10)\n    Entry.wait_for_sec(2)\n    Entry.add_y(-10)",
    "move_y_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 向上一步으로 10만큼 이동하고 2초 동안 기다린 후 向下一步으로 10만큼 이동합니다.",
    "move_xy_time_desc": "오브젝트가 x와 y좌표를 각각 A와 B만큼 C초에 걸쳐 서서히 바꿉니다.",
    "move_xy_time_elements": "A-- x좌표의 변화 값<br>① 양수: 오브젝트가 向右一步으로 이동합니다.<br>② 음수: 오브젝트가 向左一步으로 이동합니다.%nextB-- y좌표의 변화 값<br>① 양수: 오브젝트가 向上一步으로 이동합니다.<br>② 음수: 오브젝트가 向下一步으로 이동합니다.%nextC-- 이동하는 시간(초)",
    "move_xy_time_exampleCode": "def when_start():\n    Entry.add_xy_for_sec(100, 100, 2)\n    Entry.add_xy_for_sec(-100, -100, 2)",
    "move_xy_time_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 向右一步 위로 100만큼 2초 동안 이동한 후 向左一步 아래로 100만큼 2초 동안 이동합니다.",
    ...
    "locate_x_exampleDesc": "向右一步화살표키를 누르면 오브젝트의 x좌표를 100으로 정하고, 向左一步화살표키를 누르면 오브젝트의 x좌표를 -100으로 정합니다.",
    ...
    "locate_y_exampleDesc": "向上一步화살표키를 누르면 오브젝트의 y좌표를 100으로 정하고, 向下一步화살표키를 누르면 오브젝트의 y좌표를 -100으로 정합니다.",
    ...
    "locate_xy_exampleDesc": "向右一步화살표키를 누르면 오브젝트의 x좌표를 10만큼 바꾸고, 向上一步화살표키를 누르면 오브젝트의 y좌표를 10만큼 바꿉니다. 마우스를 클릭하면 오브젝트의 x, y좌표를 0으로 정합니다.",
    ...
    "locate_xy_time_exampleDesc": "向右一步화살표키를 누르면 오브젝트의 x좌표를 10만큼 바꾸고, 向上一步화살표키를 누르면 오브젝트의 y좌표를 10만큼 바꿉니다. 마우스를 클릭하면 2초 동안 오브젝트를 x,y 좌표 0으로 이동시킵니다.",
    ...
    "direction_relative_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 이동방향으로 50만큼 이동한 다음 0.5초간 기다립니다. 그 후 이동방향을 90도 만큼 회전하고 0.5초간 기다린 후 이동방향으로 50만큼 이동합니다.",
    ...
    "rotate_by_time_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 2초 동안 90도 만큼 회전하고, 다시 2초 동안 -90도 만큼 회전합니다.",
    ...
    "direction_relative_duration_exampleDesc": "[开始]버튼을 클릭하면 오브젝트의 이동방향을 2초 동안 90도만큼 회전시킵니다. 동시에 오브젝트는 이동방향으로 1만큼 계속 이동합니다.",
    ...
    "rotate_absolute_exampleDesc": "向右一步화살표키를 누르면 오브젝트의 방향을 90으로 정하고, 向左一步화살표키를 누르면 오브젝트의 방향을 270으로 정합니다.",
    ...
    "direction_absolute_exampleDesc": "向右一步화살표키를 누르면 오브젝트의 이동방향을 90으로 정한 후 해당 쪽으로 10만큼 이동하고, 向左一步화살표키를 누르면 오브젝트의 이동방향을 270으로 정하고 해당쪽으로 10만큼 이동합니다.",
    ...
    "move_to_angle_exampleDesc": "向上一步화살표키를 누르면 오브젝트가 0도방향으로 10만큼 이동하고, 向下一步화살표키를 누르면 오브젝트가 180도방향으로 10만큼 이동합니다.",
    "show_desc": "오브젝트를 화면에 나타냅니다.",
    "show_exampleCode": "def when_start():\n    Entry.wait_for_sec(1)\n    Entry.hide()\n    Entry.wait_for_sec(1)\n    Entry.show()",
    "show_exampleDesc": "[开始]버튼을 클릭하면 1초 뒤에 오브젝트 모양이 숨겨지고, 다음 1초 뒤에 오브젝트 모양이 나타납니다.",
    "hide_desc": "오브젝트를 화면에서 보이지 않게 합니다.",
    "hide_exampleCode": "def when_start():\n    Entry.wait_for_sec(1)\n    Entry.hide()\n    Entry.wait_for_sec(1)\n    Entry.show()",
    "hide_exampleDesc": "[开始]버튼을 클릭하면 1초 뒤에 오브젝트 모양이 숨겨지고, 다음 1초 뒤에 오브젝트 모양이 나타납니다.",
    ...
    "dialog_time_exampleDesc": "[开始]버튼을 클릭하면 \"안녕! 나는\", 16, \"살이야\"를 각각 2초 동안 차례대로 말합니다.",
    ...
    "dialog_exampleDesc": "[开始]버튼을 클릭하면 \"키보드로 숫자 1,2 를 누르면 숫자를 말해볼게\"를 말하고, 키보드로 1, 2를 누르면 각각 1, 2라 말합니다.",
    "remove_dialog_desc": "오브젝트가 말하고 있는 말풍선을 지웁니다.",
    "remove_dialog_exampleCode": "def when_start():\n    Entry.print(\"말풍선을 지우려면 엔터를 눌러!\")\n\ndef when_press_key(\"enter\"):\n    Entry.clear_print()",
    "remove_dialog_exampleDesc": "[开始]버튼을 클릭하면 \"말풍선을 지우려면 엔터를 눌러!\"라 말하고, 엔터키를 누르면 말풍선이 사라집니다.",
    ...
    "change_to_some_shape_exampleDesc": "[开始]버튼을 클릭하면 0.3초간 기다린 다음 \"오브젝트모양\"으로 모양을 바꾸고 0.3초간 기다린 다음 \"오브젝트모양\"모양으로 모양을 바꿉니다.",
    "change_to_next_shape_desc": "오브젝트의 모양을 다음 또는 返回 모양으로 바꿉니다.",
    "change_to_next_shape_elements": "A-- 아래 선택지 중 하나<br>① 다음 모양 : \"next\" 또는 \"다음\" <br>② 返回 모양 : \"pre\" 또는 \"返回\"",
    "change_to_next_shape_exampleCode": "def when_start():\n    Entry.wait_for_sec(0.3)\n    Entry.change_shape_to(\"next\")\n    Entry.wait_for_sec(0.3)\n    Entry.change_shape_to(\"pre\")",
    "change_to_next_shape_exampleDesc": "[开始]버튼을 클릭하면 0.3초간 기다린 다음 모양으로 오브젝트 모양을 바꾸고 0.3초간 기다린 다음 返回 모양으로 오브젝트 모양을 바꿉니다.",
    ...
    "change_effect_amount_elements": "A-- 아래 선택지 중 하나<br>① “color” 또는 “색깔“                 <br>② “brightness” 또는 “밝기”                <br>③ “transparency” 또는 “투명도”%nextB-- 효과의 값<br>① color: 0~100 범위의 수, 100을 주기로 循环됨<br>② brightness: -100~100 사이 범위의 수, -100이하는 -100 으로 100 이상은 100 으로 처리 됨<br>③ transparency: 0~100 사이 범위의 수, 0 이하는 0으로, 100이상은 100으로 처리 됨",
    ...
    "change_scale_size_exampleDesc": "向上一步화살표키를 누르면 오브젝트의 크기가 10만큼 커지고, 向下一步화살표키를 누르면 오브젝트의 크기가 10만큼 작아집니다. 스페이스키를 누르면 오브젝트의 크기를 100으로 정합니다.",
    "set_scale_size_desc": "오브젝트의 크기를 A로 정합니다.",
    "set_scale_size_elements": "A-- 크기값",
    "set_scale_size_exampleCode": "def when_press_key(\"up\"):\n    Entry.add_size(10)\n\ndef when_press_key(\"down\"):\n    Entry.add_size(-10)\n\ndef when_press_key(\"space\"):\n    Entry.set_size(100)",
    "set_scale_size_exampleDesc": "向上一步화살표키를 누르면 오브젝트의 크기가 10만큼 커지고, 向下一步화살표키를 누르면 오브젝트의 크기가 10만큼 작아집니다. 스페이스키를 누르면 오브젝트의 크기를 100으로 정합니다.",
    "flip_x_desc": "오브젝트의 상하 모양을 뒤집습니다.",
    "flip_x_exampleCode": "def when_press_key(\"up\"):\n    Entry.flip_horizontal()\n\ndef when_press_key(\"right\"):\n    Entry.flip_vertical()",
    "flip_x_exampleDesc": "向上一步화살표키를 누르면 오브젝트의 상하 모양을 뒤집고, 向右一步화살표키를 누르면 오브젝트의 좌우 모양을 뒤집습니다.",
    "flip_y_desc": "오브젝트의 좌우 모양을 뒤집습니다.",
    "flip_y_exampleCode": "def when_press_key(\"up\"):\n    Entry.flip_horizontal()\n\ndef when_press_key(\"right\"):\n    Entry.flip_vertical()",
    "flip_y_exampleDesc": "向上一步화살표키를 누르면 오브젝트의 상하 모양을 뒤집고, 向右一步화살표키를 누르면 오브젝트의 좌우 모양을 뒤집습니다.",
    ...
    "change_object_index_exampleDesc": "오브젝트가 여러개가 겹쳐 있을 경우 [开始]버튼을 클릭하면  해당 오브젝트의 레이어를 가장 앞으로 가져와서 보여줍니다.",
    "brush_stamp_desc": "오브젝트의 모양을 도장처럼 실행화면 위에 찍습니다.",
    "brush_stamp_exampleCode": "def when_start():\n    for i in range(10):\n        Entry.move_to_direction(10)\n        Entry.stamp()",
    "brush_stamp_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 이동방향으로 10만큼 이동하고, 도장찍는 행동을 10번 循环합니다.",
    "start_drawing_desc": "오브젝트가 이동하는 경로를 따라 선이 그려지기 시작합니다. (오브젝트의 중심점이 기준)",
    "start_drawing_exampleCode": "def when_start():\n    Entry.start_drawing()\n    for i in range(10):\n        Entry.move_to_direction(10)",
    "start_drawing_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작되고, 오브젝트가 이동방향으로 10만큼 10번 이동할 때 오브젝트의 이동경로를 따라 선이 그려집니다.",
    "stop_drawing_desc": "오브젝트가 선을 그리는 것을 멈춥니다.",
    "stop_drawing_exampleCode": "def when_start():\n    Entry.start_drawing()\n    while True:\n        Entry.move_to_direction(1)\n\ndef when_click_mouse_on():\n    Entry.stop_drawing()",
    "stop_drawing_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작되고 계속해서 오브젝트가 이동방향으로 10만큼 이동합니다. 마우스를 클릭하면 그리는것을 멈춥니다.",
    ...
    "set_color_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작되고, 선의 색을 \"#000099\"로 정합니다. 오브젝트는 계속해서 이동방향으로 1만큼 움직이고, 오브젝트의 이동경로를 따라 선이 그려집니다.",
    ...
    "set_random_color_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작됩니다. 오브젝트는 계속해서 이동방향으로 1만큼 움직이고, 오브젝트의 이동경로를 따라 선이 그려집니다. 선의 색깔은 계속해서 무작위로 정해집니다.",
    ...
    "change_thickness_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작됩니다. 오브젝트는 계속해서 이동방향으로 10만큼 움직이고, 오브젝트의 이동경로를 따라 선이 그려집니다. 선의 굵기는 계속해서 1씩 커집니다.",
    ...
    "set_thickness_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작되고, 선의 굵기를 10으로 정합니다. 오브젝트는 계속해서 이동방향으로 10만큼 움직이고, 오브젝트의 이동경로를 따라 선이 그려집니다.",
    ...
    "change_brush_transparency_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작되고, 선의 굵기를 10으로 정합니다. 오브젝트는 계속해서 이동방향으로 10만큼 움직이고, 오브젝트의 이동경로를 따라 선이 그려집니다. 선의 투명도는 계속해서 5만큼 바꿉니다.",
    ...
    "set_brush_tranparency_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작되고, 선의 굵기를 10으로, 선의 투명도를 50으로 정합니다. 오브젝트는 계속해서 이동방향으로 10만큼 움직이고, 오브젝트의 이동경로를 따라 선이 그려집니다.",
    "brush_erase_all_desc": "오브젝트가 그린 선과 도장을 모두 지웁니다.",
    "brush_erase_all_exampleCode": "def when_start():\n    Entry.start_drawing()\n    while True:\n        Entry.move_to_direction(10)\n\ndef when_click_mouse_on():\n    Entry.clear_drawing()",
    "brush_erase_all_exampleDesc": "[开始]버튼을 클릭하면 그리기가 시작됩니다. 오브젝트는 계속해서 이동방향으로 10만큼 움직이고, 오브젝트의 이동경로를 따라 선이 그려집니다. 마우스를 클릭하면 오브젝트가 그린 선을 모두 지웁니다.",
    ...
    "text_read_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 글상자 \"A\"의 내용을 말합니다.​",
    ...
    "text_write_exampleDesc": "[开始]버튼을 클릭하면 글상자의 내용을 \"엔트리\"로 바꿉니다.",
    ...
    "text_append_exampleDesc": "[开始]버튼을 클릭하면 글상자의 내용이 \"안녕?\"이 되었다가 1초 뒤에 \"엔트리!\"가 추가되어 \"안녕?엔트리!\"가 됩니다.",
    ...
    "text_prepend_exampleDesc": "[开始]버튼을 클릭하면 글상자의 내용이 \"반가워!\"가 되었다가 1초 뒤에 \"엔트리!\"가 앞에 추가되어 \"엔트리!반가워!\"가 됩니다.",
    "text_flush_desc": "글상자에 저장된 값을 모두 지웁니다.",
    "text_flush_exampleCode": "def when_start():\n    Entry.write_text(\"엔트리\")\n    Entry.wait_for_sec(1)\n    Entry.clear_text()",
    "text_flush_exampleDesc": "[开始]버튼을 클릭하면 글상자의 내용이 \"엔트리\"가 되었다가 1초 뒤에 모든 내용이 사라집니다.",
    ...
    "sound_something_with_block_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 재생하면서 오브젝트의 크기가 50만큼 커집니다.",
    ...
    "sound_something_second_with_block_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 1초 동안 재생하면서, 오브젝트의 크기가 50만큼 커집니다.",
    ...
    "sound_from_to_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 0.5초부터 1초 구간까지만 재생하면서, 오브젝트의 크기가 50만큼 커집니다.",
    ...
    "sound_something_wait_with_block_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 재생하고, 재생이 끝나면 오브젝트의 크기가 50만큼 커집니다.",
    ...
    "sound_something_second_wait_with_block_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 1초 동안 재생하고, 재생이 끝나면 오브젝트의 크기가 50만큼 커집니다.",
    ...
    "sound_from_to_and_wait_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 0.5초부터 1초 구간까지만 재생하고, 재생이 끝나면 오브젝트의 크기가 50만큼 커집니다.",
    ...
    "sound_volume_change_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 계속 재생합니다. 向上一步화살표키를 누르면 소리의 크기가 10\" 커지고, 向下一步화살표키를 누르면 소리의 크기가 10\"작아집니다.",
    ...
    "sound_volume_set_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 계속 재생합니다. 向上一步화살표키를 누르면 소리의 크기가 10\" 커지고, 向下一步화살표키를 누르면 소리의 크기가 10\"작아집니다. 엔터키를 누르면 소리의 크기를 100\"로 정합니다.",
    "sound_silent_all_desc": "현재 재생 중인 모든 소리를 멈춥니다.",
    "sound_silent_all_exampleCode": "def when_start():\n    while True:\n        Entry.play_sound_and_wait(\"소리\")\n\ndef when_press_key(\"enter\"):\n    Entry.stop_sound()",
    "sound_silent_all_exampleDesc": "[开始]버튼을 클릭하면 \"소리\"를 계속 재생합니다. 엔터키를 누르면 현재 재생 중인 소리를 멈춥니다.",
    ...
    "is_clicked_exampleDesc": "[开始]버튼을 클릭하면 계속해서 마우스를 클릭했는지 확인합니다. 만약 마우스를 클릭하면 오브젝트가 \"반가워!\"라고 0.5초간 말합니다.",
    ...
    "is_press_some_key_exampleDesc": "[开始]버튼을 클릭하면 계속해서 선택한 키를 눌렀는지 확인합니다. 만약 스페이스 키를 누르면 오브젝트가 이동방향으로 10만큼 이동합니다.",
    ...
    "reach_something_exampleDesc": "[开始]버튼을 클릭하면 계속해서 오브젝트가 이동방향으로 10만큼 이동합니다. 만약 오브젝트가 벽에 닿으면 150만큼 회전하게 됩니다.",
    ...
    "boolean_basic_operator_exampleDesc": "[开始]버튼을 클릭하면 계속해서 오브젝트 x좌표를 10만큼 바꿉니다. 만약 오브젝트 x좌표가 240보다 크면 오브젝트 x좌표를 0으로 정합니다.",
    ...
    "boolean_and_exampleDesc": "[开始]버튼을 클릭하고 키보드의 \"a\" 와 \"s\"키를 동시에 눌렀을 때, 색깔 효과를 10만큼 줍니다.",
    ...
    "boolean_or_exampleDesc": "[开始]버튼을 클릭하면 키보드의 \"a\"나 \"s\"키 중 무엇이든 하나를 누르면 오브젝트에 색깔 효과를 10만큼 줍니다.",
    ...
    "boolean_not_exampleDesc": "[开始]버튼을 클릭하면 마우스를 클릭하지 않은 동안 크기가 1씩 커집니다.",
    ...
    "calc_basic_exampleDesc": "[开始]버튼을 클릭하면 10과 10을 더한값, 뺀값, 곱한값, 나눈값을 각 2초간 말합니다.",
    ...
    "calc_rand_exampleDesc": "[开始]버튼을 클릭하면 1부터 10사이의 정수중 무작위 수를 뽑아 2초간 말합니다. 그 후 0.1부터 2사이의 실수중 무작위 수를 뽑아 2초간 말합니다.",
    ...
    "coordinate_mouse_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 마우스 포인터의 x좌표를 계속해서 말합니다.",
    ...
    "coordinate_object_exampleDesc": "[开始]버튼을 클릭하면 계속해서 오브젝트의 x좌표가 1씩 증가하며, \"오브젝트\"의 x좌표를 말합니다.",
    ...
    "get_sound_volume_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 소리의 크기값을 계속해서 말합니다.",
    ...
    "quotient_and_mod_exampleDesc": "[开始]버튼을 클릭하면 10 / 3의 몫인 3을 2초 동안 말하고, 나머지인 1을 2초 동안 말합니다.",
    ...
    "calc_operation_exampleDesc": "[开始]버튼을 클릭하면 10의 제곱, 9의 루트값, 90의 사인값, -10의 절댓값을 각 2초 동안 말합니다.",
    ...
    "get_project_timer_value_exampleDesc": "[开始]버튼을 클릭하면 초시계를 시작합니다. 3초 뒤에는 초시계를 정지하고 초시계창을 숨깁니다. 그 후 초시계값을 말합니다.",
    ...
    "choose_project_timer_action_exampleDesc": "[开始]버튼을 클릭하면 초시계를 시작합니다. 3초 뒤에는 초시계를 정지하고 초시계창을 숨깁니다. 그 후 초시계값을 말합니다.",
    ...
    "set_visible_project_timer_exampleDesc": "[开始]버튼을 클릭하면 초시계를 시작합니다. 3초 뒤에는 초시계를 정지하고 초시계창을 숨깁니다. 그 후 초시계값을 말합니다.",
    ...
    "get_date_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 현재년도와 월을 말합니다.",
    ...
    "distance_something_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 마우스포인터와의 거리를 계속해서 말합니다.",
    ...
    "get_sound_duration_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"소리\"의 길이를 말합니다.",
    "get_user_name_desc": "작품을 실행하고 있는 사용자의 이름 값입니다.",
    "get_user_name_exampleCode": "def when_start():\n    Entry.print(Entry.value_of_username())",
    "get_user_name_exampleDesc": "[开始]버튼을 클릭하면 작품을 실행하고 있는 사용자의 이름 값을 말합니다.",
    ...
    "length_of_string_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"안녕\"과 \"엔트리\"의 글자 수를 각각 2초 동안 말합니다.",
    ...
    "combine_something_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"안녕!\"과 \"엔트리\"를 결합한 \"안녕! 엔트리\"를 말합니다.",
    ...
    "char_at_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"안녕 엔트리!\"의 0번째 글자인 \"안\"을 말합니다.",
    ...
    "substring_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"안녕 엔트리!\"의 1에서 4번째 글자인 \"녕 엔트\"를 말합니다.",
    ...
    "index_of_string_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"안녕 엔트리!\"에서 \"엔트리\"가 처음으로 등장하는 위치인 3을 말합니다.",
    ...
    "replace_string_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"안녕 엔트리!\"에서 \"안녕\"을 \"반가워\"로 바꾼 \"반가워 엔트리!\"를 말합니다.",
    ...
    "change_string_case_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"Hello Entry!\"를 모두 대문자로 바꾼 \"HELLO ENTRY!\"를 2초간 말한 다음 모두 소문자로 바꾼 \"hello entry!\"를 2초간 말합니다.",
    ...
    "ask_and_wait_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"이름을 입력해보세요.\"라고 말풍선으로 묻습니다. 이름을 입력하면 \"(입력한 이름) 반가워!\"라 말합니다.",
    "get_canvas_input_value_desc": "Entry.input(A) 명령에 의해 실행화면 또는 콘솔에서 입력받은 값입니다.",
    "get_canvas_input_value_exampleCode": "def when_start():\n    Entry.input(\"이름을 입력해보세요.\")\n    Entry.print(Entry.answer() + \" 반가워!\")",
    "get_canvas_input_value_exampleDesc": "[开始]버튼을 클릭하면 오브젝트가 \"이름을 입력해보세요.\"라고 말풍선으로 묻습니다. 이름을 입력하면 \"(입력한 이름) 반가워!\"라 말합니다.",
    ...
    "set_visible_answer_exampleDesc": "[开始]버튼을 클릭하면 대답창이 숨겨지고, 오브젝트가 \"나이를 입력하세요.\"라고 말풍선으로 묻습니다. 나이를 입력하면 오브젝트가 입력한 나이를 말합니다.",
    ...
    "get_variable_exampleDesc": "age라는 변수를 만들고 그 값을 16으로 정합니다. [开始]버튼을 클릭하면 오브젝트가 age 변수에 들어 가 있는 값인 \"16\"을 말합니다.",
    ...
    "change_variable_exampleDesc": "age라는 변수를 만들고 그 값을 16으로 정합니다. [开始]버튼을 클릭하면 오브젝트가 age 변수에 들어 가 있는 값인 \"16\"을 2초 동안 말합니다. 그 후 age변수에 2를 더하고 더한값인 \"18\"을 2초 동안 말합니다.",
    ...
    "set_variable_exampleDesc": "age라는 변수를 만들고 그 값을 16으로 정합니다. [开始]버튼을 클릭하면 오브젝트가 age 변수에 들어 가 있는 값인 \"16\"을 말합니다.",
    ...
    "show_variable_exampleDesc": "age라는 변수를 만들고 그 값을 16으로 정합니다. [开始]버튼을 클릭하면 age변수창을 실행화면에서 숨깁니다. 2초 후 변수값을 17로 바꾸고 age변수창을 실행화면에 보이게 합니다.",
    ...
    "hide_variable_exampleDesc": "age라는 변수를 만들고 그 값을 16으로 정합니다. [开始]버튼을 클릭하면 age변수창을 실행화면에서 숨기고, 오브젝트가 age 변수에 들어 가 있는 값인 \"16\"을 2초 동안 말합니다.",
    ...
    "value_of_index_from_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 오브젝트가 basket 리스트의 1번째 항목인 orange를 말합니다.",
    ...
    "add_value_to_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 \"juice\"를 basket의 마지막 항목으로 추가합니다. 오브젝트는 basket의 4번째 항목인 \"juice\"를 말합니다.",
    ...
    "remove_value_from_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 basket의 0번째 항목인 apple을 삭제합니다. 오브젝트는 새롭게 basket의 0번째 항목이 된 \"orange\"를 말합니다.",
    ...
    "insert_value_to_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 basket의 1번째 위치에 항목 \"juice\"를 끼워 넣습니다. 오브젝트는 새롭게 basket의 2번째 항목이 된 \"orange\"를 말합니다.",
    ...
    "change_value_list_index_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 basket의 0번째 위치의 항목 \"apple\"을 \"juice\"로 바꿉니다. 오브젝트는 바뀐 basket의 0번째 항목 \"juice\"를 말합니다.",
    ...
    "length_of_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 오브젝트는  basket의 항목 개수인 4를 말합니다.",
    ...
    "is_included_in_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 basket 리스트에 \"apple\"항목이 있는지 확인합니다. \"apple\"항목이 있기 때문에 오브젝트는 \"사과가 있어!\"라 말합니다.",
    ...
    "show_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 basket 리스트를 2초간 숨긴 다음 보여줍니다.",
    ...
    "hide_list_exampleDesc": "basket이라는 리스트를 만들고 4개의 항목을 넣습니다. [开始]버튼을 클릭하면 basket 리스트를 2초간 숨긴 다음 보여줍니다.",
    ...
    "boolean_and_or_exampleDesc": "[开始]버튼을 클릭하고 키보드의 \"a\" 와 \"s\"키를 동시에 눌렀을 때, 색깔 효과를 10만큼 줍니다."
};
